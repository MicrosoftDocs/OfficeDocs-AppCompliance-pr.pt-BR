---
title: Informações do aplicativo para PrivyNow por PT Privy Identitas Digital
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: Todas as informações de segurança e conformidade disponíveis para PrivyNow, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66546969"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 2 de março de 2022</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo PT Privy Identitas Digital para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | PrivyNow |
| ID | WA200004229 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | PT Privy Identitas Digital |
| Site da empresa | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| Termos de Uso do Aplicativo | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| Funcionalidade principal do aplicativo | Assinar todos os tipos de documentos é uma parte essencial do seu dia a dia e atrasar muda tudo. Feche seus negócios rapidamente com o PrivyNow. Carregue e compartilhe um documento em 1 minuto.   Para usar esse aplicativo, os usuários devem ter contas ativas do PrivyNow, inscreva-se PrivyNow.com ou entre em contato com nossa equipe de suporte para obter mais detalhes. |
| Localização da sede da empresa | Indonésia |
| Página de informações do aplicativo | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
Essas informações foram fornecidas pelo PT Privy Identitas Digital sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Nome completo, emails |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Nome completo, emails |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Indonésia |
...
| URL da Política de Privacidade | https://privynow.com/terms-of-use/ |
