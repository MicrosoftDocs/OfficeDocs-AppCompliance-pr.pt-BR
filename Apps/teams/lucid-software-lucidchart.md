---
title: Informações do aplicativo para Lucidchart por Lucid Software
ms.author: elmalova
author: elenamalova
ms.date: 12/16/2019
ms.topic: article
...
description: Todas as informações disponíveis de segurança e conformidade para a Lucidchart, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7f905be6-3226-4a4c-9c54-ab1edce3c99c" target="_blank">Vista na loja Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381935" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Lucid Software à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Lucidchart |
| ID | WA104381935 |
...
| URL da página de informações do aplicativo Teams | [https://lucidchart.zendesk.com/](https://lucidchart.zendesk.com/) |
| URL da Política de Privacidade | [https://lucid.co/privacy](https://lucid.co/privacy) |
| URL de Termos de Uso | [https://lucid.co/tos](https://lucid.co/tos) |
...
Essas informações foram fornecidas pela Lucid Software sobre como este aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
