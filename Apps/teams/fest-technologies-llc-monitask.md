---
title: Informações de aplicativo para Monitask da FEST Technologies, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Monitask, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0b49493f-fc40-49e1-9e3b-6515588af2b5" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela FEST Technologies, LLC para a Microsoft:
...
| Nome da empresa parceira | Tecnologias DEC, LLC |
...
| Funcionalidade principal do aplicativo | O Monitask é o kit de ferramentas de produtividade de negócios remotos tudo em um |
...
Essas informações foram fornecidas pela FEST Technologies, LLC sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
