---
title: Informações do aplicativo para Kunjani por FACEBOARD (PTY) LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/10/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Kunjani, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6b4ac65a-764d-4021-bf3f-40cb2d137a33" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo FACEBOARD (PTY) LTD para a Microsoft:
...
| Nome da empresa parceira | FACEBOARD (PTY) LTD |
| Site da empresa | [https://www.kunjani.co](https://www.kunjani.co) |
| Termos de Uso do Aplicativo | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| Funcionalidade principal do aplicativo | Anucie sua Reunião com um jogo interativo kunjani projetado por você. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://Kunjani.co](https://Kunjani.co) |
...
Essas informações foram fornecidas pela FACEBOARD (PTY) LTD sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
