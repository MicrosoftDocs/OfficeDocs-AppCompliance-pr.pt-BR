---
title: Informações de aplicativo para Panopto por Panopto
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Panopto, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63551970"
---
# <a name="panopto"></a>Panopto

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 22 de fevereiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Panopto à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Panopto |
| ID | WA200003801 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Panopto |
| Site da empresa | [https://www.panopto.com](https://www.panopto.com) |
| Termos de uso do aplicativo | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| Funcionalidade principal do aplicativo | Exportar Teams gravações para Panopto e pesquisar, compartilhar e exibir vídeos panopto sem sair Teams.  Adiciona recursos como um índice visual de cada reunião e legendas fechadas verificadas por humanos. Acessar recursos panopto sem sair do Teams: criar uma nova guia de canal mapeada para uma pasta Panopto; pesquisar e compartilhar vídeos panopto; apresentar vídeos panopto em reuniões agendadas; e receber notificações quando um novo vídeo Panopto estiver pronto. Precisa de um site panopto? Visite www.panopto.com/plans para começar. |
...
Essas informações foram fornecidas pela Panopto sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Metadados em Teams de reunião e Teams canais. |
...
| Data de certificação SOC2 mais recente |  2021-08-19 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente |  2021-10-13 |
...
| URL da Política de Privacidade | https://www.panopto.com/privacy/ |
