---
title: Informações do aplicativo para o Assistente summize por Summize (Ltd)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/11/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Assistente summize, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63551340"
---
# <a name="summize-assistant"></a>Assistente de Resumo
...
* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Summize (Ltd) à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Assistente de Resumo |
| ID | WA200003577 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Resumo (Ltd) |
| Site da empresa | [https://www.summize.com](https://www.summize.com) |
| Termos de uso do aplicativo | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Resumir facilita a revisão e a criação de contratos. Resumir está mudando a maneira como as empresas entendem e interagem com contratos. Usando nosso software inteligente e conversacional, sobrecarregamos seus processos de contrato e desbloqueiamos percepções contratuais.  Summize Assistant app within Teams ajuda os usuários a carregar contratos (formatos PDF e docx) para revisão.  Os usuários também podem criar contratos usando modelos criados no aplicativo Summize.   |
...
Essas informações foram fornecidas pela Summize (Ltd) sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Documentos originais e avaliações de clientes de documentos |
...
| URL da Política de Privacidade | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
