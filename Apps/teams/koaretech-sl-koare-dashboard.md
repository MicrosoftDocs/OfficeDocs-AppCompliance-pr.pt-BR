---
title: Informações do aplicativo para o Painel do Koare da KoareTech S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Painel do Koare, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66817585"
---
# <a name="koare-dashboard"></a>Painel do Koare

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 4 de junho de 2022</p>

* <a href="https://teams.microsoft.com/l/app/08a78d62-ec3b-4800-b51a-9ffd823273cd" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004403" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela KoareTech S.L. para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Painel do Koare |
| ID | WA200004403 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | KoareTech S.L. |
| Site da empresa | [https://koaretech.com](https://koaretech.com) |
| Termos de Uso do Aplicativo | [https://koaretech.com/termsofuse.php](https://koaretech.com/termsofuse.php) |
| Funcionalidade principal do aplicativo | O gerenciamento de inventário é a ferramenta para gravação e acompanhamento de ativos de hardware e software e inventário de TI em uma organização. Ideal para desparamentos e gerenciamento de TI. Os relatórios fornecidos pela ferramenta de gerenciamento de Inventário koareTech mostram informações detalhadas sobre o estado e o uso de itens atribuídos a cada funcionário. Compatível com o Microsoft Teams e o SharePoint. Requisito: associar ao grupo ou canal do Microsoft Teams e assinar com o Azure Marketplace. |
