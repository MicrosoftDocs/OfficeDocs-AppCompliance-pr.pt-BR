---
title: Informações do aplicativo para o produtor de AI pela LiveArena Technologies AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Produtor de AI, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "64602356"
---
# <a name="ai-producer"></a>Produtor de IA
...
* <a href="https://teams.microsoft.com/l/app/e7fb100c-8c81-4e3f-9c78-bb1407080cdc" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003883" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela LiveArena Technologies AB à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Produtor de IA |
| ID | WA200003883 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | LiveArena Technologies AB |
| Site da empresa | [https://livearena.com](https://livearena.com) |
| Termos de uso do aplicativo | [https://livearena.com/termsofuse](https://livearena.com/termsofuse) |
| Funcionalidade principal do aplicativo | O Produtor de Ia transforma sua Microsoft Teams em uma transmissão profissional. Totalmente automatizado. O Produtor de AI permite que Microsoft Teams usuários criem transmissões profissionais, bem como a oportunidade de transformar Microsoft Teams reuniões em produções personalizadas e envolventes. O Produtor de AI é integrado Microsoft Teams como uma extensão de reunião. Formatos de produção predefinidos que se adequam às suas necessidades. Brand your broadcast with a logo and background. |
| Localização da sede da empresa | Suécia |
| Página de informações do aplicativo | [https://livearena.com](https://livearena.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegado | Para detectar edições feitas em uma reunião e, portanto, ajustar os recursos dos aplicativos. O aplicativo também pode atualizar o texto de convite da reunião se o organizador optar por fazer isso por meio do aplicativo. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| Calls.AccessMedia.All | aplicação | O Produtor de AI ingressará na reunião como participante. Se for deixado entrar na reunião, ele lerá o áudio e o vídeo dos participantes para poder produzir uma transmissão fora da reunião. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| Calls.JoinGroupCallasGuest.All | aplicação | O Produtor de AI deve poder participar de reuniões para poder criar transmissões delas. O Produtor de AI só pode participar de reuniões que ele conhece, ou seja, é uma reunião à que o organizador adicionou ao aplicativo. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| Chat.ReadWrite | delegado | O aplicativo pode ler e gravar mensagens de chat para os participantes da reunião. Se essa permissão não for concedida, não será possível usar o recurso mensagens &#8220;mensagens&#8221; do Produtor de AI, mas o aplicativo ainda poderá fazer uma transmissão. O aplicativo nunca lê mensagens de chat, mas não há permissão para apenas gravar. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| OnlineMeetings.ReadWrite | delegado | O aplicativo usa essa permissão quando o aplicativo é adicionado a uma reunião para ler informações sobre quem é convidado para a reunião, quando ele é iniciado e termina e o título da reunião. O aplicativo pode, por exemplo, ler quem ingressou na reunião. Ele também pode criar eventos ao vivo de reuniões e equipes em nome do usuário. O aplicativo cria uma assinatura para monitorar as alterações na reunião, ou seja, se a reunião for reagendada ou removida. Habilita a coleta de fontes de vídeo corretas no horário de reunião agendado. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| User.ReadBasic.All | delegado | Essa permissão é usada para ler o nome, o cargo, o email, o nome principal do usuário e a foto de perfil do usuário na reunião. Mais informações sobre como essas informações são usadas na seção Processamento de dados acima. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| email | delegado | Permite que o aplicativo veja o perfil básico de seus usuários (nome, imagem, nome de usuário). | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| offline_access | delegado | Permite ao aplicativo ler e atualizar dados do usuário, mesmo quando eles não estiver usando o aplicativo. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| openid | delegado | Permite que os usuários entre no aplicativo com suas contas de trabalho ou de estudante e permite que o aplicativo veja informações básicas de perfil de usuário. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| perfil | delegado | Permite ao aplicativo ler o endereço de email principal do usuário. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
