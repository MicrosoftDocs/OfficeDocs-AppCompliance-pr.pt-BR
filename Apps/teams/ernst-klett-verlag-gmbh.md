---
title: Informações do aplicativo para Klett por Ernst Klett Verlag GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/11/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Klett, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/e52ef0da-a602-479b-8ac4-f3e0398009e6" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003716" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por Ernst Klett Verlag GmbH à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Klett |
| ID | WA200003716 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Ernst Klett Verlag GmbH |
| Site da empresa | [https://www.klett.de/index/](https://www.klett.de/index/) |
| Termos de uso do aplicativo | [https://www.klett.de/inhalt/rechtliches/nutzungsbedingungen...](https://www.klett.de/inhalt/rechtliches/nutzungsbedingungen-fuer-digitale-inhalte-und-online-services/6931) |
| Funcionalidade principal do aplicativo | Bequemer Zugriff auf die digitalen Produkte passend zum Schulbuch |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://www.klett.de/inhalt/217167](https://www.klett.de/inhalt/217167) |
...
Essas informações foram fornecidas por Ernst Klett Verlag GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://www.klett.de/datenschutz |
