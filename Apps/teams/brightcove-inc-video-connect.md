...
description: Todas as informações de segurança e conformidade disponíveis para o Conexão Vídeo Brightcove, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | A Conexão vídeo Brightcove dá suporte a opções de colaboração em torno de ativos de vídeo e mídia diretamente Microsoft Teams |
