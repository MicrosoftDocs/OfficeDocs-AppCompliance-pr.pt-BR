---
title: Informações do aplicativo para o Brightcove Video Conexão da Brightcove Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Brightcove Video Conexão, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/af7b350c-9e21-49a2-98b8-679327ed31c3" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Brightcove Inc. |
| Site da empresa | [https://www.brightcove.com/en/](https://www.brightcove.com/en/) |
| Termos de Uso do Aplicativo | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| Funcionalidade principal do aplicativo | O Brightcove Video Conexão dá suporte a opções de colaboração em torno de ativos de vídeo e mídia diretamente no Microsoft Teams |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
