---
title: Informações do aplicativo para a VLE OLIVE por OliveGroup
ms.author: elmalova
author: elenamalova
ms.date: 07/12/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para o VLE OLIVE, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo OliveGroup à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | OLIVE VLE |
| ID | WA200003331 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | OliveGroup |
| Site da empresa | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Termos de uso do aplicativo | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Funcionalidade principal do aplicativo | A VLE de Oliva ajuda os provedores de educação e tutores a criar e gerenciar cursos, programas de aprendizagem e alunos. Os administradores de provedores de educação podem criar seus próprios cursos online, testes, atribuições, programas e atribuí-los aos alunos. Microsoft Teams é integrado usando Graph API para que os administradores também possam criar salas de aula de vídeo dentro Teams e convidar alunos para a sala de aula de vídeo. Os alunos podem ver e fazer seus cursos, programas e gerenciar evidências de portfólio. Os administradores também podem postar feeds de notícias. |
...
Essas informações foram fornecidas pelo OliveGroup sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
