---
title: Informações do aplicativo para OLIVE VLE by OliveGroup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o OLIVE VLE, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | OliveGroup |
...
| Funcionalidade principal do aplicativo | A Olive VLE ajuda os tutores e os provedores de educação a criar e gerenciar cursos, programas de aprendizagem e aprendizes. Os administradores de provedores de educação podem criar seus próprios cursos online, testes, atribuições, programas e atribuí-los aos aprendizes. Microsoft Teams é integrado usando API do Graph para que os administradores também possam criar sala de aula de vídeo no Teams e convidar aprendizes para a sala de aula de vídeo. Os aprendizes podem ver e fazer seus cursos, programas e gerenciar evidências de portfólio. Os administradores também podem postar feeds de notícias. |
...
Essas informações foram fornecidas pelo OliveGroup sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
