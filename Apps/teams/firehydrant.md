...
description: Todas as informações de segurança e conformidade disponíveis para FireHydrant, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pelo FireHydrant à Microsoft:
...
| Nome da empresa de parceiro | FireHydrant |
...
Essas informações foram fornecidas pelo FireHydrant sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | id da equipe, id de locatário, mensagens, nome de usuário |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | delegado | FireHydrant cria canais em nome de nossos usuários para gerenciar incidentes | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
