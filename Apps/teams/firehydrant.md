---
title: Informações do aplicativo para FireHydrant por FireHydrant
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Todas as informações de segurança e conformidade disponíveis para FireHydrant, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64878668"
---
# <a name="firehydrant"></a>FireHydrant

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 10 de fevereiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo FireHydrant para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | FireHydrant |
| ID | WA200003794 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | FireHydrant |
| Site da empresa | [https://firehydrant.io](https://firehydrant.io) |
| Termos de Uso do Aplicativo | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| Funcionalidade principal do aplicativo | Gerencie seus incidentes com FireHydrant.io. |
...
Essas informações foram fornecidas pelo FireHydrant sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Identidade do usuário (nome, email), dados de incidentes de canais do Teams |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | id da equipe, ID do locatário, mensagens, nome de usuário |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Delegada | O FireHydrant cria canais em nome de nossos usuários para gerenciar incidentes | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
