...
* <a href="https://teams.microsoft.com/l/app/220b3db0-e3be-40df-8148-f0e0c33a986a" target="_blank">Vista na loja Teams</a>
...
| URL de Termos de Uso | [https://support.starleaf.com/legal-information/starleaf-clo...](https://support.starleaf.com/legal-information/starleaf-cloud-services-customer-terms-of-use/) |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| O bot acessa a lista da equipe para marcar uma reunião em nome do usuário/host que reserva o encontro através do bot. Isso permite que o StarLeaf forneça uma experiência de junção perfeita com um botão para participar de reuniões. | Nome, sobrenome, endereço de e-mail. Isso permite que o bot StarLeaf reserve uma reunião em nome do usuário/host que interagiu com o bot e convide os outros membros da equipe para a reunião. |  |
