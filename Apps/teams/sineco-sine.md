---
title: Informações do aplicativo para o Seno por Sine.co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Sine, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b0d37fb7-080f-4288-992b-36790712c016" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Sine.co |
| Site da empresa | [https://www.sine.co](https://www.sine.co) |
| Termos de Uso do Aplicativo | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| Funcionalidade principal do aplicativo | Software de local de trabalho do Sine que melhora a segurança, a segurança, a conformidade do visitante e do trabalhador. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://www.sine.co](https://www.sine.co) |
