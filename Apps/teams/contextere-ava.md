---
title: Informações do aplicativo para Contextere AVA por Contextere
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Contextere AVA, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 13 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/be5caee0-f2bc-11ea-b597-ef970e2f5141" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003167" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Contextere à Microsoft:
...
| Nome da empresa parceira | Contexto |
| Site da empresa | [https://contextere.com](https://contextere.com) |
| Termos de Uso do Aplicativo | [https://contextere.com/wp-primary/wp-content/uploads/Contex...](https://contextere.com/wp-primary/wp-content/uploads/Contextere-End-User-License-Agreement-Microsoft-Challenge.pdf) |
| Funcionalidade principal do aplicativo | O Contextere Advanced Assistente Virtual (AVA) fornece insights sobre o trabalho para trabalhadores industriais. |
...
Essas informações foram fornecidas pelo Contextere sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| Data de certificação SOC3 mais recente | 2020-09-30 |
