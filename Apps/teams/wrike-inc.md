...
* <a href="https://teams.microsoft.com/l/app/05274a45-7312-4c23-8f64-d57fe4a28d6d" target="_blank">Exibir no Teams store</a>
...
| URL da página Teams de informações do aplicativo | [https://wrike.com](https://wrike.com) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| https://learn.wrike.com/subprocessor-list/ | Dados de contato do usuário, nome da empresa, tamanho da empresa | Dados necessários para o registro da conta no Wrike |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Dados nomes de usuários wrike e títulos de tarefa para menções personilizadas | mesmo que acima | mesmo que acima |
...
Essas informações foram fornecidas pela Wrike Inc. sobre como esse aplicativo lida com autenticação, autorização, práticas recomendadas de registro de aplicativos e outros critérios de Identidade.
