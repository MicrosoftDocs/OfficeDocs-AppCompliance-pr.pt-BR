...
description: Todas as informações de segurança e conformidade disponíveis para NE, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | NE |
| Site da empresa | [https://www.ne.se](https://www.ne.se) |
| Termos de Uso do Aplicativo | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| Funcionalidade principal do aplicativo | Um aplicativo do Teams que permite que os clientes ne acessem seus serviços de conteúdo de dentro das equipes. Ele também adiciona uma extensão de mensagem do Teams, permitindo que os usuários pesquisem a enciclopédia ne digitando @ne em um chat. |
| Localização da sede da empresa | Suécia |
| Página de informações do aplicativo | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
