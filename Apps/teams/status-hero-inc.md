---
title: Informações de aplicativo para Status Hero por Status Hero, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Status Hero, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66549338"
---
# <a name="status-hero"></a>Status Hero
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Status Hero, Inc. para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Status Hero |
| ID | WA200004205 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Status Hero, Inc. |
| Site da empresa | [https://statushero.com](https://statushero.com) |
| Termos de Uso do Aplicativo | [https://statushero.com/terms](https://statushero.com/terms) |
| Funcionalidade principal do aplicativo | O Status Hero transforma check-ins e dados assíncronos das ferramentas da sua equipe em relatórios concisos e insight. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Essas informações foram fornecidas pela Status Hero, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente | 2021-11-01 |
...
| URL da Política de Privacidade | https://statushero.com/privacy |
