...
description: Todas as informações de segurança e conformidade disponíveis para Tendfor, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/212fcd92-bc06-4746-85c4-f7b5d39579ba" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002996" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Tendfor para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Tendfor |
| ID | WA200002996 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Tendfor |
| Site da empresa | [https://www.tendfor.com](https://www.tendfor.com) |
...
| Funcionalidade principal do aplicativo | Um centro de contatos e um console do atendedor totalmente em destaque para Microsoft Teams. |
...
Essas informações foram fornecidas pelo Tendfor sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário, dados de calendário do usuário, Mídia de chamada |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil do usuário, dados de calendário do usuário |
...
| URL da Política de Privacidade | https://tendfor.com/en/contact/tendfor-privacy-notice/ |
...
| Listar os tipos de políticas com suporte | Todo e qualquer suporte do Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Para poder conectar usuários | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
...
>| User.Read.All | Delegada | Para poder importar informações do usuário | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
