---
title: Informações do aplicativo para Rafiky pela SRL do GLOBAL CONGRESS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Rafiky, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo GLOBAL CONGRESS SRL à Microsoft:
...
| Nome da empresa parceira | SRL DO CONGRESSO GLOBAL |
...
| Funcionalidade principal do aplicativo | Rafiky é uma solução de plataforma de nuvem extremamente flexível e acessível projetada para executar a interpretação simultânea remota para seus eventos online. É&#8217;visão única e inovadora da interpretação remota; ele permite que interpretadores profissionais trabalhem de qualquer lugar a qualquer momento. |
...
Essas informações foram fornecidas pelo SRL do GLOBAL CONGRESS sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
