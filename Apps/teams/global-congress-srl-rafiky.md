...
| Site da empresa | [https://rafiky.net/en/](https://rafiky.net/en/) |
| Termos de uso do aplicativo | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| Funcionalidade principal do aplicativo | O Rafiky é uma solução de plataforma de nuvem extremamente flexível e acessível projetada para executar a interpretação simultânea remota para seus eventos online. Ele&#8217;uma visão exclusiva e inovadora de interpretação remota; permite que os intérpretes profissionais trabalhem em qualquer lugar a qualquer momento. |
