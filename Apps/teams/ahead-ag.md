---
title: Informações do aplicativo para uso antecipado pelo AG antecipado
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o futuro, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66549354"
---
# <a name="ahead"></a>ahead

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 20 de maio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/53360535-c93f-497f-b2a1-95bd9aa34283" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004202" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo AG antecipado à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | ahead |
| ID | WA200004202 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | ahead AG |
| Site da empresa | [https://www.aheadintranet.com](https://www.aheadintranet.com) |
| Termos de Uso do Aplicativo | [https://www.aheadintranet.com/terms-and-conditions](https://www.aheadintranet.com/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Aplicativo de envolvimento do funcionário para manter os funcionários informados e envolvidos. |
...
Essas informações foram fornecidas pelo grupo de disponibilidade antecipado sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados relevantes para o funcionamento correto do produto de intranet antecipado. Isso inclui, mas não se limita a notícias, histórias, informações relacionadas ao direcionamento de conteúdo para grupos de usuários específicos, navegação e notificações. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados relevantes para o funcionamento correto do produto de intranet antecipado. Isso inclui, mas não se limita a notícias, histórias, informações relacionadas ao direcionamento de conteúdo para grupos de usuários específicos, navegação e notificações. Os dados relacionados ao usuário são cópias somente leitura de Azure AD. Isso é restrito à ID e ao nome do usuário e sua associação em grupos do Azure AD que foram marcados como relevantes no futuro. |
...
| URL da Política de Privacidade | https://www.aheadintranet.com/data-security |
...
| Listar os tipos de políticas com suporte | Aplicativo cliente |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegada | Notícias de destino de acordo com grupos do AD | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Directory.Read.All | aplicação | Notícias de destino de acordo com grupos do AD, para push | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| ExternalItem.Read.All | Delegada | Pesquisar conteúdo de fontes de terceiros (ServiceNow) | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Sites.Read.All | Delegada | Pesquisar conteúdo de sites do SharePoint | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | Delegada | Ler perfil do usuário | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | Delegada | Ler perfil do usuário (imagem etc.) | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | Delegada | Ler perfil do usuário | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | aplicação | Ler informações de perfil na pesquisa | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
