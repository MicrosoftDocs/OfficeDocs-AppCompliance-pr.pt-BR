---
title: Informações do aplicativo para Ideanote por ApS do Ideanote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Ideanote, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Ideanote ApS à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Ideanote |
| ID | WA200003876 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Ideanote ApS |
| Site da empresa | [https://ideanote.io](https://ideanote.io) |
| Termos de uso do aplicativo | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| Funcionalidade principal do aplicativo | Coletar, desenvolver e gerenciar ideias com inovação orientada por objetivo. |
| Localização da sede da empresa | Dinamarca |
| Página de informações do aplicativo | [https://ideanote.io](https://ideanote.io) |
...
Essas informações foram fornecidas pelo Ideanote ApS sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Informações sobre o token JWT obtidas do Usuário. Nome do Usuário, Email do Usuário. |
...
| URL da Política de Privacidade | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Precisamos de informações sobre o Usuário para entrar automaticamente na pessoa em sua conta do Ideanote. | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
