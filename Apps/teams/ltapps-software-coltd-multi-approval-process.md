---
title: Informações do aplicativo para LTAPPs de processo de várias aprovações por LTAPPs SOFTWARE CO.,LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: Todas as informações de segurança e conformidade disponíveis para LTAPPs do Processo de Multi-Aprovação, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c1ab19ab-6a95-4f02-b42f-c1df3415e8a8" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo LTAPPs SOFTWARE CO.,LTD para a Microsoft:
...
| Nome da empresa parceira | LTAPPs SOFTWARE CO.,LTD |
| Site da empresa | [https://ltaddins.com](https://ltaddins.com) |
| Termos de Uso do Aplicativo | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| Funcionalidade principal do aplicativo | O Processo de Aprovação Multifator é um aplicativo fácil de usar que permite que os usuários finais façam a solicitação. O aplicativo é totalmente personalizável, permitindo que os administradores mantenham a consistência com as especificações de suas organizações. |
...
Essas informações foram fornecidas pelo LTAPPs SOFTWARE CO.,LTD sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | A ID do locatário &amp; de informações do usuário | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |
