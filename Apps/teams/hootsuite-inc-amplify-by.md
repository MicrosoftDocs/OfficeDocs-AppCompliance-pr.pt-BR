...
description: Todas as informações de segurança e conformidade disponíveis para o Amplify by Hootsuite, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | Compartilhe conteúdo do Microsoft Teams para seus canais sociais de equipes, com a Tecnologia Desembolsar. |
