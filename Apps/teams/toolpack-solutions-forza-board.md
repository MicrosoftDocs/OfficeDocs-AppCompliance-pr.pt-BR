---
title: Informações do aplicativo para o Forza Board by Toolpack Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Forza Board, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b4db3055-5e98-4935-862e-7ffd42761eaa" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004274" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelas Soluções toolpack para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Forza Board |
| ID | WA200004274 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Soluções do Toolpack |
| Site da empresa | [https://www.toolpack365.com](https://www.toolpack365.com) |
| Termos de Uso do Aplicativo | [https://www.toolpack365.com/kontakt-og-vilkaar](https://www.toolpack365.com/kontakt-og-vilkaar) |
| Funcionalidade principal do aplicativo | Libere seu potencial com um KPI inteligente e relatórios para melhor colaboração. |
...
Essas informações foram fornecidas pelas Soluções toolpack sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | email e nome |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | email e nome |
...
| URL da Política de Privacidade | https://www.toolpack365.com/cookie-og-privatlivspolitik |
