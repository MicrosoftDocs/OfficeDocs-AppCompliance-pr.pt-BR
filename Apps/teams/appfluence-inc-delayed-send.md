---
title: Informações do aplicativo para envio atrasado pela Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Envio Atrasado, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66247892"
---
# <a name="delayed-send"></a>Envio atrasado
...
* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693a99f7fc3" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004301" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Envio atrasado |
| ID | WA200004301 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Appfluence Inc |
| Site da empresa | [https://appfluence.com](https://appfluence.com) |
| Termos de Uso do Aplicativo | [https://delayedsend.com/eula](https://delayedsend.com/eula) |
| Funcionalidade principal do aplicativo | Agende suas mensagens a serem enviadas no futuro para qualquer chat privado ou em grupo. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://delayedsend.com](https://delayedsend.com) |
...
| Quais dados são processados pelo seu aplicativo? | Lista de chats pessoais e de grupo no Teams, para ajudar o usuário a escolher para onde enviar uma mensagem. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | Delegada | Mostrar ao usuário que está em um chat para que ele entenda para onde está enviando sua mensagem | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| ChatMessage.Send | Delegada | Enviar uma mensagem em nome de nosso usuário | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.Read | Delegada | Entre no usuário e saiba o nome do usuário | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.ReadBasic.All | Delegada | Consulte a lista de colaboradores do usuário para permitir a seleção de um destino para sua mensagem atrasada | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| offline_access | Delegada | Permitir que nosso aplicativo atue como o usuário no horário de agendamento para entrega de mensagens | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
