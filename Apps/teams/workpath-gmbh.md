---
title: Informações do aplicativo para Workpath da Workpath GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Workpath, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
* <a href="https://teams.microsoft.com/l/app/8562f79a-0ba8-4555-a967-6e34bdfecca9" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003898" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Workpath GmbH para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Workpath |
| ID | WA200003898 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Workpath GmbH |
| Site da empresa | [https://www.workpath.com/en/home](https://www.workpath.com/en/home) |
| Termos de Uso do Aplicativo | [https://www.workpath.com/en/workpath-ms](https://www.workpath.com/en/workpath-ms) |
| Funcionalidade principal do aplicativo | Mantenha-se no topo de suas metas estratégicas com o Workpath OKRs. |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://workpath.zendesk.com/hc/en-us/articles/455508104360...](https://workpath.zendesk.com/hc/en-us/articles/4555081043602-Using-the-MS-Teams-integration) |
...
Essas informações foram fornecidas pela Workpath GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | ID do locatário,  |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | ID do locatário,  |
...
| URL da Política de Privacidade | https://www.workpath.com/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Para ler o locatário do usuário conectado | [dc8facfc-c606-44b4-a0ad-04f81446845c](../azure/dc8facfc-c606-44b4-a0ad-04f81446845c.md) |
