---
title: Informações do aplicativo para BrowserStack da BrowserStack Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para BrowserStack, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo BrowserStack Inc para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | BrowserStack |
| ID | WA200004404 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | BrowserStack Inc |
| Site da empresa | [https://www.browserstack.com](https://www.browserstack.com) |
| Termos de Uso do Aplicativo | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| Funcionalidade principal do aplicativo | Traga seus insights do BrowserStack diretamente para o Microsoft Teams! |
| Localização da sede da empresa | Índia |
| Página de informações do aplicativo | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
Essas informações foram fornecidas pela BrowserStack Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente | 2021-06-14 |
...
| URL da Política de Privacidade | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Entrar e ler o perfil do usuário para fins de autenticação | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |
