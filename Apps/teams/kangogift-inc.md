---
title: Informações do aplicativo para KangoGift da KangoGift, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o KangoGift, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65938664"
---
# <a name="kangogift"></a>KangoGift

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 13 de maio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/a19a36e4-c33d-4988-a706-5c740ccab0eb" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004174" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por KangoGift, Inc. à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | KangoGift |
| ID | WA200004174 |
| Clientes do Office 365 com suporte | Microsoft Teams |
| Nome da empresa parceira | KangoGift, Inc. |
| Site da empresa | [https://www.kangogift.com](https://www.kangogift.com) |
| Termos de Uso do Aplicativo | [https://www.kangogift.com/app_terms](https://www.kangogift.com/app_terms) |
| Funcionalidade principal do aplicativo | Envie reconhecimento e elogio. |
...
Essas informações foram fornecidas pelo KangoGift, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Informações básicas sobre usuários – nome, email. Isso é tratado em um contrato separado que temos com os clientes.  |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Informações básicas sobre usuários – nome, email. Isso é tratado em um contrato separado que temos com os clientes.  |
...
| URL da Política de Privacidade | https://www.kangogift.com/privacy |
