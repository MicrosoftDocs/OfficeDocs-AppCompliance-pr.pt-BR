---
title: Informações de aplicativo para o EducationHUB Lesmateriaal da Smartersoft B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o EducationHUB Lesmateriaal, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Smartersoft B.V. para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Smartersoft B.V. |
| Site da empresa | [https://smartersoft.nl](https://smartersoft.nl) |
| Termos de Uso do Aplicativo | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| Funcionalidade principal do aplicativo | Permitir que as escolas forneçam acesso direto ao conteúdo digital fornecido pela escola em vez de forçar os alunos a outro site. |
| Localização da sede da empresa | Países Baixos (o) |
| Página de informações do aplicativo | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
Essas informações foram fornecidas pelo Smartersoft B.V. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | ID de usuário, associação de grupo, conteúdo pessoal adicionado ao aplicativo |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | ID de usuário, ID de grupo, links fornecidos pelo usuário para conteúdo de escola digital |
...
| Listar os tipos de políticas com suporte | Tudo, a plataforma Microsoft é responsável por nos fornecer um token para um usuário. O administrador decide como o usuário é validado/forçado a usar a MFA |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Delegada | Informações de acesso salvas em atributos de extensão de grupo | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | Delegada | Informações sobre as equipes de usuários | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | Delegada | Logon | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
