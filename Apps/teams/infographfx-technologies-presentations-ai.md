---
title: Informações do aplicativo para IA de apresentações por tecnologias Infographfx
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Todas as informações de segurança e conformidade disponíveis para IA de Apresentações, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1f510555-b518-4084-84e0-18c7bebc807c" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Tecnologias Infographfx |
| Site da empresa | [https://presentations.ai](https://presentations.ai) |
| Termos de Uso do Aplicativo | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| Funcionalidade principal do aplicativo | Presentations.AI é uma ferramenta inteligente com melhores práticas de design para criar apresentações incríveis. |
...
Essas informações foram fornecidas pelas tecnologias infographfx sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Por quanto tempo os dados são retidos após o encerramento da conta? | Excluído dentro de 3 meses |
