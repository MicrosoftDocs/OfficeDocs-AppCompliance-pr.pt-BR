...
| Site da empresa | [https://mural.co](https://mural.co) |
| Termos de uso do aplicativo | [https://mural.co/terms](https://mural.co/terms) |
| Funcionalidade principal do aplicativo | Pense e colabore visualmente |
...
| Quais dados são processados pelo aplicativo? | O MURAL requer apenas Nome, Sobrenome e Endereço de Email para fins de logon. O tipo de dados a serem processados/armazenados dependeria do cliente |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | O MURAL exige apenas o nome, sobrenome e email do usuário para fins de logon e que o restante das informações armazenadas depende das informações que os clientes armazenam em seus murales. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | delegado | Files.read necessário para carregar documentos no MURAL. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | delegado | User.read porque o mural precisa de nome, sobrenome e email para criação de conta. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
