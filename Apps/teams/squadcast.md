---
title: Informações de aplicativo para Squadcast por Squadcast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Squadcast, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66892009"
---
# <a name="squadcast"></a>Squadcast

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 10 de janeiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Squadcast para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Squadcast |
| ID | WA200004390 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Squadcast |
| Site da empresa | [https://www.squadcast.com](https://www.squadcast.com) |
| Termos de Uso do Aplicativo | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| Funcionalidade principal do aplicativo | Gerenciamento efetivo de incidentes diretamente do MS Teams. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
Essas informações foram fornecidas pelo Squadcast sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário – somente nome de usuário, Email |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | ID da Equipe, Nome da equipe, ID do Canal, Nome do Canal, ID do Locatário |
...
| URL da Política de Privacidade | https://www.squadcast.com/privacy |
