...
description: Todas as informações de segurança e conformidade disponíveis para monday.com, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo monday.com à Microsoft:
...
| Site da empresa | [https://monday.com](https://monday.com) |
| Termos de Uso do Aplicativo | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| Funcionalidade principal do aplicativo | monday.com é um sistema operacional de trabalho versátil que capacita o trabalho em equipe remoto – para organizar, estruturar e simplificar todos os programas, projetos e processos.  Por meio do monday.com, você pode usar blocos de construção &#8211; como quadros, exibições, gráficos, automações e integrações – para criar aplicativos de fluxo de trabalho personalizados para executar processos, projetos e trabalho diário. Crie um novo monday.com ou adicione a um existente diretamente no Microsoft Teams e visualize facilmente o trabalho&#8217;equipe em um workspace colaborativo. |
...
| Data de certificação SOC1 mais recente | 2021-05-01 |
...
| Data de certificação SOC3 mais recente | 2021-05-01 |
