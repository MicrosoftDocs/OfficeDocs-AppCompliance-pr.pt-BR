---
title: Informações do aplicativo para o GuideSpark Communicate Cloud by GuideSpark
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o GuideSpark Communicate Cloud, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/34b870ca-2417-4660-b835-ebb18ee7ccf9" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | GuideSpark |
| Site da empresa | [https://guidespark.com](https://guidespark.com) |
| Termos de Uso do Aplicativo | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| Funcionalidade principal do aplicativo | Conduza a alteração organizacional direcionando seus públicos-alvo e acompanhe os dados de envolvimento por meio do GuideSpark Communicate Cloud. Expanda seus canais de entrega e acesse suas pessoas onde elas estão para facilitar comunicações internas eficazes. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
