---
title: Informações do aplicativo para CyReport by CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: Todas as informações de segurança e conformidade disponíveis para CyReport, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/10b18ffa-155e-4b1f-89d5-88401ba0aa64" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004272" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo CyTrack para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | CyReport |
| ID | WA200004272 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | CyTrack |
| Site da empresa | [https://web.cytrack.com](https://web.cytrack.com) |
| Termos de Uso do Aplicativo | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| Funcionalidade principal do aplicativo | Análise do local de trabalho e relatórios para informações de negócios sobre suas interações&#8217;de produtividade do &amp; Microsoft Team.  A solução analítica e de relatório fácil de usar para seus insights de negócios em sua equipe&#8217;produtividade, interações do cliente, tendências, qualidade de chamadas, custos de comunicação e muito mais. O CyReport para Microsoft Teams melhora a colaboração, o desempenho de comunicações comerciais e a eficiência, levando a uma experiência excepcional do cliente. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://web.cytrack.com/microsoft-teams/call-reporting-for-...](https://web.cytrack.com/microsoft-teams/call-reporting-for-microsoft-teams/) |
...
Essas informações foram fornecidas pelo CyTrack sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de Chamada do Teams |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de Chamada do Teams |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Austrália, Nova Zelândia, Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
...
| URL da Política de Privacidade | https://web.cytrack.com/privacy-policy-teams/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppRoleAssignment.ReadWrite.All | Delegada | Precisamos disso para criar servicePrincipal para conceder permissões de API Azure AD aplicativo no locatário dos clientes | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
>| Application.ReadWrite.All | Delegada | Precisamos dessa permissão para criar um Azure AD no locatário dos clientes que estamos usando para assinar os serviços de notificação de alteração para obter metadados relacionados a chamadas de equipes. | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
