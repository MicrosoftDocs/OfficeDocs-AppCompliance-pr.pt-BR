---
title: Informações do aplicativo para Marvel by Marvel
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Marvel, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2e7fb70e-f75d-4e85-997e-90ce89000f43" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Marvel para a Microsoft:
...
| Nome da empresa parceira | Marvel |
| Site da empresa | [https://marvelapp.com](https://marvelapp.com) |
| Termos de Uso do Aplicativo | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| Funcionalidade principal do aplicativo | Marvel - Wireframe, Design e Prototyping para todos |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://marvelapp.com](https://marvelapp.com) |
...
Essas informações foram fornecidas pela Marvel sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
