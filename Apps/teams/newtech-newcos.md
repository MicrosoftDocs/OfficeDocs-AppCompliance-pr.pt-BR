---
title: Informações do aplicativo para NewCOS da Newtech
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Todas as informações de segurança e conformidade disponíveis para NewCOS, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Newtech |
| Site da empresa | [https://newtech.com.ar](https://newtech.com.ar) |
| Termos de Uso do Aplicativo | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| Funcionalidade principal do aplicativo | Implante uma solução de comunicação inteligente de forma rápida, fácil e no modo de serviço. A plataforma NewCOS permite executar, gerenciar, monitorar e dar suporte à instalação de forma rápida, fácil e sem intervenção da TI.  Vamos com você para que o processo de adoção da tecnologia seja bem-sucedido. Facilitamos a adaptação das alterações nos workspaces colaborativos de hoje. Por meio da adoção Microsoft 365 podemos acelerar o processo de transformação digital em sua organização.  |
| Localização da sede da empresa | Argentina |
| Página de informações do aplicativo | [https://N.A](https://N.A) |
...
Essas informações foram fornecidas pela Newtech sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| perfil | Ambos | Esses dados são usados para autenticação em permissões de aplicativo | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | Ambos | Microsoft Teams uso, para relatar e controlar | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
