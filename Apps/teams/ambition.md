...
description: Todas as informações de segurança e conformidade disponíveis para a Ambição, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
* <a href="https://teams.microsoft.com/l/app/250ef61a-9fa3-434b-ae2a-0ecbe3f8116b" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Ambição para a Microsoft:
...
| Nome da empresa parceira | Ambição |
| Site da empresa | [https://ambition.com](https://ambition.com) |
| Termos de Uso do Aplicativo | [https://ambition.com/pages/terms/](https://ambition.com/pages/terms/) |
| Funcionalidade principal do aplicativo | Software de gamificação e treinamento para equipes de vendas. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://ambition.com](https://ambition.com) |
...
Essas informações foram fornecidas pela Ambição sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| Data de certificação SOC2 mais recente | 2021-02-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegada | Enviar notificações de ambição para o canal | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| Group.Read.All | Delegada | Configure uma notificação de Fluxo de Trabalho de Ambição para um canal específico dentro de uma equipe. | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| User.Read | Delegada | Para identificar o administrador que autorizou o aplicativo Ambição | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| User.ReadBasic.All | Delegada | Os emails de nomes do usuário &amp; para sincronizar usuários com suas contas de Ambição. | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| offline_access | Delegada | Para sincronizar Microsoft Teams dados enquanto os usuários estão offline. | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| openid | Delegada | Isso é necessário para usar o recurso de entrada da Microsoft | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
