---
title: Informações do aplicativo para freehand da InVision da InVisionApp, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Freehand by InVision, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela InVisionApp, Inc. à Microsoft:
...
| Nome da empresa parceira | InVisionApp, Inc. |
...
| Funcionalidade principal do aplicativo | Colabore em tempo real com um quadro de comunicações online. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
...
Essas informações foram fornecidas pela InVisionApp, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
