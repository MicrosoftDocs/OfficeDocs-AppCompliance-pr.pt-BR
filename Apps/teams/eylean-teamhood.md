---
title: Informações do aplicativo para o Teamhood por Eylean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Teamhood, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Eylean à Microsoft:
...
| Nome da empresa parceira | Eylean |
| Site da empresa | [https://teamhood.com](https://teamhood.com) |
| Termos de Uso do Aplicativo | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| Funcionalidade principal do aplicativo | O Teamhood é um software all-in-one de gerenciamento de projetos e tarefas para uma colaboração diária eficiente. O Teamhood fornece os recursos necessários para cada gerente de projeto e membro da equipe planejar, executar e relatar dados de trabalho. |
| Localização da sede da empresa | Lituânia |
| Página de informações do aplicativo | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
...
Essas informações foram fornecidas pelo Eylean sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
