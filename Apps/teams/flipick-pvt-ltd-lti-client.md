---
title: Informações do aplicativo para o cliente LTI da Flipick Pvt Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Cliente LTI, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Flipick Pvt Ltd |
...
| Funcionalidade principal do aplicativo | O aplicativo fornece um SSO (logon único) com um servidor LTI (interoperabilidade de ferramentas de Learning) para iniciar cursos. Ele é um Consumidor de Ferramentas LTI e dá suporte ao BLTI (Basic LTI). |
