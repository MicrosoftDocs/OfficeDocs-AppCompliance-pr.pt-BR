...
| Site da empresa | [https://flipick.com](https://flipick.com) |
| Termos de uso do aplicativo | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Funcionalidade principal do aplicativo | O aplicativo fornece um SSO (Single Sign On) com um servidor LTI (interoperabilidade de ferramentas Learning) para iniciar cursos. É um Consumidor de Ferramentas LTI e dá suporte a LTI Básico (BLTI). |
