...
description: Todas as informações de segurança e conformidade disponíveis para o Play by IntraActive, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65938662"
---
# <a name="play-by-intraactive"></a>Reproduzir por IntraActive
...
|:----------------|:-------------|
| Nome do aplicativo | Reproduzir por IntraActive |
| ID | WA200004169 |
| Clientes do Office 365 com suporte | Microsoft Teams |
| Nome da empresa parceira | Fellowmind Da dinamarca |
