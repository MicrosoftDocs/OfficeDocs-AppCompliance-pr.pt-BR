---
title: Informações do aplicativo para o Conector VoIP do POPP Cloud da POPP.Com, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/01/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Conector VoIP do POPP Cloud, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/b8e57f6b-31cf-468e-9e99-81f0395cb1f9" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela POPP.Com, Inc para a Microsoft:
...
| Nome da empresa parceira | POPP.Com, Inc |
| Site da empresa | [https://popp.com](https://popp.com) |
| Termos de Uso do Aplicativo | [https://popp.com/pvnterms/](https://popp.com/pvnterms/) |
| Funcionalidade principal do aplicativo | Fazer chamadas de Microsoft Teams usando o cliente MaxUC |
...
Essas informações foram fornecidas pela POPP.Com, Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | Delegada | IDs de usuário e nomes de exibição de membros do canal atual. O aplicativo usa isso para apresentar ao usuário uma lista de membros do canal a serem chamado. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| Chat.Read | Delegada |  Quais dados são coletados ou usados? Adicione uma justificativa para coletar ou usar os dados. IDs de usuário e nomes de exibição de membros do chat atual. O aplicativo usa isso para apresentar ao usuário uma lista de membros de chat para chamar. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| TeamMember.Read.All | Delegada | IDs de usuário e nomes de exibição de membros da equipe atual. O aplicativo usa isso para apresentar ao usuário uma lista de membros da equipe a serem chamado. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| User.Read.All | Delegada |  Quais dados são coletados ou usados? Adicione uma justificativa para coletar ou usar os dados. Os números de telefone comercial e móvel dos usuários. Isso é necessário para que as chamadas telefônicas para esses números possam ser iniciadas. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| openid | Delegada | Um token de autorização para o usuário, autorizando o aplicativo a acessar os outros API do Graph de extremidade listados em seu nome. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
