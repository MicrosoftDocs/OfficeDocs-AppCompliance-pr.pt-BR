...
description: Todas as informações de segurança e conformidade disponíveis para Wisembly, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Wisembly à Microsoft:
...
| Nome da empresa parceira | Wisembly |
| Site da empresa | [https://wisembly.com](https://wisembly.com) |
| Termos de Uso do Aplicativo | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| Funcionalidade principal do aplicativo | Criar eventos virtuais e híbridos simples e envolventes Seminários, conferências, workshops... Guia-o com sabedoria pelo seu projeto de evento, do início ao fim, seja qual for sua necessidade: home page personalizável, registro, organização de workshops e sessões plenárias, ferramentas de vídeo, recursos interativos e muito mais. |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://wisembly.com](https://wisembly.com) |
...
Essas informações foram fornecidas pelo Wisembly sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
