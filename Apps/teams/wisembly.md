...
| Funcionalidade principal do aplicativo | Criar eventos virtuais e híbridos simples e envolvente, seminários, conferências, workshops... Orienta você no projeto do evento, do início ao fim, independentemente das suas necessidades: homepage personalizável, registro, organização de workshops e sessões de plenária, ferramentas de vídeo, recursos interativos e muito mais. |
