---
title: Informações do aplicativo para Smy by Supermonday
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Smy, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2858d81b-9eb1-4ba1-a79b-b42390bb0015" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004190" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Supermonday para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Smy |
| ID | WA200004190 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Supermonday |
| Site da empresa | [https://supermonday.io](https://supermonday.io) |
| Termos de Uso do Aplicativo | [https://supermonday.io/conditions-generales-de-vente](https://supermonday.io/conditions-generales-de-vente) |
| Funcionalidade principal do aplicativo | Smy l'application de Supermonday pour Microsoft Teams |
...
Essas informações foram fornecidas pelo Supermonday sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | microsoft user, microsoft groups, outlook calendar availability |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | microsoft user, microsoft group |
...
| URL da Política de Privacidade | https://supermonday.io/politique-de-confidentialite |
