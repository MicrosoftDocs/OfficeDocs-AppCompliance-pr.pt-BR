---
title: Informações do aplicativo para Timeneye da DM Digital SRL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Timeneye, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/015bf4ec-bc37-4931-9862-ef8686da652b" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo DM Digital SRL para a Microsoft:
...
| Nome da empresa parceira | DM Digital SRL |
| Site da empresa | [https://www.dmdigital.it](https://www.dmdigital.it) |
| Termos de Uso do Aplicativo | [https://www.timeneye.com/terms-and-conditions](https://www.timeneye.com/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Acompanhe o tempo gasto em suas tarefas diretamente do Microsoft Teams! |
...
Essas informações foram fornecidas pelo DM Digital SRL sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegada | DateTime de início/término do evento, assunto do evento, ID do evento, URI da Web do evento. Gere sugestões com base em eventos de calendário. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Calendars.Read.Shared | Delegada | DateTime de início/término do evento, assunto do evento, ID do evento, URI da Web do evento. Usamos essas informações para gerar sugestões com base em eventos de calendário. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Directory.Read.All | Delegada | IDs dos grupos do usuário. Usamos essas informações para verificar os grupos dos qual o usuário é membro para que possamos sincronizar os planejadores de seus grupos. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Group.Read.All | Delegada | Nome do Grupo, ID do Grupo. Usamos essas informações ao sincronizar os projetos do planejador. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Tasks.Read | Delegada | nome da lista de tarefas, ID da lista de tarefas. Usamos essas informações ao sincronizar os projetos do planejador. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| User.Read | Delegada | email, nome. Usamos essas informações para fazer logon no usuário/criar a conta de usuário | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| User.ReadBasic.All | Delegada | nome de usuário, email. Usamos essas informações para que o usuário possa importar outros usuários do Planner/Microsoft para nosso serviço. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| email | Delegada | Email. Usamos essas informações para fazer logon no usuário/criar a conta de usuário | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| offline_access | Delegada | Permissão necessária para sincronizar o planejador/calendário enquanto o usuário não está online. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| openid | Delegada | id_token. Fazer logon no usuário por meio do SSO da Microsoft | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| perfil | Delegada | email, nome. Usamos essas informações para fazer logon no usuário/criar a conta de usuário | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
