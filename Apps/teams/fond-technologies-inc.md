---
title: Informações do aplicativo para afeiçoado pela Fond Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/04/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Fond, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63538149"
---
# <a name="fond"></a>Fond

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 17 de dezembro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/d25d7cc9-0a7e-41e2-ad98-f446141a8ffa" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003631" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Fond Technologies, Inc. à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Fond |
| ID | WA200003631 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Tecnologias Da Technologies, Inc. |
| Site da empresa | [https://fond.co](https://fond.co) |
| Termos de uso do aplicativo | [https://www.fond.co/tos/](https://www.fond.co/tos/) |
| Funcionalidade principal do aplicativo | Celebrar as conquistas de seus colegas de trabalho com o Fond |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://fond.co/products/features/fond-teams-integration/](https://fond.co/products/features/fond-teams-integration/) |
...
Essas informações foram fornecidas pela Fond Technologies, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | ID do Locatário do Cliente, Nome da Equipe, Nome do Canal, URL do Webhook |
...
| Data de certificação SOC2 mais recente |  2020-09-01 |
...
| URL da Política de Privacidade | https://www.fond.co/privacy/ |
