---
title: Informações de aplicativo para Koan da Koan, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Koan, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Koan, Inc. |
| Site da empresa | [https://www.koan.co](https://www.koan.co) |
| Termos de Uso do Aplicativo | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| Funcionalidade principal do aplicativo | Coloque o gerenciamento de metas e o acompanhamento de status diretamente Microsoft Teams para ver o progresso e manter suas equipes alinhadas. A integração&#8217;Koan permite que os funcionários se concentrem no trabalho mais importante sem precisar sair Microsoft Teams. Crie facilmente hábitos positivos de equipe de compartilhamento de status, reconhecimento de vitórias e identificação de preocupações no início, aumentando a barra para todas as outras pessoas ao seu redor. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
...
| Data de certificação SOC2 mais recente | 2021-01-15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegada | A ID do canal e o nome do canal são usados. Usamos os dados para que os usuários possam selecionar onde querem que as notificações de reflexão entregues. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | Ambos | A ID da equipe e o nome da equipe são coletados e usados. Usamos os dados para que os usuários possam selecionar onde querem que as notificações de reflexão entregues. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | Delegada | O nome de usuário, a ID de usuário e o endereço de email do usuário são usados. Usamos os dados para vincular contas de usuário entre Microsoft Teams e Koan. Ele se aplica apenas a menções. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
