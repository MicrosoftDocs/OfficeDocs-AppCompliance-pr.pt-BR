---
title: Informações do aplicativo para o Slido by Slido
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/02/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Slido, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/1517b59d-6d65-4316-a708-035adc659394" target="_blank">Exibir no Teams armazenamento</a>
...
| Site da empresa | [https://www.sli.do](https://www.sli.do) |
| Termos de Uso do Aplicativo | [https://www.sli.do/terms](https://www.sli.do/terms) |
| Funcionalidade principal do aplicativo | O Slido é a melhor QA&amp; e plataforma de sondagem para eventos e reuniões ao vivo e virtuais. Ele oferece QA interativa&amp;, votações ao vivo e insights sobre seu público-alvo. |
| Localização da sede da empresa | Eslováquia |
| Página de informações do aplicativo | [https://www.sli.do/product](https://www.sli.do/product) |
