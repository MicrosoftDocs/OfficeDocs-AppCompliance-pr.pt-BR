...
| Site da empresa | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Termos de uso do aplicativo | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Funcionalidade principal do aplicativo | Soluções de gerenciamento de senha DBit com menos problemas. DBit é uma ferramenta de gerenciamento de senhas para equipes de pequeno a grande porte. Com o DBit, você pode compartilhar senhas com segurança entre membros da equipe. As senhas compartilhadas e senhas geradas expirarão automaticamente após uma duração definida de minutos. Suas senhas são criptografadas na memória em nossos servidores e nunca são armazenadas no armazenamento em disco. Depois que suas senhas expiram, elas são removidas da memória do nosso servidor. Este aplicativo é desenvolvido pela Soluções Da Diamondsoft, LLC |
