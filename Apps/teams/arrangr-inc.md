...
| Quais dados são processados pelo aplicativo? | Nome de usuário, endereço de email, nomes de calendário, detalhes de eventos de calendário, nomes e email de colegas de equipe. |
