---
title: Informações do aplicativo para o Gateway por ponto de decisão
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Core, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Ponto de Decisão |
| Site da empresa | [https://decisionpoint.ai](https://decisionpoint.ai) |
| Termos de Uso do Aplicativo | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| Funcionalidade principal do aplicativo | O Kit é uma ferramenta de BI baseada em chat que é integrada a plataformas como o MS Teams. O Backup reduz as barreiras de adoção e elimina a necessidade de treinamento (de indivíduos) levando dados para as pessoas por meio de um aplicativo de colaboração.  O Backup mostra dados relevantes para um usuário na forma de Cartões insight e permite que ele se aprofunde neles usando filtros e ajuda na tomada de decisões mais rápida.  |
| Localização da sede da empresa | Índia |
| Página de informações do aplicativo | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
...
Essas informações foram fornecidas pelo Ponto de Decisão sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
