---
title: Informações do aplicativo para CLIPr pela CLIPr Co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a CLIPr, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66952603"
---
# <a name="clipr"></a>CLIPr

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 3 de dezembro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/2d6b2a6d-a20d-4206-a11c-e01d34d0d3a0" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003612" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela CLIPr Co para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | CLIPr |
| ID | WA200003612 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | CLIPr Co |
| Site da empresa | [https://www.clipr.ai](https://www.clipr.ai) |
| Termos de Uso do Aplicativo | [https://www.clipr.ai/terms-of-use](https://www.clipr.ai/terms-of-use) |
| Funcionalidade principal do aplicativo | A CLIPr usa IA/machine learning para tornar o conteúdo de vídeo pesquisável e acionável. |
...
Essas informações foram fornecidas pela CLIPr Co sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Coletamos o nome do usuário e o endereço de email. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Nome de usuário, endereço de email e o nome da empresa anexado à ID do locatário.  |
...
| URL da Política de Privacidade | https://www.clipr.ai/privacy-policy |
