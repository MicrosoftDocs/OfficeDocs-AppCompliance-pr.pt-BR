---
title: Informações do aplicativo para Sailpoint da SailPoint Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Sailpoint, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela SailPoint Technologies, Inc. à Microsoft:
...
| Nome da empresa parceira | SailPoint Technologies, Inc. |
| Site da empresa | [https://sailpoint.com](https://sailpoint.com) |
| Termos de Uso do Aplicativo | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| Funcionalidade principal do aplicativo | A solução de segurança de identidade do SailPoint casa o gerenciamento de acesso com segurança de identidade, garantindo que os trabalhadores tenham o acesso certo para fazer seu trabalho&#8211;não mais, nem menos. |
...
Essas informações foram fornecidas pela SailPoint Technologies, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC1 mais recente | 2020-10-31 |
