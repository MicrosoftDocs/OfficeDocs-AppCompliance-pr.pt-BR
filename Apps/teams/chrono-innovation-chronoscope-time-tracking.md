...
description: Todas as informações de segurança e conformidade disponíveis para o Controle de Tempo do Chronoscope, suas políticas de tratamento de dados, Microsoft Cloud App Security informações do catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | O chronoscope é uma plataforma inteligente de gerenciamento de tempo que aumenta a precisão dos dados e reduz os erros de entrada de tempo. Por meio de um assistente inteligente que se integra ao ecossistema existente, o Chronoscope facilita a entrada de tempo e fornece visibilidade aos dados para tomar decisões comerciais melhores. |
