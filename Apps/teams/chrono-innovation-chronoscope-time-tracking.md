---
title: Informações do aplicativo para o acompanhamento de tempo de cronoscópio por Chrono Innovation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Chronoscope Time Tracking, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Chrono Innovation para a Microsoft:
...
| Nome da empresa parceira | Cronograma de Inovação |
| Site da empresa | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| Termos de Uso do Aplicativo | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| Funcionalidade principal do aplicativo | O Chronoscope é uma plataforma de gerenciamento de tempo inteligente que aumenta a precisão dos dados e reduz os erros de entrada de tempo. Por meio de um assistente inteligente que se integra ao ecossistema existente, o Chronoscope facilita a entrada de tempo e fornece visibilidade dos dados para tomar melhores decisões de negócios. |
| Localização da sede da empresa | Canadá |
| Página de informações do aplicativo | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
Essas informações foram fornecidas pela Chrono Innovation sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | aplicação | as informações de conta de usuário do teams tenantId, teams addObjectId e teams. Ao vincular usuários do Chronoscope, estamos validando que o email está correspondendo a uma conta Teams para que possamos vincular a conta sem etapa manual do usuário | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
