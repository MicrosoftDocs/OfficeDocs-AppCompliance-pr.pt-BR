---
title: Informações de aplicativo para HubEngage da HubEngage, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Todas as informações de segurança e conformidade disponíveis para HubEngage, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66549339"
---
# <a name="hubengage"></a>HubEngage

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 12 de janeiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/d96b4f99-e4b8-4af8-ba3d-36675f9a5353" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003668" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela HubEngage, Inc. para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | HubEngage |
| ID | WA200003668 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | HubEngage, Inc. |
| Site da empresa | [https://www.hubengage.com](https://www.hubengage.com) |
| Termos de Uso do Aplicativo | [https://www.hubengage.com/privacy-policy/](https://www.hubengage.com/privacy-policy/) |
| Funcionalidade principal do aplicativo | O aplicativo HubEngage Teams permite que você acesse as comunicações da sua organização e outras informações relevantes de dentro do Teams. Você também pode enviar suas próprias postagens e gostar e comentar em outras postagens. |
...
Essas informações foram fornecidas pela HubEngage, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente | 2022-05-20 |
...
| URL da Política de Privacidade | https://www.hubengage.com/platform-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Ambas | Conhecer o usuário | [63e17eec-6b5f-476b-a26b-54fde8bd2c83](../azure/63e17eec-6b5f-476b-a26b-54fde8bd2c83.md) |
