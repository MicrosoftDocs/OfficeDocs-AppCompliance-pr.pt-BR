---
title: Informações de aplicativo para SwiftAssess por GamaLearn
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Todas as informações de segurança e conformidade disponíveis para SwiftAssess, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo GamaLearn à Microsoft:
...
| Nome da empresa parceira | GamaLearn |
...
| Funcionalidade principal do aplicativo | Uma loja única para todas as necessidades de Avaliação, que varia de metodologias e recursos tentados e verdadeiros que orientam sua jornada pela criação, entrega e acompanhamento de sua estratégia de transformação de avaliação em todos os níveis em sua organização. O SwiftAssess oferece várias soluções principais, recursos e fluxos de trabalho que simplificam e automatizam processos de avaliação reais em diferentes instituições. Isso aborda os padrões do setor quando se trata de segurança, acessibilidade, análise, banco de dados de itens e muito mais |
...
Essas informações foram fornecidas pelo GamaLearn sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
