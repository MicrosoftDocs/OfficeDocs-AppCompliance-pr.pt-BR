---
title: Informações do aplicativo para o Treinador de Bem-estar da Meditation.live, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Wellness Coach, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9913e2ed-5c17-4d66-b9e7-439290238f29" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Meditation.live, Inc. |
| Site da empresa | [https://welllnesscoach.live](https://welllnesscoach.live) |
| Termos de Uso do Aplicativo | [https://www.wellnesscoach.live/terms-of-service](https://www.wellnesscoach.live/terms-of-service) |
| Funcionalidade principal do aplicativo | Práticas físicas e mentais rápidas para manter você em movimento e motivado ao longo do dia.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://wellnesscoach.live/teams-app](https://wellnesscoach.live/teams-app) |
