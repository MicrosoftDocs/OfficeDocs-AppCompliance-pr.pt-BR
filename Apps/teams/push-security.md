---
title: Informações do aplicativo para segurança por push por push
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Segurança por Push, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66817594"
---
# <a name="push-security"></a>Segurança por push
...
* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Segurança por Push para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Segurança por push |
| ID | WA200002833 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Segurança por push |
| Site da empresa | [https://pushsecurity.com](https://pushsecurity.com) |
| Termos de Uso do Aplicativo | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| Funcionalidade principal do aplicativo | Ajudamos as empresas a serem mais produtivas com o SaaS, equipando os funcionários para usarem aplicativos com segurança. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
Essas informações foram fornecidas pela Segurança por Push sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | O push processa as horas de trabalho do cliente para fornecer alertas quando o cliente está trabalhando.  |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | O push armazena o horário de trabalho do cliente para fornecer alertas quando o cliente está trabalhando.  |
...
| URL da Política de Privacidade | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | aplicação | Listar canais para facilitar a instalação do bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | aplicação | Consultar o horário de trabalho do cliente para que não o mensagem seja enviada após o horário comercial | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | aplicação | Listar equipes para facilitar a instalação do bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | aplicação | Permitir que o bot se instale para uma equipe | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | aplicação | Permitir que o bot se instale para um usuário | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | aplicação | Listar usuários para que possamos mensagem para eles | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
