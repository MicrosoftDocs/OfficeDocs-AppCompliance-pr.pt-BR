...
description: Todas as informações de segurança e conformidade disponíveis para o Teamflect, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Grepsi Software para a Microsoft:
...
| Nome da empresa parceira | Grepsi Software |
...
| Funcionalidade principal do aplicativo | O Teamflect é uma solução de gerenciamento de desempenho e envolvimento de funcionários tudo em um criada para Microsoft Teams. Ele torna as pessoas mais produtivas e mais envolvidas com seus módulos reunião, meta/OKR, comentários, reconhecimento e tarefas |
...
Essas informações foram fornecidas pelo Grepsi Software sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | aplicação | Usamos essa permissão para acessar calendários de usuário para identificar as reuniões 1 a 1 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | Delegada | Diretório da empresa – usamos essa permissão para mostrar aos usuários finais uma lista de seus colegas ao executar uma pesquisa | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
