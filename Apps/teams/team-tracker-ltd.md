---
title: Informações do aplicativo para o Team Tracker by Team Tracker Ltd
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para o Team Tracker, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pelo Team Tracker Ltd à Microsoft:
...
| Nome da empresa de parceiro | Team Tracker Ltd |
...
| Funcionalidade principal do aplicativo | O Team Tracker é um primeiro aplicativo do usuário para reservar hot desks e ver quem está funcionando |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegado | Depois que um usuário define suas atividades para as próximas semanas, o Team Tracker atualiza o calendário dos usuários e sua disponibilidade com base em sua seleção.  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| MailboxSettings.Read | delegado | Usado para obter o timezone para criar eventos de calendário | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| User.Read | delegado | Verifica as informações dos usuários em relação ao perfil | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| email | delegado | Usado para verificar o email dos usuários | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| openid | delegado | Permite que os usuários entre com sua Office 365 de usuário | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| perfil | delegado | Verifica as informações básicas dos usuários em relação ao perfil | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
