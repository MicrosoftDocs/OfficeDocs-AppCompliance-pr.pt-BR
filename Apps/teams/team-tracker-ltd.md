...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | delegado | Depois que um usuário define suas atividades para as próximas semanas, o Team Tracker atualiza o calendário dos usuários e sua disponibilidade com base em sua seleção.  |
>| email | delegado | Usado para verificar o email dos usuários |
>| MailboxSettings.Read | delegado | Usado para obter o timezone para criar eventos de calendário |
>| openid | delegado | Permite que os usuários entre com sua Office 365 de usuário |
>| perfil | delegado | Verifica as informações básicas dos usuários em relação ao perfil |
>| User.Read | delegado | Verifica as informações dos usuários em relação ao perfil |
