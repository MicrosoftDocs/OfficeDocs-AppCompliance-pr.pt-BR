...
description: Todas as informações de segurança e conformidade disponíveis para Bright Remind Me, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a66ea116-3ae1-495b-9f5f-b4b59f19945b" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelos Aplicativos de Chat, LLC para a Microsoft:
...
| Nome da empresa parceira | Aplicativos de Chat, LLC |
...
| Funcionalidade principal do aplicativo | Obtenha lembretes de mensagens importantes quando for conveniente para você responder. |
