---
title: Informações do aplicativo para o Onsight Conexão byStream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Onsight Conexão, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64876328"
---
# <a name="onsight-connect"></a>Onsight Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 13 de abril de 2021</p>

* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002769" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Borderstream para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Onsight Connect |
| ID | WA200002769 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Librestream |
| Site da empresa | [https://librestream.com](https://librestream.com) |
| Termos de Uso do Aplicativo | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| Funcionalidade principal do aplicativo | Aprimora sua estratégia de transformação digital para capacitar seus funcionários e clientes com acesso imediato ao conteúdo, às pessoas, aos dados inteligentes e às diretrizes necessárias para inspecionar e resolver problemas rapidamente. Implantada globalmente, a Onsight Augmented Reality Platform aumenta a eficiência operacional em setores como fabricação, aviação, energia, equipamentos pesados e serviço de campo. |
...
Essas informações foram fornecidas peloStream sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
