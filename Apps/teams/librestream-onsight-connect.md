---
title: Informações do aplicativo para o Onsight Conexão pela Librestream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pelo Librestream para a Microsoft:
...
| Funcionalidade principal do aplicativo | Aprimora sua estratégia de transformação digital para capacitar seus funcionários e clientes com acesso imediato ao conteúdo, às pessoas, aos dados inteligentes e às diretrizes necessárias para inspecionar e resolver problemas rapidamente. Implantada globalmente, a Plataforma de Realidade Aumentada do Onsight aumenta a eficiência operacional em setores como fabricação, indústria, energia, equipamentos pesados e serviço de campo. |
...
Essas informações foram fornecidas pelo Librestream sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
