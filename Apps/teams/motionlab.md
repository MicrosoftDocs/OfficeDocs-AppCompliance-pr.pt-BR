---
title: Informações do aplicativo para Motionlab by Motionlab
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Motionlab, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Motionlab para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Motionlab |
| ID | WA200004250 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Motionlab |
| Site da empresa | [https://www.motionlab.io](https://www.motionlab.io) |
| Termos de Uso do Aplicativo | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| Funcionalidade principal do aplicativo | Crie facilmente vídeos personalizados diretamente no Microsoft Teams. |
...
Essas informações foram fornecidas pela Motionlab sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Informações necessárias para criar um vídeo personalizado. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Informações necessárias para criar um vídeo personalizado. |
