---
title: Informações do aplicativo para CyRecord by CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para CyRecord, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66546963"
---
# <a name="cyrecord"></a>CyRecord

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 27 de maio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">Exibir no AppSource</a>
...
| Funcionalidade principal do aplicativo | O CyRecord destina-se a usuários empresariais que exigem funcionalidade avançada para gravação de voz de suas chamadas telefônicas externas do Microsoft Teams.   A gravação de chamadas fornece fatos indisputados sobre chamadas telefônicas, resultando em uma resolução de controvérsias mais rápida. Melhore o atendimento ao cliente por meio de escuta e treinamento e atenda aos requisitos regulatórios. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |
