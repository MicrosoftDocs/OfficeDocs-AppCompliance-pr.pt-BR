---
title: Informações do aplicativo para DataFetch da DataFetch, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o DataFetch, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d6756140-a823-11ea-94d9-ddbe638eaf6b" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003961" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela DataFetch, Inc para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | DataFetch |
| ID | WA200003961 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | DataFetch, Inc |
| Site da empresa | [https://datafetch.io](https://datafetch.io) |
| Termos de Uso do Aplicativo | [https://datafetch.io/terms](https://datafetch.io/terms) |
| Funcionalidade principal do aplicativo | Pesquisar fontes de dados conectadas |
...
Essas informações foram fornecidas pela DataFetch, Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | id, name, tenantId, tenantName |
...
| URL da Política de Privacidade | https://datafetch.io/privacy-policy |
...
| Listar os tipos de políticas com suporte | Os usuários que estão inscritos em fontes de dados em vez de serem seus próprios não podem excluí-los. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | Delegada | Gerenciar os aplicativos do Teams instalados do usuário | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser | Delegada | Permitir que o Teams aplicativo se gerencie para um usuário | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| User.Read | Delegada | Entrar e ler o perfil do usuário | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| email | Delegada | Exibir o endereço de email do usuário | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| offline_access | Delegada | Manter acesso aos dados aos quais você concedeu acesso | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| openid | Delegada | Assinar identificação de usuários | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| perfil | Delegada | Exibir os perfis básicos dos usuários | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
