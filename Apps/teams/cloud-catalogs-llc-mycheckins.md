---
title: Informações do aplicativo para MyCheckins por Catálogos de Nuvem LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para MyCheckins, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo CLOUD Catalogs LLC para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | MyCheckins |
| ID | WA200004375 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | LLC de Catálogos de Nuvem |
| Site da empresa | [https://mycheckins.io](https://mycheckins.io) |
| Termos de Uso do Aplicativo | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Execute stand-ups assíncronos, retrospectivas e muito mais no Microsoft Teams. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://mycheckins.io](https://mycheckins.io) |
...
Essas informações foram fornecidas pelo LLC de Catálogos de Nuvem sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário, Email usuário, mensagens de usuário enviadas para o bot |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil do usuário, Email usuário, mensagens de usuário enviadas para o bot |
...
| URL da Política de Privacidade | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicação | Obtendo detalhes do usuário, como nome, sobrenome e endereço de email | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |
