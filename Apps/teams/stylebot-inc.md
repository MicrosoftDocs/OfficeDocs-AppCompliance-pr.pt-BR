---
title: Informações do aplicativo para Stylebot da Stylebot Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Stylebot, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Stylebot Inc |
...
| Funcionalidade principal do aplicativo | O Stylebot melhora sua escrita colocando um idioma moderno e um manual de estilo ao seu alcance |
