---
title: Informações do aplicativo para os achievers por achievers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Todas as informações de segurança e conformidade disponíveis para os Achievers, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "67048299"
---
# <a name="achievers"></a>Empreendedores
...
* <a href="https://teams.microsoft.com/l/app/76903584-359f-4e1e-9f6e-741f48322709" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000573" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelos Achievers à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Empreendedores |
| ID | WA200000573 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Empreendedores |
| Site da empresa | [https://www.achievers.com](https://www.achievers.com) |
| Termos de Uso do Aplicativo | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| Funcionalidade principal do aplicativo | Crie o Reconhecimento para seus colegas na plataforma Achievers com menos atrito dentro do ecossistema da Microsoft. |
| Localização da sede da empresa | Canadá |
| Página de informações do aplicativo | [https://www.achievers.com/connect/teams/](https://www.achievers.com/connect/teams/) |
...
Essas informações foram fornecidas pelos Achievers sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| Quais dados são armazenados em seus bancos de dados? | ID do locatário, ID do usuário, Email do usuário, Localidade do usuário, ID do Bot, Nome do bot, URL do serviço de Bot |
...
| Data de certificação SOC2 mais recente | 2021-12-25 |
...
| URL da Política de Privacidade | https://over.achievers.com/ilr_privacy_policy |
