---
title: Informações do aplicativo para Jabber da Cisco
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Jabber, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001496" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Cisco para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Jabber |
| ID | WA200001496 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Cisco |
| Site da empresa | [https://www.cisco.com](https://www.cisco.com) |
| Termos de Uso do Aplicativo | [https://www.cisco.com/c/en/us/products/universal-cloud-agre...](https://www.cisco.com/c/en/us/products/universal-cloud-agreement.html) |
| Funcionalidade principal do aplicativo | Faça chamadas de vídeo e cisco voice diretamente do MS Teams com o aplicativo Jabber. |
...
Essas informações foram fornecidas pela Cisco sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
