---
title: Informações do aplicativo para Jabber pela Cisco
ms.author: elmalova
author: elenamalova
ms.date: 02/23/2022
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para Jabber, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">Exibir no Teams store</a>
...
| Funcionalidade principal do aplicativo | Faça chamadas do Cisco Voice e vídeo diretamente do MS Teams com o Aplicativo Jabber. |
