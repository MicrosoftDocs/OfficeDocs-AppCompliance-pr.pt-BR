---
title: Informações do aplicativo para Miro por Miro
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/22/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Miro, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/8216e453-3db5-48ee-a3d6-5122f505c8a3" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas por Miro à Microsoft:
...
| Nome da empresa de parceiro | Miro |
...
| Funcionalidade principal do aplicativo | Plataforma de quadro de trabalho colaborativo online |
...
Essas informações foram fornecidas por Miro sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
