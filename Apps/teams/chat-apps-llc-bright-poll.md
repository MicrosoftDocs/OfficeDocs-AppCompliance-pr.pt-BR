...
| URL do site do parceiro | [https://brightpoll.app](https://brightpoll.app) |
| URL da Política de Privacidade | [https://www.brightpoll.app/privacy](https://www.brightpoll.app/privacy) |
| URL dos Termos de Uso | [https://brightpoll.app/terms/](https://brightpoll.app/terms/) |
...
>Identificadores exclusivos de equipe e usuário são armazenados para oferecer suporte e correção de erros. Os logs são mantidos por sete dias e excluídos posteriormente.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Controles organizacionais para dados armazenados pelo parceiro

Descrever como os administradores da organização podem controlar suas informações em sistemas parceiros? por exemplo, exclusão, retenção, auditoria, arquivamento, política de usuário final, etc.

>Os dados do usuário são armazenados apenas no banco de dados de produção e backups do Bright Poll. Esse banco de dados só pode ser acessado pelo aplicativo e pelo desenvolvedor principal.
...
<iframe height='1020' title='Microsoft Cloud App Security Informações' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/39110' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/39110" target="_blank">Exibir em uma nova guia</a>
