...
| Site da empresa | [https://churnzero.net](https://churnzero.net) |
| Termos de uso do aplicativo | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Funcionalidade principal do aplicativo | O ChurnZero é uma plataforma de Sucesso do Cliente em tempo real que ajuda as empresas de assinatura a combater o churn, expandir contas atuais, aumentar a adoção de produtos e otimizar a experiência do cliente. |
...
| Data de certificação SOC2 mais recente |  2020-11-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | A ID do Objeto do Azure do Usuário de delegação para correlacionar com um Usuário ChurnZero, a fim de identificar e autorizar esse Usuário durante uma sessão de bot futura. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
