---
title: Informações do aplicativo para Zesavi by Zesavi GmbH
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para a Zesavi, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
|:----------------|:-------------|
| Nome do aplicativo | Zesavi |
| ID | WA200003621 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Zesavi GmbH |
| Site da empresa | [https://zesavi.com](https://zesavi.com) |
| Termos de uso do aplicativo | [https://zesavi.com/en/impressum/](https://zesavi.com/en/impressum/) |
| Funcionalidade principal do aplicativo | O Zesavi permite que todos em uma empresa criem, editem documentações de vídeo curtas &amp; diretamente no navegador da Internet. |
...
| URL da Política de Privacidade | https://zesavi.com/en/datenschutz/ |
