---
title: Informações de aplicativo para huminos da SOE Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Todas as informações de segurança e conformidade disponíveis para huminos, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c0b70874-2c95-4be7-a0cb-0d893e25a2a3" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela SOE Technologies à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | huminos |
| ID | WA200003308 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | TECNOLOGIAS SOE |
| Site da empresa | [https://www.myokr.co](https://www.myokr.co) |
...
Essas informações foram fornecidas pela SOE Technologies sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegada | Obter detalhes do calendário do usuário para criar uma reunião 1:1 no calendário do usuário, atualizar ou excluir criado pela plataforma myOKR e mostrar slots de tempo livre | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read | Delegada | Usamos a ID de objeto do azure do usuário para fazer logon do usuário no aplicativo myOKR usando a autenticação da Microsoft no email | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read.All | aplicação | Sincronizar informações do usuário com a plataforma myOKR e exibe a análise de aplicativo myOKR para o administrador com base em vários cortes de usuário, como local, gerente de &amp; departamento | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| offline_access | Delegada | ID do usuário do Azure Active Directory | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| openid | Delegada | Usamos a ID de objeto do Azure do usuário para fazer logon do usuário no aplicativo myOKR usando a autenticação da Microsoft | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
