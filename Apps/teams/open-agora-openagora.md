...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | delegado | ID&#8217;do Azure Active Directory usuário. | Identificação do usuário, para garantir que os usuários possam ver e gerenciar apenas os dados visíveis para eles. |  |
