---
title: Informações do aplicativo para Meus Lembretes da Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Meus Lembretes, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66655822"
---
# <a name="my-reminders"></a>Meus Lembretes
...
* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693569f7fc3" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004342" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Meus Lembretes |
| ID | WA200004342 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Appfluence Inc |
| Site da empresa | [https://appfluence.com](https://appfluence.com) |
| Termos de Uso do Aplicativo | [https://teamsreminder.com/eula](https://teamsreminder.com/eula) |
| Funcionalidade principal do aplicativo | Agende uma mensagem de lembrete para ser enviada de volta para você por meio de nosso chatbot. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://teamsreminder.com](https://teamsreminder.com) |
...
| Quais dados são processados pelo seu aplicativo? | Liste os chats do usuário no Teams para ajudar o usuário a indicar se um lembrete está relacionado a uma conversa específica. |
...
| Se seu aplicativo não usar uma das bibliotecas acima, qual biblioteca ou biblioteca de autenticação ele usa? | next-auth/react |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | Delegada | Mostrar ao usuário que está em um chat para que ele entenda se um lembrete está associado a um chat | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.Read | Delegada | Entre no usuário e saiba o nome do usuário | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.ReadBasic.All | Delegada | Exibir o avatar dos colaboradores relacionados quando agendamos um lembrete relacionado a um chat pessoal com eles | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| offline_access | Delegada | Permitir que nosso aplicativo atue como o usuário no horário de agendamento para entrega de lembretes | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| perfil | Delegada | Entre no usuário e saiba o nome do usuário | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
