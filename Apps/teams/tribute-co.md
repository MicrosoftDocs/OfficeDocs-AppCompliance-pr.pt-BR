---
title: Informações do aplicativo para tributo por Tribute Co.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Tributo, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cfb46a87-a75b-4045-9f22-a0ae0614fd60" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Tribute Co. à Microsoft:
...
| Site da empresa | [https://www.tributementorship.com](https://www.tributementorship.com) |
| Termos de Uso do Aplicativo | [https://www.tributementorship.com/terms](https://www.tributementorship.com/terms) |
| Funcionalidade principal do aplicativo | O Tributo é um aplicativo de orientação moderno para organizações que promovem o crescimento, a colaboração e a conexão dos funcionários.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.tributementorship.com/how-it-works](https://www.tributementorship.com/how-it-works) |
...
Essas informações foram fornecidas pelo Tribute Co. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente | 2020-07-10 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente | 2020-07-10 |
