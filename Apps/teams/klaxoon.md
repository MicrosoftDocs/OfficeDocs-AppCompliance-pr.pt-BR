...
| Funcionalidade principal do aplicativo | A Klaxoon fornece acesso a um pacote completo de ferramentas colaborativas (quadro de comunicação, pesquisa, quizz, sondagem ao vivo, etc.) projetadas para aumentar a eficiência do trabalho em equipe. O pacote Klaxoon é acessível como um webapp, aplicativos móveis (Apple/Android) ou diretamente do Microsoft Teams (por meio de uma integração de tabulação) |
