---
title: Informações de aplicativo para Klaxoon da Klaxoon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Klaxoon, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Exibir na loja do Teams</a>
...
Informações fornecidas pelo Klaxoon à Microsoft:
...
| Nome da empresa parceira | Klaxoon |
| Site da empresa | [https://klaxoon.com](https://klaxoon.com) |
| Termos de Uso do Aplicativo | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| Funcionalidade principal do aplicativo | O Klaxoon fornece acesso a um conjunto completo de ferramentas colaborativas (quadro de comunicações, pesquisa, testes, sondagem ao vivo, etc.) projetado para aumentar a eficiência do trabalho em equipe. O pacote Klaxoon é acessível como um aplicativo Web, aplicativos móveis (Apple/Android) ou diretamente do Microsoft Teams (por meio de uma integração com Tab) |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://klaxoon.com](https://klaxoon.com) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? | Híbrido |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | Azure, Aws, Outros |
...
Essas informações foram fornecidas pelo Klaxoon sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | email, nome, sobrenome, avatar |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | email, nome, sobrenome, avatar |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Estados Unidos da América, França, Alemanha |
...
| URL da Política de Privacidade | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
| Listar os tipos de políticas com suporte | solicite detalhes |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | identificação do usuário e criação de conta | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| email | Delegada | identificação do usuário e criação de conta | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | Delegada | identificação do usuário e criação de conta | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | Delegada | identificação do usuário e criação de conta | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| perfil | Delegada | identificação do usuário e criação de conta | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
