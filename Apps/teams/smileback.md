...
description: Todas as informações de segurança e conformidade disponíveis para SmileBack, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo SmileBack para a Microsoft:
...
| Site da empresa | [https://smileback.com](https://smileback.com) |
| Termos de Uso do Aplicativo | [https://smileback.com/terms](https://smileback.com/terms) |
| Funcionalidade principal do aplicativo | O SmileBack é uma plataforma de satisfação do cliente projetada para provedores de serviços gerenciados, suporte técnico e equipes de suporte de TI. Nossas ferramentas CSAT + NPS&#174; ajudar os profissionais de TI a coletar, relatar e agir com base nos comentários dos clientes. A CSAT (Pesquisa de Satisfação do Cliente) ajuda você a entender sua taxa de satisfação atual do cliente, fornecendo uma medida instantânea e direta de cada interação do cliente (tíquetes de suporte). O NPS&#174; (Net Promoter Score) fornece insights sobre sua relação geral com o cliente. |
...
Essas informações foram fornecidas pelo SmileBack sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
