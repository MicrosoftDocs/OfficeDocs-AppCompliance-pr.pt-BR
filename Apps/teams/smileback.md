...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Exibir no Teams store</a>
...
| Nome da empresa de parceiro | SmileBack |
...
| Funcionalidade principal do aplicativo | O SmileBack é uma plataforma de satisfação do cliente projetada para Provedores de Serviços Gerenciados, Suporte técnico e equipes de suporte de TI. Nossas ferramentas de&#174; CSAT + NPS ajudam os profissionais de TI a coletar, relatar e agir nos comentários dos clientes. O CSAT (Customer Satisfaction Survey) ajuda você a entender sua taxa de satisfação do cliente atual, dando a você uma medida instantânea e direta de cada interação do cliente (tíquetes de suporte). O NPS&#174; (Net Promoter Score) fornece informações sobre seu relacionamento geral com o cliente. |
...
Essas informações foram fornecidas pelo SmileBack sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
