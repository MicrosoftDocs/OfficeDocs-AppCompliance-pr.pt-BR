---
title: Informações do aplicativo para Eva por OutThink Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Eva, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eddbe35e-8260-4878-99d2-946c4aac73f4" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004345" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela OutThink Ltd para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Eva |
| ID | WA200004345 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | OutThink Ltd |
| Site da empresa | [https://www.outthink.io](https://www.outthink.io) |
| Termos de Uso do Aplicativo | [https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-...](https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-and-Conditions.pdf) |
| Funcionalidade principal do aplicativo | Eva é uma assistente de IA que oferece suporte virtual a clientes OutThink que procuram gerenciar o risco humano de segurança cibernética em sua organização.  Ele fornece aos funcionários atualizações regulares sobre o progresso do treinamento e oferece comentários eficazes sobre seu desempenho, ajudando a aumentar o conhecimento de segurança cibernética. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://docs.outthink.io/integration-with-microsoft-teams/](https://docs.outthink.io/integration-with-microsoft-teams/) |
...
Essas informações foram fornecidas pela OutThink Ltd sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de Email do Usuário, Informações de Disponibilidade do Calendário do Usuário |
...
| URL da Política de Privacidade | https://outthink.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegada | Encontrar os próximos slots gratuitos disponíveis no calendário do usuário para permitir que ele reserve um slot para treinamento de segurança cibernética por meio do aplicativo Teams. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
>| User.Read | Delegada | Identificar usuários por endereço de email, para enviar mensagens a um usuário com um determinado endereço de email corporativo. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
