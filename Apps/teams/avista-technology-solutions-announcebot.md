---
title: Informações de aplicativo para AnnounceBot da Avista Technology Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: Todas as informações de segurança e conformidade disponíveis para AnnounceBot, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d13120dd-5961-4589-b470-19d9d01c6668" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003321" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | AnnounceBot |
| ID | WA200003321 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Soluções Tecnológicas Avista |
| Site da empresa | [https://announcebot.in](https://announcebot.in) |
| Termos de Uso do Aplicativo | [https://announcebot.in/terms.html](https://announcebot.in/terms.html) |
| Funcionalidade principal do aplicativo | Aniversários, aniversários e cumprimentos de aniversários em tempo há muito tempo com o AnnounceBot |
| Localização da sede da empresa | Índia |
| Página de informações do aplicativo | [https://announcebot.in](https://announcebot.in) |
...
| Quais dados são armazenados em seus bancos de dados? | Primeiro nome. Sobrenome |
