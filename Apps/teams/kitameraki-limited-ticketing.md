---
title: Informações do aplicativo para tíquetes por kitameraki limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: Todas as informações de segurança e conformidade disponíveis para tíquetes, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64879688"
---
# <a name="ticketing"></a>Emissão de Bilhetes
...
* <a href="https://teams.microsoft.com/l/app/aa6b770e-6b8c-4096-9648-5239295ecadc" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003945" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo kitameraki limitadas à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Emissão de Bilhetes |
| ID | WA200003945 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | kitameraki limitado |
| Site da empresa | [https://TeamsWork.app](https://TeamsWork.app) |
| Termos de Uso do Aplicativo | [https://TeamsWork.app/terms](https://TeamsWork.app/terms) |
| Funcionalidade principal do aplicativo | Interface &amp; do usuário intuitiva simples, aplicativo móvel pronto, logon único, &amp; conformidade de segurança, alta disponibilidade, pronto para análise |
| Localização da sede da empresa | Hong-Kong |
| Página de informações do aplicativo | [https://www.teamswork.app/ticketingapp](https://www.teamswork.app/ticketingapp) |
...
Essas informações foram fornecidas pelo kitameraki limitado sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de assinatura saaS, dados Teams de referência de conversa, dados de tíquete |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de assinatura saaS, dados Teams de referência de conversa, dados de tíquete |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegada | Para verificar se o usuário tem o aplicativo instalado a ele | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| Group.Read.All | Delegada | Para obter a lista de membros e proprietários da equipe, importante para o caso de uso do aplicativo | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| TeamsAppInstallation.ReadWriteForUser | Delegada | Para instalar o aplicativo ao usuário para que o usuário possa se conectar ao bot de notificação | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| User.Read.All | Delegada | Para obter o perfil completo do usuário | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| offline_access | Delegada | Para acessar dados em situação offline | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| openid | Delegada | Para fazer logon no usuário como eles mesmos | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| perfil | Delegada | Para obter o perfil básico do usuário | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
