---
title: Informações do aplicativo para FinTech Studio da FinTech Studio
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a FinTech Studio, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64974360"
---
# <a name="fintech-studios"></a>FinTech Studio

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 1º de março de 2022</p>

* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela FinTech Studio para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | FinTech Studio |
| ID | WA200003969 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | FinTech Studio |
| Site da empresa | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| Termos de Uso do Aplicativo | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| Funcionalidade principal do aplicativo | Business Intelligence controlado por IA |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
Essas informações foram fornecidas pela FinTech Studio sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário, nomes/IDs de equipe, nomes/IDs de canal (sem dados de mensagem), nomes/IDs de chat (sem dados de mensagem) |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil do usuário (nome, email, microsoft Graph acesso + tokens de atualização) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegada | Para solicitar ao usuário canais para compartilhar conteúdo de um módulo de tarefa no aplicativo | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | Delegada | Para enviar conteúdo compartilhado para canais de um módulo de tarefa no aplicativo | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | Delegada | Para solicitar ao usuário chats para compartilhar conteúdo de um módulo de tarefa no aplicativo | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | Delegada | Para enviar conteúdo compartilhado para chats de um módulo de tarefa no aplicativo | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | Delegada | É necessário obter as equipes que um usuário pode acessar para poder acessar os canais disponíveis para o usuário | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | Delegada | Para obter informações de identificação e comunicação sobre o usuário | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
