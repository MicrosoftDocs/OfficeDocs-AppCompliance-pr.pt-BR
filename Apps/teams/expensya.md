---
title: Informações de aplicativo para Expensya por Expensya
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Expensya, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Expensya à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Expensya |
| ID | WA200003924 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Expensya |
| Site da empresa | [https://www.expensya.com](https://www.expensya.com) |
| Termos de Uso do Aplicativo | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| Funcionalidade principal do aplicativo | O Expensya automatiza os gastos empresariais, de ponta a ponta, do processamento de faturas aos cartões corporativos |
...
Essas informações foram fornecidas pelo Expensya sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Perfil da empresa, perfis de usuário (funcionários) e itens de Gastos Comerciais |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Tokens Graph Microsoft (conforme nos integramos ao Teams!) |
...
| URL da Política de Privacidade | https://www.expensya.com/en/legal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicação | Precisamos do nome completo do usuário e do email | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
