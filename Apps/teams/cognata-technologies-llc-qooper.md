---
title: Informações do aplicativo para Qooper da COGNATA TECHNOLOGIES, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Todas as informações de segurança e conformidade disponíveis para qooper, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | TECNOLOGIAS COGNATA, LLC |
| Site da empresa | [https://qooper.io](https://qooper.io) |
| Termos de Uso do Aplicativo | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| Funcionalidade principal do aplicativo | Atingir metas com conteúdo de conexões significativas &amp; . Envolva suas pessoas com conexões significativas e conteúdo por meio de orientação, treinamento de pares, aprendizado da comunidade e rede. A Qooper faz parcerias com empresas, universidades e organizações sem fins lucrativos de todos os tamanhos para automatizar o trabalho de gerenciamento de programas de orientação, conectar pessoas em uma plataforma interativa de aprendizado de orientação e exibir a análise do programa. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://qooper.io](https://qooper.io) |
...
Essas informações foram fornecidas pela COGNATA TECHNOLOGIES, LLC sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
