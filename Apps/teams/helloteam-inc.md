---
title: Informações de aplicativo para HelloTeam por HelloTeam Inc.
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para HelloTeam, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/58426e2f-12cd-4b86-bae3-37feb09bf146" target="_blank">Exibir no Teams store</a>
...
| Nome da empresa de parceiro | HelloTeam Inc. |
...
| Funcionalidade principal do aplicativo | Plataforma de Sucesso de Pessoas all-in-one para a força de trabalho moderna |
