---
title: Informações do aplicativo para GoLinks por GoLinks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: Todas as informações de segurança e conformidade disponíveis para GoLinks, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo GoLinks para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | GoLinks |
| ID | WA200003853 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | GoLinks |
| Site da empresa | [https://www.golinks.io](https://www.golinks.io) |
| Termos de uso do aplicativo | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| Funcionalidade principal do aplicativo | Os GoLinks, conhecidos como links de go, golinks, go/links ou go-links, são links curtos intuitivos e fáceis de lembrar, compartilhados pelas equipes. Ele transforma URLs longas e feias em links de ida e volta que podem ser usados diretamente em navegadores, emails, chats e conversas. O GoLinks permite que as empresas acessem de forma eficiente e eficiente e compartilhem informações e recursos de trabalho em escala. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
Essas informações foram fornecidas pelo GoLinks sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Armazenamos apenas a ID do locatário da Microsoft. |
...
| Data de certificação SOC2 mais recente |  2021-10-31 |
...
| URL da Política de Privacidade | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | aplicação | Precisamos acessar as mensagens em canais públicos para verificar se a mensagem contém um go/link. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
