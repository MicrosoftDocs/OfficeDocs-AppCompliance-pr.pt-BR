---
title: Informações de aplicativo para Moneypenny da CALLITECH LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Moneypenny, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela CALLITECH LIMITED à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Moneypenny |
| ID | WA200003396 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | CALLITECH LIMITADA |
| Site da empresa | [https://www.moneypenny.com](https://www.moneypenny.com) |
| Termos de Uso do Aplicativo | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| Funcionalidade principal do aplicativo | A principal funcionalidade do aplicativo é que os Teams integrem suas organizações para receber chamadas do Moneypenny por meio de um Bot |
...
Essas informações foram fornecidas pela CALLITECH LIMITED sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | ID do Locatário da Microsoft, ID de Objeto da Microsoft |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | ID do Locatário da Microsoft, ID de Objeto da Microsoft |
...
| Se seu aplicativo não usar uma das bibliotecas acima, qual biblioteca ou biblioteca de autenticação ele usa? | Microsoft Identity Web |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | aplicação | Para transmitir mídia do Bot para o Teams usuário | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
>| Calls.Initiate.All | aplicação | Para fazer uma chamada a um Teams por meio de um Bot | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
