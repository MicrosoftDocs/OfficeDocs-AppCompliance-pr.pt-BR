---
title: Informações de aplicativo para Moneypenny por CALLITECH LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Exibir no Teams store</a>
...
| Nome da empresa de parceiro | CALLITECH LIMITADA |
...
| Funcionalidade principal do aplicativo | A funcionalidade principal do aplicativo é que os usuários Teams a integração de suas organizações para receber chamadas do Moneypenny por meio de um Bot |
...
| Quais dados são armazenados em seus bancos de dados? | ID do Locatário da Microsoft, ID do objeto Microsoft |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | aplicação | Para transmitir mídia do Bot para o usuário Teams usuário | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
>| Calls.Initiate.All | aplicação | Para fazer uma chamada para um usuário Teams por meio de um Bot | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
