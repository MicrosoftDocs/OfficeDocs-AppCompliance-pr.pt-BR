...
ms.locfileid: "52250900"
---
# <a name="cai-adoption-bot"></a>C.AI bot de adoção
...
|:----------------|:-------------|
| Nome do aplicativo | C.AI bot de adoção |
| ID | WA200002633 |
| Recursos | Bot, Guia |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | contexxt.ai |
| URL do site do parceiro | [https://www.contexxt.ai](https://www.contexxt.ai) |
| URL da página Teams de informações do aplicativo | [https://contexxt.ai/sphere/cai-adoption-bot](https://contexxt.ai/sphere/cai-adoption-bot) |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Não é possível evitar tecnicamente, Microsoft Teams envia automaticamente (id do usuário) | Não |  |
