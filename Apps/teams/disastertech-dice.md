---
title: Informações do aplicativo para DisasterTech DICE da DisasterTech
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
| Site da empresa | [https://www.disastertech.com](https://www.disastertech.com) |
| Termos de Uso do Aplicativo | [https://dice.disastertech.com/tos.html](https://dice.disastertech.com/tos.html) |
| Funcionalidade principal do aplicativo | O DICE (Ambiente de Colaboração Integrada) de Ciência de Dados de Desastre fornece visualização de dados baseada na Web e software de exploração de dados com ferramentas de ciência de dados e análise de autoatendimento definidas pelo usuário e por autoatendimento. O DICE fornece acesso ao inventário de dados de risco de desastre mais abrangente a ser explorado em tempo real antes, durante e após desastres. |
