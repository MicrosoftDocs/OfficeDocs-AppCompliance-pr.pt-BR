---
title: Informações do aplicativo para Gerenciamento de Serviços Efecte pela Efecte Oyj
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Gerenciamento de Serviços da Efecte, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63553341"
---
# <a name="efecte-service-management"></a>Gerenciamento de Serviço de Infecção
...
* <a href="https://teams.microsoft.com/l/app/1c20b1ea-7f9f-496a-a577-8b1bb1a28228" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003830" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Efecte Oyj à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Gerenciamento de Serviço de Infecção |
| ID | WA200003830 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Efecte Oyj |
| Site da empresa | [https://www.efecte.com](https://www.efecte.com) |
| Termos de uso do aplicativo | [https://www.efecte.com/terms-of-service](https://www.efecte.com/terms-of-service) |
| Funcionalidade principal do aplicativo | Receber notificações sobre novos tíquetes no ESM (Gerenciamento de Serviços do Efecte) |
| Localização da sede da empresa | Finlândia |
| Página de informações do aplicativo | [https://www.efecte.com/ms-teams-integration](https://www.efecte.com/ms-teams-integration) |
...
Essas informações foram fornecidas pelo Efecte Oyj sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://www.efecte.com/privacy-policy |
