...
description: Todas as informações de segurança e conformidade disponíveis para SurveyMonkey, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 25 de outubro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/0fd925a0-357f-4d25-8456-b3022aaa41a9" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo SurveyMonkey para a Microsoft:
...
| Site da empresa | [https://www.surveymonkey.com](https://www.surveymonkey.com) |
| Termos de Uso do Aplicativo | [https://www.surveymonkey.com/mp/legal/terms-of-use/](https://www.surveymonkey.com/mp/legal/terms-of-use/) |
| Funcionalidade principal do aplicativo | Colabore e capture comentários e sentimentos dos funcionários por meio de pesquisas e votações rápidas. Capture os resultados em um só lugar para manter a equipe atualizada com novas respostas. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://help.surveymonkey.com/articles/en_US/kb/Microsoft-T...](https://help.surveymonkey.com/articles/en_US/kb/Microsoft-Teams-Integration) |
