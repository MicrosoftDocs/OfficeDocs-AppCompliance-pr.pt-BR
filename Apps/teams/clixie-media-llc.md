---
title: Informações do aplicativo para Clixie por Clixie Media LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Clixie, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/3ff43e1b-180b-4aab-916e-e49aaaefbccb" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003880" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Clixie Media LLC à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Clixie |
| ID | WA200003880 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Clixie Media LLC |
| Site da empresa | [https://clixiemedia.com](https://clixiemedia.com) |
| Termos de uso do aplicativo | [https://clixiemedia.com/terms-and-conditions/](https://clixiemedia.com/terms-and-conditions/) |
| Funcionalidade principal do aplicativo | Clixie pega gravações de sessão de reunião ao vivo ou híbrida e as transforma em módulos de treinamento úteis, envolvedores e memoráveis sob demanda que o Clixie atualiza automaticamente em tempo real; com certificação e dados à vista que você pode usar para tomar decisões. O microapreendedor, a capítuloagem com bloqueios, avaliações /enquetes em vídeo, aprendizado adaptável e gamificação são apenas alguns dos recursos avançados projetados para impulsionar o envolvimento. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://clixiemedia.com](https://clixiemedia.com) |
...
Essas informações foram fornecidas pelo Clixie Media LLC sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://clixiemedia.com/privacy-policy/ |
