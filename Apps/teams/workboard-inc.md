...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | endereço de email e ids dos usuários.  Ele é usado para mapear o usuário para a ID de usuário da WorkBoard | [User.Read](https://docs.microsoft.com/microsoft-365-app-certification/azure/User.Read) |
