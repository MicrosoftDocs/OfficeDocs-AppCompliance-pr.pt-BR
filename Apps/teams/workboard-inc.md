...
| Site da empresa | [https://www.workboard.com](https://www.workboard.com) |
| Termos de uso do aplicativo | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| Funcionalidade principal do aplicativo | Alinhe prioridades estratégicas por meio da organização e localize os objetivos e os principais resultados (OKRs) para equipes e indivíduos entre funcionalidades. Chart, calculate and share progress on key results and success metrics.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
| Data de certificação SOC1 mais recente |  2020-07-31 |
...
| Data de certificação SOC2 mais recente |  2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | endereço de email e ids dos usuários.  Ele é usado para mapear o usuário para a ID de usuário da WorkBoard | [User.Read](../azure/User.Read.md) |
