---
title: Informações do aplicativo para o Dost – Bot de linguagem inclusiva da ishield Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Dost – Bot de Linguagem Inclusiva, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66546974"
---
# <a name="dost---inclusive-language-bot"></a>Dost - Bot de Linguagem Inclusiva
...
* <a href="https://teams.microsoft.com/l/app/14a29007-c5ca-4a2d-9228-b0217d8403d7" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004214" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela ishield Technologies, Inc. à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Dost - Bot de Linguagem Inclusiva |
| ID | WA200004214 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | ishield Technologies, Inc. |
| Site da empresa | [https://ishield.ai](https://ishield.ai) |
| Termos de Uso do Aplicativo | [https://ishield.ai/terms-of-service/](https://ishield.ai/terms-of-service/) |
| Funcionalidade principal do aplicativo | Promova mensagens inclusivas no local de trabalho, colaboração e comunicações em suas equipes com a ajuda do Dost. Quando você adiciona o Dost ao seu workspace do Microsoft Teams, o Dost o orientará a usar o idioma inclusivo em suas mensagens por meio de sugestões e material de educação.  O Dost mostra os momentos de aprendizado em tempo real quando os usuários postam mensagens que contêm desvios inconscientes, microagressões ou linguagem não inclusiva com recomendações para modificá-la e torná-la mais inclusiva. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://getdost.com](https://getdost.com) |
...
Essas informações foram fornecidas pela ishield Technologies, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | O aplicativo processa mensagens do MS Teams no escopo do Teams e chat, mas não armazena mensagens ou detalhes do usuário |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | aplicação | Ler mensagens no escopo do Teams para fornecer comentários ao usuário sobre o idioma não inclusivo | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
>| ChatMessage.Read.Chat | aplicação | Ler mensagens no escopo do Chat para fornecer comentários ao usuário sobre o idioma não inclusivo | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
