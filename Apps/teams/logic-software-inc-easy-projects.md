---
title: Informações do aplicativo para projetos fáceis da Logic Software Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Projetos Fáceis, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ee27dd0c-3a49-4c09-8faa-6c6e0163bae5" target="_blank">Exibir no Teams armazenamento</a>
...
| URL do site do parceiro | [https://www.easyprojects.net](https://www.easyprojects.net) |
| URL da página Teams informações do aplicativo | [https://www.easyprojects.net](https://www.easyprojects.net) |
| URL da Política de Privacidade | [https://www.easyprojects.net/privacy/](https://www.easyprojects.net/privacy/) |
| URL dos Termos de Uso | [https://www.easyprojects.net/hosting-agreement/](https://www.easyprojects.net/hosting-agreement/) |
...
Essas informações foram fornecidas pela Logic Software Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
<iframe height='1020' title='Microsoft Cloud App Security informações' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/10134' frameborder='no'></iframe>
...
Essas informações foram fornecidas pela Logic Software Inc. sobre como esse aplicativo lida com autenticação, autorização, práticas recomendadas de registro de aplicativo e outros critérios de identidade.
...
| Seu aplicativo usa a MSAL (Biblioteca de Autenticação da Microsoft) para autenticação? | Na |
