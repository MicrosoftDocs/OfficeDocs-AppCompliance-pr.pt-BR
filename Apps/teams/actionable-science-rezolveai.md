---
title: Informações do aplicativo para Rezolve.ai por ciência acionável
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Rezolve.ai, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Ciência Acionável para a Microsoft:
...
| Nome da empresa parceira | Ciência acionável |
| Site da empresa | [https://www.rezolve.ai](https://www.rezolve.ai) |
| Termos de Uso do Aplicativo | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| Funcionalidade principal do aplicativo | O aplicativo fornece funcionalidade abrangente do Employee Service Desk – incluindo a capacidade de a) Criar e atualizar tíquetes b) Responder perguntas de rotina c) Automatizar tarefas comuns, como provisionamento ou integração  |
...
Essas informações foram fornecidas pela Ciência Acionável sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC1 mais recente | 2019-12-31 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 2)? | Sim |
| Data de certificação SOC2 mais recente | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Entrar e ler o perfil do usuário | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
