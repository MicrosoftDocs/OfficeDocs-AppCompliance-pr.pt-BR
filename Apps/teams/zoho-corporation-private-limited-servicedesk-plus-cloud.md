---
title: Informações do aplicativo para ServiceDesk Plus Cloud da Zoho Corporation Private Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o ServiceDesk Plus Cloud, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000037" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | ServiceDesk Plus Cloud |
| ID | WA200000037 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Zoho Corporation Private Limited |
| Site da empresa | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| Termos de Uso do Aplicativo | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| Funcionalidade principal do aplicativo | O ServiceDesk Plus é um software de gerenciamento de suporte técnico de TI SaaS. Com a infinidade de recursos para o Gerenciamento de Serviços de TI, ele ajuda os gerentes de TI a organizar efetivamente as operações de suporte técnica dentro da organização. Por padrão, o ServiceDesk Plus (nuvem) funciona com Azure AD. Para começar, inscreva-se no ServiceDesk Plus (nuvem) usando uma conta em sua instância do Azure AD. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Entrar e ler o perfil do usuário | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | Delegada | Manter acesso aos dados aos quais você concedeu acesso | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
