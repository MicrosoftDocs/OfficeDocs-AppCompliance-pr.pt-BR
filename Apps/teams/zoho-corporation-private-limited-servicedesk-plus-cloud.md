...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Exibir no Teams store</a>
...
| Funcionalidade principal do aplicativo | ServiceDesk Plus é um software de gerenciamento de suporte de SUPORTE de IT SaaS. Com a infinidade de recursos para o Gerenciamento de Serviços de IT, ele ajuda os gerentes de IT a organizar efetivamente as operações de help desk dentro da organização. Por padrão, ServiceDesk Plus (Nuvem) funciona com o Azure AD. Para começar, inscreva-se no ServiceDesk Plus (Cloud) usando uma conta em sua instância do Azure AD. |
...
| Quais dados são armazenados em seus bancos de dados? | ID do usuário, Nome de Usuário, Endereço de Email |
...
| Listar os tipos de políticas com suporte | Autenticação multifagável, exigindo dispositivos gerenciados pela organização para aplicativos específicos, Bloqueando comportamentos de entrada arriscados, limitando o acesso dado a outras pessoas que não as funções administrativas  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Entrar e ler o perfil do usuário | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a) |
>| offline_access | delegado | Manter acesso aos dados aos quais você concedeu acesso | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a) |
