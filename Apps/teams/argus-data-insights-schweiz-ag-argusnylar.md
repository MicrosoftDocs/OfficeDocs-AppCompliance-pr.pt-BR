---
title: Informações de aplicativo para ARGUSnylar da ARGUS DATA INSIGHTS Ag
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Todas as informações de segurança e conformidade disponíveis para ARGUSnylar, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo ARGUS DATA INSIGHTS Insights Ag para a Microsoft:
...
| Nome da empresa parceira | INSIGHTS DE DADOS DO ARGUS Schweiz AG |
| Site da empresa | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| Termos de Uso do Aplicativo | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| Funcionalidade principal do aplicativo | O ARGUSnylar é a extensão útil para sua conta. |
| Localização da sede da empresa | Suíça |
| Página de informações do aplicativo | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
Essas informações foram fornecidas pelo ARGUS DATA INSIGHTS– Ag da Insights sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | aplicação | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |
