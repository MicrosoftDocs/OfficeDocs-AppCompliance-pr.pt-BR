---
title: Informações do aplicativo para Wired2Perform por Wired2Perform
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Wired2Perform, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Wired2Perform |
| Site da empresa | [https://wired2perform.com](https://wired2perform.com) |
| Termos de Uso do Aplicativo | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| Funcionalidade principal do aplicativo | O Wired2Perform&#174;, uma empresa orientada por propósitos, combina ciência comportamental e análise avançada para sincronizar as pessoas com as melhores oportunidades disponíveis e ajudar os líderes de talentos a crescer, otimizar e acessar uma força de trabalho mais adaptável. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://wired2perform.com](https://wired2perform.com) |
