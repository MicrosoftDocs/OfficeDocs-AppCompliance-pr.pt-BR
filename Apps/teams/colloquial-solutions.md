---
title: Informações de aplicativo para colloquial por soluções coloquiais
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/25/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Colloquial, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "67016901"
---
# <a name="colloquial"></a>Coloquial

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 30 de junho de 2022</p>

* <a href="https://teams.microsoft.com/l/app/79b08482-6a09-41ff-a303-7ad2fd9c3531" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004395" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelas Soluções Coloquial para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Coloquial |
| ID | WA200004395 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Soluções coloquiais |
| Site da empresa | [https://www.colloquial.io](https://www.colloquial.io) |
| Termos de Uso do Aplicativo | [https://app.colloquial.io/terms](https://app.colloquial.io/terms) |
| Funcionalidade principal do aplicativo | Um aplicativo direto para coleta e compartilhamento de recursos, processos, aplicativos e conhecimento de tecnologia em sua organização. Normalmente conhecido como um portfólio ou catálogo. Esse aplicativo ajuda você a reunir e manter seus portfólios. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://www.colloquial.io/solutions](https://www.colloquial.io/solutions) |
...
Essas informações foram fornecidas pelas Soluções Coloquial sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário – nome e sobrenome, bem como email |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil do usuário – nome e sobrenome, bem como email |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Austrália |
...
| Se seu aplicativo não usar uma das bibliotecas acima, qual biblioteca ou biblioteca de autenticação ele usa? | Usamos o fluxo de código de autorização OAuth2 com a seguinte biblioteca: https://github.com/RIPAGlobal/omniauth-azure-activedirectory-v2 |
