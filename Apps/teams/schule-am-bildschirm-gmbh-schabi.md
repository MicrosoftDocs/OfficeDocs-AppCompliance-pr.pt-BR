---
title: Informações do aplicativo para Schabi por Schule am Bildschirm GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Schabi, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/8ddc9e63-e032-4639-afa6-b7c806303212" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003728" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por Schule am Bildschirm GmbH para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Schabi |
| ID | WA200003728 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Schule am Bildschirm GmbH |
| Site da empresa | [https://web.schabi.ch](https://web.schabi.ch) |
| Termos de uso do aplicativo | [https://www.schabi.ch/Info/AGB](https://www.schabi.ch/Info/AGB) |
| Funcionalidade principal do aplicativo | Desin Schabi-Hausaufgaben e Schabi-Seiten direkt no Microsoft Teams! |
| Localização da sede da empresa | Suíça |
| Página de informações do aplicativo | [https://web.schabi.ch](https://web.schabi.ch) |
...
Essas informações foram fornecidas por Schule am Bildschirm GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://www.schabi.ch/Info/Datenschutz |
