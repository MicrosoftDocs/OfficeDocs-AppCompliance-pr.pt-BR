...
description: 'Todas as informações de segurança e conformidade disponíveis para a Schabi, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.'
...
| Funcionalidade principal do aplicativo | Deine Schabi-Hausaufgaben und Schabi-Seiten direkt no Microsoft Teams! |
