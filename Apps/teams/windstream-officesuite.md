---
title: Informações do aplicativo para OfficeSuite by Windstream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o OfficeSuite, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/bf9c1c49-a529-451e-a81d-ac94cfdbec3e" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000618" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Windstream para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | OfficeSuite |
| ID | WA200000618 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Windstream |
| Site da empresa | [https://www.windstreamenterprise.com](https://www.windstreamenterprise.com) |
| Termos de uso do aplicativo | [https://www.windstream.com/about/legal/Terms-and-Conditions](https://www.windstream.com/about/legal/Terms-and-Conditions) |
| Funcionalidade principal do aplicativo | Aplicativo de notificação de chamada, reunião e chamada |
...
Essas informações foram fornecidas pelo Windstream sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente |  2021-11-03 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente |  2021-11-04 |
...
| URL da Política de Privacidade | https://www.windstream.com/about/legal/privacy-policy |
