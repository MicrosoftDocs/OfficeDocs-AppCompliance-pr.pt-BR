---
title: Informações do aplicativo para ForceManager CRM da Tritium Software SL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Todas as informações de segurança e conformidade disponíveis para ForceManager CRM, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f429eb71-607a-4e12-9467-209276404047" target="_blank">Exibir no Teams armazenamento</a>
...
| Funcionalidade principal do aplicativo | ForceManager é o CRM líder com um aplicativo Web e móvel de serviço completo criado para uma variedade de estilos de trabalho, incluindo página inicial, escritório ou campo. O aplicativo é destinado a representantes de vendas que precisam gerenciar suas atividades e agendas diárias com uma interface amigável e um aplicativo fácil de usar. |
