...
| Quais dados são processados pelo aplicativo? | Dados do usuário, dados de logon, dados de Auth, dados de locatário, dados do Serviço do Azure, Graph dados de Office 365 Gerenciamento |
