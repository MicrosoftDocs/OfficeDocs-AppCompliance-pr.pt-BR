---
title: Informações do aplicativo para conversas personalizadas pelo Pogo Studio
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Tailored Talks, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66655853"
---
# <a name="tailored-talks"></a>Palestras personalizadas
...
* <a href="https://teams.microsoft.com/l/app/a1f5ad93-accd-463f-a8d5-904c77015815" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004309" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Pogo Studio à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Palestras personalizadas |
| ID | WA200004309 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Pogo Studio |
| Site da empresa | [https://pogodigitalhealth.com](https://pogodigitalhealth.com) |
| Termos de Uso do Aplicativo | [https://teams.tailored-talks.com/pdf/TermsOfUse.pdf](https://teams.tailored-talks.com/pdf/TermsOfUse.pdf) |
| Funcionalidade principal do aplicativo | As Conversas Personalizadas permitem que os médicos compartilhem apresentações personalizadas com pacientes. |
...
Essas informações foram fornecidas pelo Pogo Studio sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | locatário |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | locatário, email |
...
| URL da Política de Privacidade | https://teams.tailored-talks.com/pdf/PrivacyPolicy.pdf |
...
| Listar os tipos de políticas com suporte | As políticas podem ser direcionadas a usuários e grupos específicos, dando aos administradores controle refinado sobre o acesso. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicação | Identificar Usuário | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| openid | aplicação | Identificar Usuário | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| perfil | aplicação | Identificar Usuário | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
