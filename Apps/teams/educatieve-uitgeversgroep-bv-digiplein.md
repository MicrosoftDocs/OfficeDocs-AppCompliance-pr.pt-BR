---
title: Informações de aplicativo para Digiplein por Educatieve Uitgeversgroep B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Digiplein, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a58f891-dad9-4c01-bf1a-3c418fb6b282" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003298" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Educadortieve Uitgeversgroep B.V. para a Microsoft:
...
| Nome da empresa parceira | Grupo de Editores Educacionais B.V. |
| Site da empresa | [https://www.uitgeversgroep.nl](https://www.uitgeversgroep.nl) |
| Termos de Uso do Aplicativo | [https://www.uitgeversgroep.nl/voorwaarden](https://www.uitgeversgroep.nl/voorwaarden) |
| Funcionalidade principal do aplicativo | Online leeromgeving van de Uitgeversgroep |
| Localização da sede da empresa | Países Baixos (o) |
| Página de informações do aplicativo | [https://www.uitgeversgroep.nl/digiplein](https://www.uitgeversgroep.nl/digiplein) |
...
Essas informações foram fornecidas pelo Educatieve Uitgeversgroep B.V. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
