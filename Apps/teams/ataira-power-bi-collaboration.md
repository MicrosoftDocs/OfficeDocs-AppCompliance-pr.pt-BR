...
---
# <a name="power-bi-collaboration-overview"></a>Power BI de colaboração
...
* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Ataira à Microsoft:
...
| Nome da empresa parceira | Ataira |
...
| Funcionalidade principal do aplicativo | O suplemento do Ataira permite que você exiba seus Power BI e relatórios. Envie notificações para seus grupos corporativos e equipes, adicione ações de acompanhamento, insira links públicos do Power BI, adicione comentários a pontos de dados em seus relatórios e adicione arquivos de dados como fontes de dados aos relatórios do Power BI e atualize em tempo real. Permita que sua equipe de business intelligence colabore com mais força em seus esforços de business intelligence em um único local. |
...
Essas informações foram fornecidas pelo Ataira sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
