...
| Funcionalidade principal do aplicativo | O Bot do ZeroTime permite que os usuários preencham diretamente seus quadros de horários do Replicon conversando com o Bot. |
