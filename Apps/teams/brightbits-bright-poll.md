---
title: Informações do aplicativo para Bright Poll by BrightBits
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Bright Poll, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3a3156c1-b214-4d42-bc25-6d36f6aabb5e" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo BrightBits para a Microsoft:
...
| Nome da empresa parceira | BrightBits |
...
| Funcionalidade principal do aplicativo | Coletar comentários de colegas de equipe por meio de votações no chat. |
...
Essas informações foram fornecidas pela BrightBits sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
