---
title: Informações do aplicativo para Gameinar por Heuristix
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Gameinar, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/10a3a812-c72d-47d4-b9b5-6425c6fed158" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas por Heuristix à Microsoft:
...
| Nome da empresa de parceiro | Heuristix |
...
| Funcionalidade principal do aplicativo | Criar facilitações virtuais envolvente! |
