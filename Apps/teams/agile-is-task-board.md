---
title: Informações do aplicativo para o Painel de Tarefas Agile da Agile-IS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Painel de Tarefas Agile, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 8 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6021779f-643c-48c0-9f80-8e41ea801be7" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002162" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Agile-IS para a Microsoft:
...
| Nome da empresa parceira | Agile-IS |
| Site da empresa | [https://www.agile-is.de](https://www.agile-is.de) |
| Termos de Uso do Aplicativo | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| Funcionalidade principal do aplicativo | O Painel de Tarefas Agile ajuda você e sua equipe a obter uma visão geral melhor do seu projeto agile. Converta sua placa física em uma versão digital. Você pode mapear seu processo com recursos como colunas para exibição de status, qualquer número de raias, coloração controlada por metadados de mapas, atribuição de responsabilidades, edição de arrastar e soltar e muitas outras configurações. Todos os dados permanecerão em seu locatário do M365. |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
| Quais dados são armazenados em seus bancos de dados? | Zur Lizenzverwaltung da UPN; Unternehmensdaten zur Rechnungslegung |
...
| URL da Política de Privacidade | https://www.agile-is.de/en/telemetry |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegada | Permite que o aplicativo consulte a consulta do aplicativo instalado no momento. Usado para fornecer os recursos de aplicativo corretos. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | Delegada | Ler membros do grupo para atribuir tarefas do planejador  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | Delegada | Trabalhar com planos e tarefas do Planner   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | Delegada | Enviar mensagens para a atividade do Teams | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | Delegada | Permite que o aplicativo consulte a consulta do aplicativo instalado no momento. Usado para fornecer os recursos de aplicativo corretos. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | Delegada | Permite que o usuário entre e leia informações básicas do perfil | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | Delegada | Permite que o usuário leia informações básicas de perfil de outros usuários | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
