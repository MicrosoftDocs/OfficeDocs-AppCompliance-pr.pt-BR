...
| URL da página Teams de informações do aplicativo | [https://tinyurl.com/2c6b9cdm](https://tinyurl.com/2c6b9cdm) |
...
| URL dos Termos de Uso | [https://tinyurl.com/2c6b9cdm](https://tinyurl.com/2c6b9cdm) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Para manter dados de sessão | Nome, ID de email | Gerenciamento de sessão do Chatbot |
...
<iframe height='1020' title='Microsoft Cloud App Security Informações' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35906' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35906" target="_blank">Exibir em uma nova guia</a>
...
Essas informações foram fornecidas pela Hexaware Technologies Ltd. sobre como esse aplicativo lida com autenticação, autorização, práticas recomendadas de registro de aplicativos e outros critérios de Identidade.
