...
description: Todas as informações de segurança e conformidade disponíveis para InCaseIT, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Pilotech AS para a Microsoft:
...
| Nome da empresa parceira | Pilotech AS |
| Site da empresa | [https://incaseit.com](https://incaseit.com) |
| Termos de Uso do Aplicativo | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| Funcionalidade principal do aplicativo | Sistema de gestão de crise. Sistema de preparação e tratamento de crise e incidentes. |
| Localização da sede da empresa | Noruega |
| Página de informações do aplicativo | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegada | Os únicos dados usados são a confirmação explícita pelos usuários para permitir que o aplicativo use um token de acesso para chamar o API do Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | Delegada | Os únicos dados usados são a confirmação explícita pelos usuários para permitir que o aplicativo use um token de acesso para chamar o API do Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | Delegada | Os únicos dados usados são a confirmação explícita pelos usuários para permitir que o aplicativo use um token de acesso para chamar o API do Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
