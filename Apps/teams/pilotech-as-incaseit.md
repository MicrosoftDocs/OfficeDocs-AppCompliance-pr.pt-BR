...
| Funcionalidade principal do aplicativo | Sistema de gerenciamento de crise. Sistema de preparação e tratamento de crise e incidentes. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegado | Os únicos dados usados são a confirmação explícita pelos usuários para permitir que o aplicativo use um token de acesso para chamar a API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | delegado | Os únicos dados usados são a confirmação explícita pelos usuários para permitir que o aplicativo use um token de acesso para chamar a API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | delegado | Os únicos dados usados são a confirmação explícita pelos usuários para permitir que o aplicativo use um token de acesso para chamar a API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
