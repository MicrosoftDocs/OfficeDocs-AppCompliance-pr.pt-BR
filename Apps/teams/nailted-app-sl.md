---
title: Informações do aplicativo para nailted por NAILTED APP S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Nailted, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo NAILTED APP S.L. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Nailted |
| ID | WA200003375 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | NAILTED APP S.L. |
...
Essas informações foram fornecidas pelo NAILTED APP S.L. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | tenantId e email |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | tenantId e email |
...
| URL da Política de Privacidade | https://nailted.com/legal/privacy |
...
| Se seu aplicativo não usar uma das bibliotecas acima, qual biblioteca ou biblioteca de autenticação ele usa? | usamos a versão mais recente da Biblioteca de Autenticação da Microsoft |
...
>| email | aplicação | Acessar email de funcionários para sincronizá-los | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
