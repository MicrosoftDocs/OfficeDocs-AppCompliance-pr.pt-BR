---
title: Informações do aplicativo para Go1 by Go1
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/23/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Go1, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c859de61-8a6b-42e6-ba88-f639df33bc72" target="_blank">Exibir no Teams armazenamento</a>
...
| Funcionalidade principal do aplicativo | O aplicativo go1 Teams ajuda a encontrar, consumir, compartilhar e discutir recursos de aprendizado de dentro Microsoft Teams |
...
Essas informações foram fornecidas pelo Go1 sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | aplicação | o aplicativo não armazena dados de arquivos | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| Group.ReadWrite.All | aplicação | Teams nome do canal e id exclusiva armazenada para dar suporte ao ambiente de aprendizado de gerenciamento de aplicativos | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | aplicação | nome dos usuários, email e UPN armazenados para fornecer experiência de aprendiz pessoal direta | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
