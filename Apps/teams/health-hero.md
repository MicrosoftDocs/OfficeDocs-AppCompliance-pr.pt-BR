...
description: Todas as informações de segurança e conformidade disponíveis para a Health Hero, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | Health Hero permite que os usuários capturem atividades saudáveis e recebam pontos de atividade. |
