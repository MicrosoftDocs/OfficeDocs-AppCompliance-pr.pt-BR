...
description: Todas as informações de segurança e conformidade disponíveis para o Health Hero, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
* <a href="https://teams.microsoft.com/l/app/1394c825-0026-4f33-bcc9-abaa9ae5d83b" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Health Hero para a Microsoft:
...
| Nome da empresa parceira | Health Hero |
| Site da empresa | [https://gohealthhero.com](https://gohealthhero.com) |
| Termos de Uso do Aplicativo | [https://www.gohealthhero.com/terms](https://www.gohealthhero.com/terms) |
| Funcionalidade principal do aplicativo | O Health Hero permite que os usuários capturem atividades íntegras e recebam pontos de atividade. |
...
Essas informações foram fornecidas pelo Health Hero sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicação | Apenas informações do usuário para criar conta. | [5f1f4eb7-479e-42f3-b86f-4c1f53e1c222](../azure/5f1f4eb7-479e-42f3-b86f-4c1f53e1c222.md) |
