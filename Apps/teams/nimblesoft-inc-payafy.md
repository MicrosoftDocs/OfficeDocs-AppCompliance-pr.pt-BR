---
title: Informações de aplicativo para PayaFy da NimbleSoft Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o PayaFy, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003397" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo NimbleSoft Inc. à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | PayaFy |
| ID | WA200003397 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | NimbleSoft Inc. |
| Site da empresa | [https://payafy.com](https://payafy.com) |
| Termos de Uso do Aplicativo | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| Funcionalidade principal do aplicativo | O PayaFy permite que as empresas aceitem pagamentos. Você pode vincular uma conta existente do Stripe ou registrar uma nova. |
...
Essas informações foram fornecidas pela NimbleSoft Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Nome e Endereço de Email |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | Ambos | Ele lerá as informações básicas usadas para o registro do usuário. | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](../azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b.md) |
