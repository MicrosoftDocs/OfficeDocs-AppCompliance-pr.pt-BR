...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pela NimbleSoft Inc. para a Microsoft:
...
| Nome da empresa de parceiro | NimbleSoft Inc. |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.ReadWrite.All | ambos | Ele lerá informações básicas usadas para o registro do usuário. |
