---
title: Informações do aplicativo para Starbucks da Starbucks&#174; Coffee Company
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Starbucks, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
* <a href="https://teams.microsoft.com/l/app/aa2600a7-aedf-447c-b15b-8ea2daf68a09" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Starbucks&#174; Coffee Company à Microsoft:
...
| Nome da empresa parceira | Starbucks&#174; Empresa de café |
...
| Funcionalidade principal do aplicativo | Agradeça, parabéns ou parabéns a um membro da equipe com um Starbucks eGift. |
...
Essas informações foram fornecidas pela Starbucks&#174; Coffee Company sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
