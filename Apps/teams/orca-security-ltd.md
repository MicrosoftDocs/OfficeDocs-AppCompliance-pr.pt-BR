---
title: Informações do aplicativo para Orca por ORCA SECURITY LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Orca, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela ORCA SECURITY LTD à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Orca |
| ID | WA200004132 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | ORCA SECURITY LTD |
| Site da empresa | [https://orca.security](https://orca.security) |
| Termos de Uso do Aplicativo | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| Funcionalidade principal do aplicativo | O Orca Security for Microsoft Teams fornece uma imagem em tempo real do estado de segurança do ambiente de nuvem. Usando ambas as ferramentas combinadas em uma exibição, os usuários podem criar uma discussão produtiva sobre problemas de segurança em seu ambiente de nuvem Alertas orca detalham um risco de nuvem específico que inclui as descobertas de risco de segurança e o recurso de nuvem conectado que representa o risco. |
...
Essas informações foram fornecidas pela ORCA SECURITY LTD sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Teams ID de Usuário, ID da Equipe, Nome da Equipe |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Teams ID de Usuário, ID da Equipe, Nome da Equipe |
...
| Data de certificação SOC2 mais recente | 2022-04-01 |
...
| URL da Política de Privacidade | https://orca.security/privacy-policy/ |
