---
title: Informações do aplicativo para Creately by Creately
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Creately, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66655860"
---
# <a name="creately"></a>Criar
...
* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Creately para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Criar |
| ID | WA200004335 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Criar |
| Site da empresa | [https://creately.com](https://creately.com) |
| Termos de Uso do Aplicativo | [https://creately.com/tos](https://creately.com/tos) |
| Funcionalidade principal do aplicativo | Com o Creately, você pode experimentar a colaboração visual como nunca antes. Agora planeje, analise e execute todo o seu trabalho sem sair do Microsoft Teams. O Creately oferece uma tela visual infinita e de forma livre para organizar pensamentos, debater soluções, projetar processos e colaborar com colegas de equipe em tempo real. |
...
Essas informações foram fornecidas pela Creately sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Email do Usuário, Nome Completo do Usuário |
...
| URL da Política de Privacidade | https://creately.com/privacy/ |
