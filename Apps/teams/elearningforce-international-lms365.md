...
| Site da empresa | [https://lms365.com](https://lms365.com) |
| Termos de uso do aplicativo | [https://lms365.com/lms365-saas-terms/](https://lms365.com/lms365-saas-terms/) |
| Funcionalidade principal do aplicativo | O LMS365 permite que sua organização entregue e gerencie treinamentos na plataforma Microsoft 365 por meio de SharePoint, Teams e dispositivos móveis, fornecendo um ambiente familiar para seus funcionários, parceiros e clientes |
...
| Quais dados são processados pelo aplicativo? | Dados de Perfil de Usuário - consulte https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Registros de treinamento de dados &amp; de perfil de usuário - consulte https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| Se a estrutura subjacente processa ou armazena dados de clientes da Microsoft, onde esses dados são armazenados geograficamente? | Países Baixos (o), Alemanha, Reino Unido da Grã-Bretanha e Irlanda do Norte (o), Japão, Austrália, Canadá, Irlanda |
...
| URL da Política de Privacidade | https://lms365.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | aplicação | Permite que o aplicativo expanda membros de um grupo de AD para registrar o grupo de usuários em um treinamento | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| Mail.Send | delegado | Permite que o aplicativo envie emails de notificação. A permissão é solicitada dinamicamente durante a configuração da conta de email para notificação. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| OnlineMeetings.ReadWrite | delegado | Permite que o aplicativo crie, leia, atualize e exclua eventos de reunião online. A permissão é solicitada dinamicamente durante a configuração da conta de email para notificação. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
...
>| User.Invite.All | delegado | Recurso opcional: para permitir que um Administrador de Catálogo convide usuários convidados para um catálogo de treinamento. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read | delegado | Permite que os usuários se inscrevam no aplicativo usando o cliente&#8217;do Azure AD e permite que o aplicativo leia o perfil e as informações básicas da empresa do usuário in-loco. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | delegado | Permite que o aplicativo leia o perfil de usuário completo. Ele&#8217;necessário para ler usuários&#8217; e criar hierarquia para o Dashboard do gerenciador de &amp; relatórios | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | aplicação | Permite que o aplicativo leia o perfil de usuário completo. Ele&#8217;necessário para ler usuários&#8217; e criar hierarquia para o Dashboard do gerenciador de &amp; relatórios | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| perfil | delegado | Para mostrar aos usuários qual conta foi usada para entrar, o LMS365 precisa dessa permissão para mostrar informações básicas do perfil, incluindo o nome de exibição, nome e sobrenome, endereço de email e foto. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
