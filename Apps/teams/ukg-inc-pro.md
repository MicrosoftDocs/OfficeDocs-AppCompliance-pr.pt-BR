---
title: Informações do aplicativo para Pro ukg pela UKG, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Pro UKG, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | Acesse facilmente as informações dos funcionários, ex view pay details e conclua outras ações de RH sob demanda. |
