...
* <a href="https://teams.microsoft.com/l/app/ba4eda44-cd55-4e15-855c-0debafb0490b" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002859" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Esri à Microsoft:
...
| Nome da empresa parceira | Esri |
| Site da empresa | [https://www.esri.com](https://www.esri.com) |
| Termos de Uso do Aplicativo | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| Funcionalidade principal do aplicativo | O ArcGIS Online inclui um pacote de aplicativos, mapas autoritativos e dados em milhares de tópicos, ferramentas de mapeamento modernas necessárias para visualizar seus dados, análise para descobrir e comunicar padrões significativos em seus dados e as ferramentas administrativas para gerenciar facilmente pessoas e conteúdo e capacitar todos a criar e compartilhar mapas. O ArcGIS oferece a todos em sua organização a capacidade de descobrir, usar, criar e compartilhar mapas de qualquer dispositivo, em qualquer lugar e a qualquer momento. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.esri.com/en-us/about/esri-partner-network/our-p...](https://www.esri.com/en-us/about/esri-partner-network/our-partners/global-alliances/microsoft-esri/overview) |
...
Essas informações foram fornecidas pela Esri sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Listar os tipos de políticas com suporte | O ArcGIS Online depende do modelo de RBAC (Controle de Acesso baseado em função). Todos os usuários na solução precisam ter uma função à qual eles recebem acesso. |
