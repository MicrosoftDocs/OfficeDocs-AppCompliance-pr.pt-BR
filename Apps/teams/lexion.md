---
title: Informações do aplicativo para Lexion by Lexion
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Lexion, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Lexion |
| Site da empresa | [https://lexion.ai](https://lexion.ai) |
| Termos de Uso do Aplicativo | [https://lexion.ai/terms](https://lexion.ai/terms) |
| Funcionalidade principal do aplicativo | Microsoft Teams bot para o Gerenciamento de Ciclo de Vida de Contrato baseado em IA da Lexion.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://lexion.ai](https://lexion.ai) |
