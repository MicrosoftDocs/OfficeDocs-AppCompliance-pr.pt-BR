---
title: Informações do aplicativo para AuditBoard por AuditBoard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/10/2022
...
description: Todas as informações de segurança e conformidade disponíveis para AuditBoard, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/c37d6bf9-d665-4119-b4e4-c641ee74fe09" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003600" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo AuditBoard à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | AuditBoard |
| ID | WA200003600 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | AuditBoard |
| Site da empresa | [https://www.auditboard.com](https://www.auditboard.com) |
| Termos de uso do aplicativo | [https://www.auditboard.com/terms-of-use/](https://www.auditboard.com/terms-of-use/) |
| Funcionalidade principal do aplicativo | Permite que os assinantes do AuditBoard recebam notificações Microsoft Teams. |
...
Essas informações foram fornecidas pelo AuditBoard sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente |  2021-11-04 |
...
| URL da Política de Privacidade | https://www.auditboard.com/privacy-policy/ |
