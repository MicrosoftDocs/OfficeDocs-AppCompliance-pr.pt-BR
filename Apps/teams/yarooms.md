---
title: Informações do aplicativo para YAROOMS da YAROOMS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/15/2021
...
description: Todas as informações de segurança e conformidade disponíveis para YAROOMS, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/495f8194-bdf2-41a3-8292-3f53b004c2e6" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | YAROOMS |
| Site da empresa | [https://yarooms.com](https://yarooms.com) |
| Termos de Uso do Aplicativo | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| Funcionalidade principal do aplicativo | Room &amp; Desk Booking Software |
| Localização da sede da empresa | Romênia |
| Página de informações do aplicativo | [https://yarooms.com/help](https://yarooms.com/help) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? | Iaas |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | Aws, Azure, GCP |
...
| URL da Política de Privacidade | https://www.yarooms.com/legal/privacy-policy |
