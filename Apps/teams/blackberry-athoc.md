...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| ChannelMessage.Send | delegado | Acessamos os&#8217;básicos do usuário, como nome principal e link para o canal geral do teams (para o qual o usuário está autorizado) para enviar o cartão de alerta para as equipes. | Não armazenamos&#8217;os dados do usuário no banco de dados, mas na memória Bot. Armazenamos o nome principal do usuário, Token AAD, Token BlackBerry AtHoc, preferência/configuração do BlackBerry AtHoc Server na memória do bot. Precisa das informações para enviar solicitação de API para a API do Microsoft Graph e nosso BlackBerry AtHoc Server. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
