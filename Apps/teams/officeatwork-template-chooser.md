---
title: Selador de Modelo por officeatwork – Informações do Aplicativo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Selador de Modelos, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65225095"
---
# <a name="template-chooser-application-information"></a>Informações do aplicativo Selador de Modelo
...
* <a href="https://teams.microsoft.com/l/app/13d1defc-6301-4e62-9c53-3361db865183" target="_blank">Exibir no Teams armazenamento</a>
