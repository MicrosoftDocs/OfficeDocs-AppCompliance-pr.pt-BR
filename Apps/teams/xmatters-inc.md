---
title: Informações do aplicativo para xMatters da xMatters Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Todas as informações de segurança e conformidade disponíveis para xMatters, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ccfe5256-29b8-4cc2-95ed-6612c0e1b10d" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | xMatters Inc. |
| Site da empresa | [https://www.xmatters.com](https://www.xmatters.com) |
| Termos de Uso do Aplicativo | [https://www.xmatters.com/policy/terms-conditions](https://www.xmatters.com/policy/terms-conditions) |
| Funcionalidade principal do aplicativo | Impedir, gerenciar e resolver problemas de TI automatizando a comunicação entre suas cadeias de ferramentas |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://help.xmatters.com/integrations/socialchat/microsoft...](https://help.xmatters.com/integrations/socialchat/microsoftteams.htm) |
