...
description: Todas as informações de segurança e conformidade disponíveis para o Hi Digital Coach, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | hi é um técnico digital que treina as pessoas para que eles Microsoft Teams. |
