---
title: Informações de aplicativo para Skilled Human by SaltFlat Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Skilled Human, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7c44d518-b820-461c-bbbd-2cbbd83aa3bc" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | SaltFlat Limited |
| Site da empresa | [https://skilledhuman.org](https://skilledhuman.org) |
| Termos de Uso do Aplicativo | [https://skilledhuman.org/terms](https://skilledhuman.org/terms) |
| Funcionalidade principal do aplicativo | Professional Skills Framework |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://skilledhuman.org/teamsapp](https://skilledhuman.org/teamsapp) |
