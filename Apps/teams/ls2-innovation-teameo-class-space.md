...
ms.locfileid: "61711446"
---
# <a name="teameo-class-space"></a>Espaço de classe teameo
...
* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003630" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Inovação LS2 para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Espaço de classe teameo |
| ID | WA200003630 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Inovação LS2 |
| Site da empresa | [https://teameo.io](https://teameo.io) |
| Termos de uso do aplicativo | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| Funcionalidade principal do aplicativo | O Espaço de Classe teameo permite que os professores mostrem os detalhes do curso, aplicativos e links. |
...
Essas informações foram fornecidas pela LS2 Innovation sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Informações do usuário (nome, email), Informações do Locatário (id, nome) |
...
| URL da Política de Privacidade | https://teameo.io/legal/privacy-policy.html |
