---
title: Informações do aplicativo para Bizfone por MobiKOM
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Bizfone, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5be25d59-35cd-4318-83b0-2a5d5668ddcd" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000874" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo MobiKOM à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Bizfone |
| ID | WA200000874 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | MobiKOM |
| Site da empresa | [https://mobikom.dk](https://mobikom.dk) |
...
Essas informações foram fornecidas pelo MobiKOM sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegada | Os calendários são usados para que os usuários possam mostrar seus calandares a colegas de trabalho e usar reuniões para configurar sua telefonia | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| Contacts.Read | Delegada | Os contatos dos usuários podem ser armazenados se quiserem exibi-los no aplicativo para facilitar a discagem de contatos | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | Delegada | O usuário lido neste aplicativo é usado para fins de identificação. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | Delegada | Não armazenamos os dados. O aplicativo é simplesmente usado para fins de autenticação | [fc8f7563-e8ea-4b6d-9622-82775a21a35a](../azure/fc8f7563-e8ea-4b6d-9622-82775a21a35a.md) |
