---
title: Informações do aplicativo para Feeder por Really Simple i Estocolmo AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Feeder, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66245967"
---
# <a name="feeder"></a>Alimentador

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 8 de junho de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6810f6a8-1f9a-4504-a916-e2d9814062e0" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004254" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Really Simple i Estocolmo AB para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Alimentador |
| ID | WA200004254 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Really Simple i Estocolmo AB |
| Site da empresa | [https://feeder.co](https://feeder.co) |
| Termos de Uso do Aplicativo | [https://feeder.co/teams-license](https://feeder.co/teams-license) |
| Funcionalidade principal do aplicativo | Obter atualizações de notícias de RSS feeds e outras fontes digitais |
| Localização da sede da empresa | Suécia |
| Página de informações do aplicativo | |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? | Iaas |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | OVH, DigitalOcean, Aws |
...
Essas informações foram fornecidas pelo Really Simple i Estocolmo AB sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Email, endereço IP, ID do locatário |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Email, ID do locatário |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Canadá, França |
...
| URL da Política de Privacidade | https://feeder.co/help/legal/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Ambas | Autenticação e logon do usuário | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| email | Delegada | Autenticação e logon do usuário | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| openid | Ambas | Autenticação e logon do usuário | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| perfil | Ambas | Autenticação e logon do usuário | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
