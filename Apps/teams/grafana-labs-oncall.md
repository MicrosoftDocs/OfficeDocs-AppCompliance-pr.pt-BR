---
title: Informações de aplicativo para Grafana OnCall da Grafana Labs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Grafana OnCall, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Grafana Labs à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Grafana OnCall |
| ID | WA200004307 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Grafana Labs |
| Site da empresa | [https://grafana.com](https://grafana.com) |
| Termos de Uso do Aplicativo | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| Funcionalidade principal do aplicativo | A maneira mais fácil de fazer o gerenciamento de chamadas |
...
Essas informações foram fornecidas pelo Grafana Labs sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://grafana.com/legal/terms |
...
| Os indivíduos são fornecidos como uma opção para objetor o processamento? | Não |
