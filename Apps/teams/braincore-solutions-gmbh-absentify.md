---
title: Informações do aplicativo para absentify pela GmbH de Soluções BrainCore
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pelo GmbH de Soluções BrainCore para a Microsoft:
...
| Nome da empresa de parceiro | GmbH de Soluções BrainCore |
...
Essas informações foram fornecidas pelo GmbH da BrainCore Solutions sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
