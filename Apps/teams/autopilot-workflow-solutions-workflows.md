...
* <a href="https://teams.microsoft.com/l/app/5aa677bf-b5a6-48bc-9a47-8892dbd316cb" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003745" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelas Soluções de Fluxo de Trabalho do Autopilot para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Fluxos de trabalho do Autopilot |
| ID | WA200003745 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Soluções de Fluxo de Trabalho do Autopilot |
| Site da empresa | [https://www.autopilot.co.za](https://www.autopilot.co.za) |
...
Essas informações foram fornecidas pelas Soluções de Fluxo de Trabalho do Autopilot sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou ao dispositivo? | Sim |
| Quais dados são processados pelo aplicativo? | Qual versão de dispositivo e navegador eles usaram |
