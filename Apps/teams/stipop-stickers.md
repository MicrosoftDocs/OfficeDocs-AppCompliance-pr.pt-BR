...
description: Todas as informações de segurança e conformidade disponíveis para Adesivos Do Stipop, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63773666"
---
# <a name="stipop-stickers"></a>Adesivos de stipop
...
* <a href="https://teams.microsoft.com/l/app/31c1aadf-4a2e-4465-b1a4-6d4d7d9a284c" target="_blank">Exibir no Teams store</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Adesivos de stipop |
| ID | WA200002606 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Stipop |
...
Essas informações foram fornecidas pelo Stipop sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Se a estrutura subjacente processa ou armazena dados de clientes da Microsoft, onde esses dados são armazenados geograficamente? | Coreia (República de) |
