---
title: Informações do aplicativo para a área de trabalho por workboard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/04/2021
...
* <a href="https://teams.microsoft.com/l/app/28d0282b-3cd2-49f0-90bb-a016843750c6" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Workboard |
| URL do site do parceiro | [https://www.workboard.com](https://www.workboard.com) |
| URL da página Teams informações do aplicativo | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
Essas informações foram fornecidas pela Workboard sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| A ID de usuário é usada para notificações proativas enviadas Teams WorkBord | ID e endereço de email do usuário | Usado para mapear o usuário para a ID de usuário do WorkBoard |
...
>O WorkBoard não armazena dados da organização nos sistemas do parceiro
...
<iframe height='1020' title='Microsoft Cloud App Security informações' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/29004' frameborder='no'></iframe>
...
Essas informações foram fornecidas pela Workboard sobre como esse aplicativo lida com autenticação, autorização, práticas recomendadas de registro de aplicativo e outros critérios de identidade.
...
| Listar os tipos de políticas com suporte | O WorkBoard implementou suas próprias políticas de acesso que são impostas dentro do aplicativo.  A organização, a equipe e a identidade do usuário são usadas para determinar os direitos de acesso. |
