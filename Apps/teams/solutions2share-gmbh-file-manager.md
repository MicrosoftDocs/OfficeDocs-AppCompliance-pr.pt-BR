---
title: Informações do aplicativo para o Gerenciador de Arquivos pela Solutions2Share GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Gerenciador de Arquivos, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "64463655"
---
# <a name="file-manager"></a>Gerenciador de Arquivos

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 30 de dezembro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/4946e155-584a-412d-aac1-48975e073587" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003770" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Gerenciador de Arquivos |
| ID | WA200003770 |
...
| Funcionalidade principal do aplicativo | Gerenciar arquivos por todas as equipes no Microsoft Teams |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://www.solutions2share.com/file-manager/](https://www.solutions2share.com/file-manager/) |
...
| Quais dados são armazenados em seus bancos de dados? | TenantID,Nome principal do usuário |
