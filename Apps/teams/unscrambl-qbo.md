...
description: Todas as informações de segurança e conformidade disponíveis para o qbo, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Unscrambl para a Microsoft:
...
| Termos de Uso do Aplicativo | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| Funcionalidade principal do aplicativo | O qbo, da plataforma Unscrambl qbo Insights, torna a análise conversacional usando a melhor NLP da classe. Os usuários digitam uma pergunta e o qbo exibe os insights e visualizações mais relevantes em um ajuste. Os usuários podem colaborar ativamente com colegas, tomar decisões e capturar descobertas em quadros prontos para apresentação. O qbo capacita todos na organização a tomar decisões controladas por dados. O qbo se conecta diretamente a uma variedade de fontes locais ou na nuvem e pode ser acessado por meio Microsoft Teams ou um navegador. |
...
Essas informações foram fornecidas pela Unscrambl sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | nome e endereço de email são usados para criação de conta |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | nome e endereço de email |
...
| URL da Política de Privacidade | https://qbo.ai/legal/ |
