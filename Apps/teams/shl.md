...
description: Todas as informações de segurança e conformidade disponíveis para SHL, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | SHL |
| Site da empresa | [https://shl.com](https://shl.com) |
| Termos de Uso do Aplicativo | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| Funcionalidade principal do aplicativo | A SHL é líder global em tecnologia de RH e ciência psicométrica que leva a insights profundos das pessoas, ajudando as empresas a criar soluções poderosas de força de trabalho que impulsionam os resultados dos negócios. A SHL traz tecnologia de IA poderosa e transparente, ciência de dados e o objectividade para ajudar as empresas a atrair, desenvolver e aumentar a força de trabalho de que precisam para ter sucesso na era digital. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
Essas informações foram fornecidas pela SHL sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | Delegada | Slots calander compartilhados disponíveis | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
