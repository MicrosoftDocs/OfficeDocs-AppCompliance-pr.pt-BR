---
title: Informações do aplicativo para a Wanda by Unit4 Business Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Wanda, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR da CSA.
...
ms.locfileid: "66112981"
---
# <a name="wanda"></a>Wanda
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Software Comercial unit4 para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Wanda |
| ID | WA200004038 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Unit4 Business Software |
| Site da empresa | [https://www.unit4.com](https://www.unit4.com) |
| Termos de Uso do Aplicativo | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| Funcionalidade principal do aplicativo | A Wanda ajuda você a cuidar das tarefas mais rotineiras do ERP. |
| Localização da sede da empresa | Países Baixos (o) |
| Página de informações do aplicativo | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
Essas informações foram fornecidas pela Unit4 Business Software sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | ID de usuário Microsoft Teams bot |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | ID de usuário Microsoft Teams bot |
...
| Data de certificação SOC1 mais recente | 2021-11-05 |
...
| Data de certificação SOC2 mais recente | 2021-11-23 |
...
| URL da Política de Privacidade | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
