...
>|:------------------------|:--------------------|:------------------------------------|
>| openid | delegado | Permitir que as pessoas entre nas guias |
>| perfil | delegado | Para armazenar informações de perfil de usuários |
>| email | delegado | Para organizar dados do usuário |
