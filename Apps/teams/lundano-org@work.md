---
title: Informações do aplicativo Org@Work por Lundano
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Org@Work, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b9f5d3b0-424e-473d-bcbe-dd01f17f9a41" target="_blank">Exibir no Teams armazenamento</a>
...
| Site da empresa | [https://www.lundano.com/en/](https://www.lundano.com/en/) |
| Termos de Uso do Aplicativo | [https://cp.lundano.com/Terms_en.html](https://cp.lundano.com/Terms_en.html) |
| Funcionalidade principal do aplicativo | Gerenciar sua organização de trabalho e ocupação do escritório com planejamentos colaborativos |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Estamos armazenando dados. Usamos apenas os dados para fazer logon do usuário no Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| email | Delegada | Estamos armazenando dados. Usamos apenas os dados para fazer logon do usuário no Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| offline_access | Delegada | Estamos armazenando dados. Usamos apenas os dados para fazer logon do usuário no Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| openid | Delegada | Estamos armazenando dados. Usamos apenas os dados para fazer logon do usuário no Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| perfil | Delegada | Estamos armazenando dados. Usamos apenas os dados para fazer logon do usuário no Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
