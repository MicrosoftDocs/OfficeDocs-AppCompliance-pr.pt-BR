...
description: Todas as informações de segurança e conformidade disponíveis para CI-Out-of-Office Lite, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e76af3f9-8fb6-4018-84c0-d5444ad72b4c" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela ci solution GmbH para a Microsoft:
...
| Nome da empresa parceira | solução ci GmbH |
| Site da empresa | [https://www.ci-solution.com](https://www.ci-solution.com) |
| Termos de Uso do Aplicativo | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| Funcionalidade principal do aplicativo | Com o CI-Out-of-Office Lite, as notificações de ausência podem ser padronizadas e controladas centralmente em toda a empresa. Com este aplicativo premiado (incluindo prêmio do setor, prêmio de inovação de TI), você pode garantir um gerenciamento de fora do escritório profissional, uniforme e em conformidade com a identidade corporativa para sua empresa em Microsoft 365. |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://www.ci-solution.com/support/en/ci-oof-lite/](https://www.ci-solution.com/support/en/ci-oof-lite/) |
...
Essas informações foram fornecidas pela solução ci GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Delegada | Exibir o endereço de email do usuário | [fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da](../azure/fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da.md) |
