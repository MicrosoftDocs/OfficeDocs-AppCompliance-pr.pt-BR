---
title: Informações de aplicativo para ThoughtWire EWS da ThoughtWire Corp.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/15/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o ThoughtWire EWS, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed27363f-755e-4658-b7bf-409d475959d6" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | ThoughtWire Corp. |
...
| Funcionalidade principal do aplicativo | O aplicativo ThoughtWire dá suporte a EarlyWarning- uma ferramenta avançada de detecção e intervenção que é comprovadamente redução de eventos de código azul em 61%. A Solução de Aviso Antecipado foi projetada para detectar a deterioração dos pacientes com base nos sinais vitais dos pacientes, notificar os médicos sobre eventos adversos de saúde e permitir que eles executem ações. A equipe de resposta tem acesso ao contexto do paciente e está ciente do status e da disponibilidade da equipe que responde, permitindo a resposta simplificada e fluxos de trabalho de atendimento ao paciente. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | aplicação | Permite que o aplicativo crie grupos/equipes para unidades/unidades hospitalares. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | aplicação | Necessário para que o aplicativo determine quais grupos ele pode precisar criar/criar novamente e gerenciar a associação. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | aplicação | Necessário para que o aplicativo possa gerenciar a associação de grupo. ou seja, adicionar/remover enfermeiras de uma equipe à medida que os turnos mudam. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | aplicação | Necessário para que o aplicativo possa gerenciar a associação de grupo. ou seja, adicionar/remover enfermeiras de uma equipe à medida que os turnos mudam. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | aplicação | Permite que o aplicativo instale automaticamente o bot ThoughtWire para as equipes que ele cria/gerencia. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | aplicação | Permita que o aplicativo recupere o AADID/nome de usuário, conforme necessário, ao gerenciar a associação e/ou recuperar o nome de usuário para identificar o usuário em nosso aplicativo. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
