---
title: Informações do aplicativo para o ThoughtWire EWS pela ThoughtWire Corp.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/15/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o ThoughtWire EWS, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
<p>Última atualização pelo desenvolvedor em: 17 de junho de 2021</p>

* <a href="https://teams.microsoft.com/l/app/ed27363f-755e-4658-b7bf-409d475959d6" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003239" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela ThoughtWire Corp. à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | ThoughtWire EWS |
| ID | WA200003239 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | ThoughtWire Corp. |
| Site da empresa | [https://thoughtwire.com](https://thoughtwire.com) |
| Termos de uso do aplicativo | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| Funcionalidade principal do aplicativo | O aplicativo ThoughtWire dá suporte a EarlyWarning- uma ferramenta avançada de detecção e intervenção que é comprovadamente para reduzir os eventos azuis de código em 61%. A Solução de Aviso Antecipado foi projetada para detectar a deterioração do paciente com base nos sinais vitais do paciente, notificar os médicos sobre eventos de saúde adversas e permitir que eles tomem medidas. Os funcionários da equipe de resposta têm acesso ao contexto do paciente e estão cientes do status e da disponibilidade da equipe que responde, permitindo fluxos de trabalho simplificados de resposta e atendimento ao paciente. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | aplicação | Permite que o aplicativo crie grupos/equipes para unidades/unidades de hospitais. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | aplicação | Necessário para que o aplicativo determine quais grupos ele pode precisar criar/re-criar e gerenciar a associação. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | aplicação | Necessário para que o aplicativo possa gerenciar a associação ao grupo. ou seja, adicionando/removendo as enfermeiras de uma equipe à medida que os turnos mudam. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | aplicação | Necessário para que o aplicativo possa gerenciar a associação ao grupo. ou seja, adicionando/removendo as enfermeiras de uma equipe à medida que os turnos mudam. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | aplicação | Permite que o aplicativo instale automaticamente o bot ThoughtWire para as equipes criadas/gerenciadas. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | aplicação | Permitir que o aplicativo recupere o AADID /username de um usuário conforme necessário ao gerenciar a associação e/ou recuperar o nome de usuário para identificar o usuário em nosso aplicativo. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
