---
title: Informações do aplicativo para MSPBots pela LLC da Jexet Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/23/2021
...
* <a href="https://teams.microsoft.com/l/app/10fcc57c-8d49-4f94-a516-a75de60bc969" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001128" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo LLC da Jexet Technologies para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | MSPBots |
| ID | WA200001128 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Jexet Technologies LLC |
| Site da empresa | [https://mspbots.ai](https://mspbots.ai) |
| Termos de uso do aplicativo | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| Funcionalidade principal do aplicativo | Plataforma de Business Intelligence, automação para tarefas repetitivas do provedor de serviços gerenciados de TI usando bots personalizáveis. |
...
Essas informações foram fornecidas pelo LLC da Jexet Technologies sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://mspbots.ai/home/data-security/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | aplicação | Enviar mensagem para o canal | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](../azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9.md) |
>| ChatMessage.Send | aplicação | Enviar mensagem para chat | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](../azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9.md) |
>| perfil | aplicação | obter informações do usuário do aplicativo de uso | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](../azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9.md) |
