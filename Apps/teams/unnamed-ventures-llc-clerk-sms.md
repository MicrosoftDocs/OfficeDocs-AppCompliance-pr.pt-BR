---
title: Informações de aplicativo para o SMS do Administrador por Não Nomeado Ventures, LLC.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o SMS do Administrador, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64682126"
---
# <a name="clerk-sms"></a>SMS do Administrador
...
* <a href="https://teams.microsoft.com/l/app/88c50b69-8e4b-4383-b70f-c8295d5431a0" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003376" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Unnamed Ventures, LLC. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | SMS do Administrador |
| ID | WA200003376 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Ventures sem nome, LLC. |
| Site da empresa | [https://clerk.chat/teams](https://clerk.chat/teams) |
| Termos de Uso do Aplicativo | [https://clerk.chat/legal/terms/](https://clerk.chat/legal/terms/) |
| Funcionalidade principal do aplicativo | Envie e receba mensagens de texto (SMS/MMS) dentro de Microsoft Teams.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://clerk.chat/teams](https://clerk.chat/teams) |
...
Essas informações foram fornecidas pela Unnamed Ventures, LLC. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| URL da Política de Privacidade | https://clerk.chat/legal/privacy |
