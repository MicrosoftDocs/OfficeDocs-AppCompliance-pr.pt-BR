---
title: Informações do aplicativo para BitFractal por BitFractal
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
* <a href="https://teams.microsoft.com/l/app/2908a48e-21b7-48e4-89fc-7f4a433952fa" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004172" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo BitFractal para a Microsoft:
...
| Funcionalidade principal do aplicativo | O BitFractal leva a IA aos usuários empresariais de maneira simples e eficiente para automatizar processos diários conectando os Serviços Cognitivos de IA do Azure à interface amigável do Teams e, em seguida, adicionando uma camada de produtividade e colaboração a ela, aproveitando os recursos do Teams, como bots, guias, extensões de mensagem e muito mais. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.bitfractal.com](https://www.bitfractal.com) |
...
Essas informações foram fornecidas pelo BitFractal sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário (DisplayName, Email, ObjectId, TenantId) |
...
>| User.Read | Delegada | Obter informações básicas de perfil de usuário para o aplicativo interagir com o usuário | [fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f](../azure/fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f.md) |
