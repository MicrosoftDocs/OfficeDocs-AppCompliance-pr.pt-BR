...
ms.locfileid: "65228555"
---
# <a name="sobol-overview"></a>Visão geral do Sobol
...
| Funcionalidade principal do aplicativo | O Sobol é um aplicativo Web que ajuda as organizações a visualizar e mapear suas funções, equipes, metas, usuários e contratos. |
