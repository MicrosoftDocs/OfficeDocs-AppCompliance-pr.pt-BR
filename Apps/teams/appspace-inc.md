---
title: Informações do aplicativo para Appspace da Appspace, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
* <a href="https://teams.microsoft.com/l/app/a9a866c4-e5cf-47f2-932c-db14cb89008f" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Appspace, Inc. para a Microsoft:
...
| Nome da empresa parceira | Appspace, Inc. |
| Site da empresa | [https://www.appspace.com](https://www.appspace.com) |
| Termos de Uso do Aplicativo | [https://www.appspace.com/legal/user-agreement/](https://www.appspace.com/legal/user-agreement/) |
| Funcionalidade principal do aplicativo | O Appspace é uma plataforma de gerenciamento de espaço e comunicação para ajudar seus negócios com a organização e a eficiência, trabalhando de qualquer lugar. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.appspace.com](https://www.appspace.com) |
...
| Data de certificação SOC2 mais recente | 2020-11-09 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente | 2020-11-09 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Team.ReadBasic.All | Delegada | Obtenha as equipes às qual o usuário pertence. | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
>| User.ReadBasic.All | Delegada | Leia as propriedades básicas de perfil de outros usuários em sua organização em nome do usuário conectado. Inclui o nome para exibição, nome e sobrenome, endereço de email, extensões abertas e foto. Também permite que o aplicativo leia o perfil completo do usuário conectado. | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
