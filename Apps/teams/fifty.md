---
title: Informações do aplicativo para cinquenta por cinquenta
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Fifty, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Fifty para a Microsoft:
...
| Nome da empresa parceira | Cinquenta |
| Site da empresa | [https://app.fifty.do](https://app.fifty.do) |
| Termos de Uso do Aplicativo | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| Funcionalidade principal do aplicativo | Cinquenta ajuda você a passar do conhecimento para a ação, fornecendo seus desafios personalizados. Esses desafios ajudarão a consolidar ou aprimorar algumas de suas principais habilidades. |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://www.fifty.do](https://www.fifty.do) |
...
Essas informações foram fornecidas pela Fifty sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
