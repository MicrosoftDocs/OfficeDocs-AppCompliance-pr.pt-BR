...
| Funcionalidade principal do aplicativo | O Zoho Sign é um aplicativo de assinatura digital seguro baseado em nuvem que permite que você assine, envie e gerencie sua documentação de negócios legal e eletronicamente. Você pode criar fluxos de trabalho de e-sign sem esforço para coletar assinaturas, autenticar signatários, disparar lembretes e acompanhar a assinatura e o status de aprovação em tempo real. O Zoho Sign também permite que você gerencie toda a sua documentação diretamente dos aplicativos microsoft a partir do navegador da Web e vá com aplicativos móveis. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| Se a estrutura subjacente processa ou armazena dados de clientes da Microsoft, onde esses dados são armazenados geograficamente? | Índia, Japão, Austrália, China, Países Baixos (a), Irlanda, Estados Unidos da América |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Entrar e ler o perfil do usuário | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |
