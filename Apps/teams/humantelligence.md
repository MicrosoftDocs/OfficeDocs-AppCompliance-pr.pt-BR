---
title: Informações do aplicativo para Humantelligence por Humantelligence
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Humantelligence, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
|:----------------|:-------------|
| Nome do aplicativo | Humantelligence |
| ID | WA200002650 |
