---
title: Informações do aplicativo para CloudLabs pelo SPektra Systems LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o CloudLabs, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63546339"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 14 de outubro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003273" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo SPektra Systems LLC à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | CloudLabs |
| ID | WA200003273 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Spektra Systems LLC |
| Site da empresa | [https://cloudlabs.ai](https://cloudlabs.ai) |
| Termos de uso do aplicativo | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| Funcionalidade principal do aplicativo | Preparar-se para certificações de fundamentos de nuvem da Microsoft ao praticar com testes de Prática do CloudLabs |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://cloudlabs.ai/cloudlabs-teams-app](https://cloudlabs.ai/cloudlabs-teams-app) |
...
Essas informações foram fornecidas pelo SPektra Systems LLC sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Listar os tipos de políticas com suporte | Todas as políticas de AC para aplicativos de nuvem |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Nome, Email, - Para poder fornecer experiência e suporte personalizados | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |
