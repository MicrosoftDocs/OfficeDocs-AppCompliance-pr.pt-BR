...
* <a href="https://teams.microsoft.com/l/app/861228c3-eefd-462f-9b13-24dae6530ac3" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002712" target="_blank">Exibir no AppSource</a>
...
| Site da empresa | [https://rubius.com](https://rubius.com) |
| Termos de uso do aplicativo | [https://planyway.com/legal/terms-of-use](https://planyway.com/legal/terms-of-use) |
| Funcionalidade principal do aplicativo | Planyway é uma ferramenta de controle de tempo e calendário de equipe do Trello para gerenciar cronogramas, acompanhar projetos e planejar seus recursos. Com Planyway, você pode organizar visualmente e simplificar todo o trabalho da equipe em um só lugar: planejar e priorizar as próximas tarefas, atribuir e agendar tarefas no calendário ou linha do tempo, acompanhar a carga de trabalho da equipe entre projetos, gerenciar a disponibilidade da equipe, controlar o tempo gasto em tarefas e projetos, sincronizar seu trabalho e agenda pessoal. |
...
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 1)? | Na |
...
| O aplicativo está em conformidade com a Organização Internacional para Padronização (ISO 27018)? | Na |
