---
title: Informações do aplicativo para ComplianceCow da ContiNube Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Todas as informações de segurança e conformidade disponíveis para ComplianceCow, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66249706"
---
# <a name="compliancecow"></a>ComplianceCow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 12 de maio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/be1720d1-f7ae-4f6e-ab02-e6911a51bc92" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004247" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela ContiNube Inc à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | ComplianceCow |
| ID | WA200004247 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | ContiNube Inc |
| Site da empresa | [https://compliancecow.com](https://compliancecow.com) |
| Termos de Uso do Aplicativo | [https://compliancecow.com/trust/termsandconditions](https://compliancecow.com/trust/termsandconditions) |
| Funcionalidade principal do aplicativo | Fluxos de trabalho minimalistas para GRC de Segurança e Garantia |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://compliancecow.com/docs#compliancecow-chat-applicati...](https://compliancecow.com/docs#compliancecow-chat-applications) |
...
Essas informações foram fornecidas pela ContiNube Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de conformidade |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de conformidade |
