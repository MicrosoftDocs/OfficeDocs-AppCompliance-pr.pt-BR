---
title: Informações do aplicativo para o oy Desocoto por Redes Desarmadas
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Hive, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">Exibir na loja do Teams</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Cuckoo |
| ID | WA200002750 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Redes de Cucos Oy |
| Site da empresa | [https://cuckoo.fi](https://cuckoo.fi) |
| Termos de Uso do Aplicativo | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
...
| Página de informações do aplicativo | [https://cuckoo.fi](https://cuckoo.fi) |
...
| Quais dados são processados pelo seu aplicativo? | Dados de Perfil de Usuário, ID do Locatário, Nome do locatário |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Informações de identificação do usuário e atividade do usuário |
...
| URL da Política de Privacidade | https://cuckoo.fi/en/privacy-policy/ |
...
| Se seu aplicativo não usar uma das bibliotecas acima, qual biblioteca ou biblioteca de autenticação ele usa? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Autenticação de usuário para o serviço por meio de logon da Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| email | Delegada | Contatando clientes com informações sobre eventos de aplicativo, competições disponíveis e atendimento ao cliente | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | Delegada | Autenticação de usuário para o serviço por meio de logon da Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | Delegada | Autenticação de usuário para o serviço por meio de logon da Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| perfil | Delegada | Autenticação de usuário para o serviço por meio de logon da Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
