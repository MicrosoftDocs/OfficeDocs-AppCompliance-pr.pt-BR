---
title: Informações do aplicativo para Scormium por Sense4code
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Scormium, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Sense4code à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Scormium |
| ID | WA200004358 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Sense4code |
| Site da empresa | [https://en.scormium.com](https://en.scormium.com) |
| Termos de Uso do Aplicativo | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| Funcionalidade principal do aplicativo | Aproveite o poder do E-learning, eventos e caminhos de estudo com o Scormium.  |
...
Essas informações foram fornecidas pelo Sense4code sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Email do usuário   |
...
| URL da Política de Privacidade | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Entrar e ler o perfil do usuário | [ffdbe361-6168-42f7-beef-d1931b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |
