...
description: Todas as informações de segurança e conformidade disponíveis para a Highspot, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002894" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Highspot à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Highspot |
| ID | WA200002894 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Highspot |
| Site da empresa | [https://www.highspot.com](https://www.highspot.com) |
| Termos de Uso do Aplicativo | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| Funcionalidade principal do aplicativo | Highspot é a plataforma de habilitação de vendas que os representantes adoram. Capacitamos as empresas a elevar as conversas dos clientes que impulsionam o crescimento estratégico. Nossa plataforma intuitiva combina gerenciamento de conteúdo inteligente, treinamento, diretrizes contextuais, envolvimento do cliente e análise acionável. As equipes de entrada no mercado usam a Highspot para oferecer uma experiência de compra unificada que aumenta a receita, a satisfação do cliente e a retenção. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
...
Essas informações foram fornecidas pela Highspot sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| Data de certificação SOC2 mais recente | 2020-08-20 |
