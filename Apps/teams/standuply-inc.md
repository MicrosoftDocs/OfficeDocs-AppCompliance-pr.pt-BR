...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | delegado | Para autorizar usuários no produto |
>| MailboxSettings.Read | aplicação | Para enviar relatórios sobre usuários de zona de tempo individual |
