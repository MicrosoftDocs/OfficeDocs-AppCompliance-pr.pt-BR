---
title: Informações do aplicativo para gauge.it por CLOUD Cover IT
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para gauge.it, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/9e9e5036-942e-42b4-8b7a-855a59d1c1a1" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003874" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela CLOUD Cover IT para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | gauge.it |
| ID | WA200003874 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | TI de Cobertura de Nuvem |
| Site da empresa | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| Termos de uso do aplicativo | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| Funcionalidade principal do aplicativo | Crie e compartilhe listas de verificação com modelos para um grupo, equipe ou até mesmo para você mesmo. |
...
Essas informações foram fornecidas pela CLOUD Cover IT sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Locatário, Canal e ID de Conversa |
...
| URL da Política de Privacidade | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Acessar a ID do Active Directory | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |
