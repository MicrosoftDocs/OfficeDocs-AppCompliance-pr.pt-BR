---
title: Informações do aplicativo para B12 by Apprentx
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: Todas as informações de segurança e conformidade disponíveis para B12, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a4a2213d-2466-473b-8772-021094c5f013" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004073" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Apprentx à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | B12 |
| ID | WA200004073 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Apprentx |
| Site da empresa | [https://apprentx.rocks](https://apprentx.rocks) |
| Termos de Uso do Aplicativo | [https://blogue.apprentx.rocks/terms-and-conditions](https://blogue.apprentx.rocks/terms-and-conditions) |
| Funcionalidade principal do aplicativo | B12 combina reforço de conhecimento e prática para maximizar o impacto. |
| Localização da sede da empresa | Canadá |
| Página de informações do aplicativo | [https://apprentx.rocks/en/nos-solutions](https://apprentx.rocks/en/nos-solutions) |
...
Essas informações foram fornecidas pela Apprentx sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Processemos tokens de ID que contêm o nome e o email dos usuários para o recurso de SSO opcional |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Armazenamos tokens de acesso para o recurso de sincronização de calendário opcional |
...
| URL da Política de Privacidade | https://blogue.apprentx.rocks/en/privacy-policy |
...
| O consentimento é obtido de um responsável ou responsável legal? | Não |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| email | Delegada | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| offline_access | Delegada | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| openid | Delegada | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| perfil | Delegada | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| Calendars.ReadWrite | Delegada | Sincronização de calendário | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
>| User.Read | Delegada | Sincronização de calendário | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
