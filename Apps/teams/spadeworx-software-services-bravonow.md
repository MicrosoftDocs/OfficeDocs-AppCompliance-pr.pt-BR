---
title: Informações de aplicativo para BravoNow pelos Serviços de Software DaWorx.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Todas as informações de segurança e conformidade disponíveis para BravoNow, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelos Serviços de Software DaWorx para a Microsoft:
...
| Nome da empresa parceira | Serviços de Software DaWorx |
...
| Funcionalidade principal do aplicativo | Bravo é uma plataforma de reconhecimento de funcionários ponto a ponto. |
...
Essas informações foram fornecidas pelos Serviços de Software Da EspadaWorx sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Endereço de email dos usuários. | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |
