---
title: Informações do aplicativo para interpretação do Akouo pela Akouo Technologies Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: 'Todas as informações de segurança e conformidade disponíveis para Interpretação do Akouo, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.'
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
---
# <a name="akouo-interpretation"></a>interpretação do Akouo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 26 de março de 2022</p>

* <a href="https://teams.microsoft.com/l/app/d863a24b-7cdd-46c9-8309-a15878f4f7bf" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003814" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Akouo Technologies Inc. à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | interpretação do Akouo |
| ID | WA200003814 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Akouo Technologies Inc. |
| Site da empresa | [https://akouo.io](https://akouo.io) |
| Termos de uso do aplicativo | [https://akouo.io/terms](https://akouo.io/terms) |
| Funcionalidade principal do aplicativo | Tornar suas reuniões multilíngues com interpretação simultânea. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://akouo.io](https://akouo.io) |
...
Essas informações foram fornecidas pela Akouo Technologies Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou ao dispositivo? | Sim |
| Quais dados são processados pelo aplicativo? | Dados de perfil de usuário, imagem e áudio usados no MS Teams. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Endereço de email do usuário. |
...
| URL da Política de Privacidade | https://akouo.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.Read | delegado | Usado para obter detalhes da reunião, como hora de início etc. Solicitado apenas para o organizador da reunião. | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| offline_access | aplicação | Automaticamente exigido pela microsoft&#8217;estrutura de Logom Único. https://docs.microsoft.com/graph/permissions-reference#remarks-15  | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| openid | aplicação | Autenticar usuários com a sessão de logon do Microsoft/Azure | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
