---
title: Informações do aplicativo para contatos unificados por glueckkanja-gab AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Contatos Unificados, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003877" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela AG glueckkanja-gab para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Contatos Unificados |
| ID | WA200003877 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | glueckkanja-gab AG |
| Site da empresa | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| Termos de uso do aplicativo | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Pesquisa unificada do Azure AD, seus contatos corporativos, Exchange Online e seus contatos pessoais. |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
Essas informações foram fornecidas pela AG glueckkanja-gab sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
| O consentimento é obtido de um pai ou responsável legal? | Não |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read.Shared | delegado | Os Contatos Unificados exigem acesso aos dados de contato no locatário do cliente para fornecer funcionalidade básica. | [83ff0fe1-a544-4390-bd72-3aaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | delegado | Os Contatos Unificados exigem acesso aos dados de contato no locatário do cliente para fornecer funcionalidade básica. | [83ff0fe1-a544-4390-bd72-3aaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | delegado | Os Contatos Unificados exigem acesso aos dados de contato no locatário do cliente para fornecer funcionalidade básica. | [83ff0fe1-a544-4390-bd72-3aaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
