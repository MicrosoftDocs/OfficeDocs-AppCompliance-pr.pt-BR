---
title: Informações do aplicativo para HitHorizons pelo FinStat s.r.o.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para HitHorizons, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/2b492ea3-0727-4789-90d7-8e2079d46717" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001411" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo FinStat s.r.o. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | HitHorizons |
| ID | WA200001411 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | FinStat s.r.o. |
| Site da empresa | [https://www.hithorizons.com](https://www.hithorizons.com) |
| Termos de uso do aplicativo | [https://www.hithorizons.com/legal/terms-and-conditions](https://www.hithorizons.com/legal/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Acesse o banco de dados HitHorizons de mais de 75M+ empresas da Europa e do Microsoft Teams |
| Localização da sede da empresa | Eslováquia |
| Página de informações do aplicativo | [https://www.hithorizons.com/services/microsoft/teams](https://www.hithorizons.com/services/microsoft/teams) |
...
Essas informações foram fornecidas pelo FinStat s.r.o. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
