---
title: Informações do aplicativo para a Astultômetro pela Astultômetro
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Mentimeter, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pelo Estorômetro para a Microsoft:
...
| Funcionalidade principal do aplicativo | Envolva os participantes com Enquetes, Quizzes, Nuvens do Word, QA&amp; e muito mais para capturar entrada em tempo real.
 |
...
Essas informações foram fornecidas pela Empresameter sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
