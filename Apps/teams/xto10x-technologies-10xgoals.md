...
| Site da empresa | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| Termos de uso do aplicativo | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| Funcionalidade principal do aplicativo | O 10xGoals é uma ferramenta para conduzir estratégias para a execução com foco, alinhamento, colaboração e visibilidade em toda a equipe. Com a integração 10xGoals &lt;&gt; Microsoft Teams, pode-se gerenciar toda a execução aqui em si. Para começar, os usuários podem aceitar/recusar/comentários sobre os objetivos atribuídos a eles para gerenciar melhor seu tempo. Para usar este Aplicativo, os usuários devem ter uma assinatura ativa 10xGoals. |
| Localização da sede da empresa | Índia |
| Página de informações do aplicativo | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | aplicação | Os usuários enviam emails e a id do azure é buscada para que o aplicativo possa instalar o aplicativo proativamente para todos os usuários da organização.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | aplicação | É necessário para que o aplicativo possa buscar o teamsAppDefinition instalado para administrador e instalar-se proativamente para todos os usuários da organização.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
