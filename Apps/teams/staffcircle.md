...
description: Todas as informações de segurança e conformidade disponíveis para StaffCircle, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7b358bf7-16db-498d-9407-80d2db25eb68" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | StaffCircle |
| Site da empresa | [https://www.staffcircle.com](https://www.staffcircle.com) |
| Termos de Uso do Aplicativo | [https://www.staffcircle.com/terms](https://www.staffcircle.com/terms) |
| Funcionalidade principal do aplicativo | Plataforma interna de comunicação, cultura, envolvimento e gerenciamento de desempenho para funcionários remotos. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://www.staffcircle.com/integrations/microsoft-teams-in...](https://www.staffcircle.com/integrations/microsoft-teams-integration/) |
