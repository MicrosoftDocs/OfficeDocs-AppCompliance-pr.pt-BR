...
<p>Última atualização pelo desenvolvedor em: 17 de julho de 2021</p>

* <a href="https://teams.microsoft.com/l/app/da84bd82-1002-4487-be1a-ebec71d9a61a" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003492" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Software de Liga de Liga para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo |  Assistente de Autoatendimento de liga  |
| ID | WA200003492 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Software de Liga |
| Site da empresa | [https://alloysoftware.com](https://alloysoftware.com) |
| Termos de uso do aplicativo | [https://www.alloysoftware.com/resources/eula/](https://www.alloysoftware.com/resources/eula/) |
| Funcionalidade principal do aplicativo | Crie tíquetes de service desk, pesquise o base de dados de conhecimento e aprove solicitações. |
...
Essas informações foram fornecidas pelo Software de Liga sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou ao dispositivo? | Sim |
| Quais dados são processados pelo aplicativo? | endereços de email do usuário, locatários do cliente |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | locatários do cliente |
...
| Data de certificação SOC2 mais recente |  2021-11-15 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente |  2021-11-09 |
...
| URL da Política de Privacidade | https://www.alloysoftware.com/resources/privacy/ |
