---
title: Informações de aplicativo para Beekast por Beekast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Beekast, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/377da6a7-efc3-4599-887a-1d3eda45120a" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Beekast |
| Site da empresa | [https://www.beekast.com](https://www.beekast.com) |
| Termos de Uso do Aplicativo | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| Funcionalidade principal do aplicativo | O Beekast é uma plataforma colaborativa para acelerar suas reuniões. |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://www.beekast.com](https://www.beekast.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Email, nome e sobrenome: esses dados são usados para colaborar no aplicativo beekast. | [4d0997dc-df53-4b18-9df1-bb283f8a0377](../azure/4d0997dc-df53-4b18-9df1-bb283f8a0377.md) |
