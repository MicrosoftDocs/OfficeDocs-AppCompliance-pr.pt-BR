---
title: Informações do aplicativo para | Gerenciamento de modelos por eformity
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Todas as informações de segurança e conformidade disponíveis para informações de | Gerenciamento de modelos, suas políticas de manipulação de dados, Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64771439"
---
# <a name="eformity--template-management"></a>eformity | Gerenciamento de Modelos

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 19 de novembro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela eformity à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | eformity – Gerenciamento de Modelos |
| ID | WA200003519 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | eformity |
| Site da empresa | [https://eformity.nl](https://eformity.nl) |
| Termos de Uso do Aplicativo | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| Funcionalidade principal do aplicativo | Use modelos gerenciados centralmente para criar documentos e apresentações de Microsoft Teams. |
...
Essas informações foram fornecidas pela eformity sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | User Mail, User Name, User First Name, User Last Name |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | User Mail, User Name, User First Name, User Last Name |
...
| URL da Política de Privacidade | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Delegada | Salvar modelos gerados | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | Delegada | Coletar dados para atualizar o perfil do usuário em nossa plataforma | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | Delegada | Entrar de um usuário | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| perfil | Delegada | Entrar de um usuário | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
