...
description: Todas as informações de segurança e conformidade disponíveis para Smartnotation, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Smartnotation B.V. |
| Site da empresa | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| Termos de Uso do Aplicativo | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| Funcionalidade principal do aplicativo | A anotação inteligente é uma solução de minutos de reunião fácil de usar e habilitada para voz. Suas anotações, ações e decisões são fáceis de gerenciar e suas informações estão sempre disponíveis. Acima de tudo, ele tira a sobrecarga desnecessária, permitindo que você e sua equipe se concentrem em seu negócio principal. Você pode integrar o Smartnotation completamente ao MS Teams. Adicione um conector para ser notificado de todas as atualizações importantes, novas anotações, ações e decisões para um projeto específico, configurar uma guia ou usar a Smartnotation diretamente. |
| Localização da sede da empresa | Países Baixos (o) |
| Página de informações do aplicativo | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? |  |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | Totaaldomein B.V. |
...
Essas informações foram fornecidas pelo Smartnotation B.V. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
