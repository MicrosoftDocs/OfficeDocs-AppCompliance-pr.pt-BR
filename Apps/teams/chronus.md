...
description: Todas as informações de segurança e conformidade disponíveis para Chronus, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bb32d4e5-ae29-4c59-ba7e-a11611ca9710" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Chronus |
| Site da empresa | [https://chronus.com](https://chronus.com) |
| Termos de Uso do Aplicativo | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| Funcionalidade principal do aplicativo | O software Chronus capacita milhares de programas de orientação bem-sucedidos para algumas das&#8217;maiores organizações. Facilitamos o início, o gerenciamento e a medida do impacto da orientação.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://chronus.com/services](https://chronus.com/services) |
...
Essas informações foram fornecidas pelo Chronus sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
