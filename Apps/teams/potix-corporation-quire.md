---
title: Informações do aplicativo para Quire da Potix Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Quire, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/dfad3be2-e62c-49c5-9453-ccd30999f003" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Potix Corporação |
| Site da empresa | [https://www.quire.io](https://www.quire.io) |
| Termos de Uso do Aplicativo | [https://quire.io/terms](https://quire.io/terms) |
| Funcionalidade principal do aplicativo | O melhor software de gerenciamento de projetos colaborativos para dividir metas em listas hierárquicas. |
| Localização da sede da empresa | Taiwan (província da China) |
| Página de informações do aplicativo | [https://www.quire.io](https://www.quire.io) |
...
| Data de certificação SOC1 mais recente | 2020-06-24 |
