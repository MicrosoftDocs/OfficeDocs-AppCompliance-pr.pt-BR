---
title: Informações de aplicativo para AMEX GBT por 30SecondsToFly (Tailândia) Co Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Todas as informações de segurança e conformidade disponíveis para AMEX GBT, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/157b5ffb-b183-453c-b072-9c94bb6c694c" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | 30SecondsToFly (Tailândia) Co Ltd |
| Site da empresa | [https://www.amexglobalbusinesstravel.com](https://www.amexglobalbusinesstravel.com) |
| Termos de Uso do Aplicativo | [https://www.amexglobalbusinesstravel.com/terms-service/](https://www.amexglobalbusinesstravel.com/terms-service/) |
| Funcionalidade principal do aplicativo | Converse com um conselheiro de viagens. Se você precisa de ajuda para encontrar um lugar para ficar ou apenas perder um voo, nossos conselheiros de viagens estão disponíveis para conversar 24 horas por dia, 7 dias por semana. |
