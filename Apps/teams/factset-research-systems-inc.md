---
title: Informações de aplicativo para FactSet da FactSet Research Systems Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Todas as informações de segurança e conformidade disponíveis para FactSet, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | FactSet Research Systems Inc. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicação | Nome e email para verificação e registro em log, ID da Conversa para envio proativo de mensagens | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
