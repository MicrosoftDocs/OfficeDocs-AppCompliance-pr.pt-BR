---
title: Informações do aplicativo para Findit por CTELO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Findit, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64881358"
---
# <a name="findit"></a>Findit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 25 de janeiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo CTELO à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Findit |
| ID | WA200003849 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | CTELO |
| Site da empresa | [https://www.ctelo.com](https://www.ctelo.com) |
| Termos de Uso do Aplicativo | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| Funcionalidade principal do aplicativo | Encontre slots de calendário gratuitos para colegas, Teams status e informações de contato. |
...
Essas informações foram fornecidas pela CTELO sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Entradas de calendário e informações de contato. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegada | Permitir que o aplicativo leia eventos em calendários do usuário. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Contacts.Read | Delegada | Permitir que o aplicativo leia os contatos do usuário. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Group.Read.All | Delegada | Permitir que o aplicativo leia grupos de usuários. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Presence.Read.All | Delegada | Permitir que o aplicativo leia informações de presença de todos os usuários. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read | Delegada | Permitir que o aplicativo leia o perfil do usuário. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read.All | Delegada | Permitir que o aplicativo leia todos os perfis de usuário. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
