---
title: Informações do aplicativo para Zavvy por Zavvy GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Zavvy, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/15562290-1f82-4829-9638-452633a217d8" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003965" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Zavvy GmbH à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Zavvy |
| ID | WA200003965 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Zavvy GmbH |
| Site da empresa | [https://www.zavvy.io](https://www.zavvy.io) |
| Termos de Uso do Aplicativo | [https://www.zavvy.io/terms-conditions](https://www.zavvy.io/terms-conditions) |
| Funcionalidade principal do aplicativo | Integre, desenvolva e conecte suas pessoas diretamente no Microsoft Teams. |
...
Essas informações foram fornecidas por Zavvy GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Informações do perfil do usuário, informações da equipe |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | IDs dos usuários, ID do Locatário, Nome e ID da Equipe na qual o aplicativo está instalado. |
...
| URL da Política de Privacidade | https://www.zavvy.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegada | Para poder verificar se o aplicativo já está instalado em uma equipe | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Channel.Create | aplicação | Para poder criar canais caso seja necessário enviar mensagens de grupo aos usuários em uma organização. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| ChannelMember.ReadWrite.All | aplicação | Para enviar mensagens a usuários e canais  | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Group.Read.All | aplicação | Para listar todas as equipes em um locatário para que o administrador possa escolher uma equipe para instalar o aplicativo. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamMember.Read.All | aplicação | Para localizar um usuário e sua ID do Bot Framework de uma determinada equipe depois que o aplicativo é instalado em uma equipe. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | aplicação | Para instalar o aplicativo Zavvy Microsoft Teams em uma equipe. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
