---
title: Informações de aplicativo para Kippa da KLIPPAS Technologies inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/13/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Kippa, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/49d0e480-ede2-11ea-85fc-27f7e2c29730" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | KLIPPAS Technologies inc. |
| Site da empresa | [https://www.kippa.app](https://www.kippa.app) |
| Termos de Uso do Aplicativo | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| Funcionalidade principal do aplicativo | Defina rapidamente lembretes pessoais, compartilhados ou de canal recorrentes de dentro de Microsoft Teams |
| Localização da sede da empresa | Canadá |
| Página de informações do aplicativo | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
...
| Listar os tipos de políticas com suporte | O mesmo Microsoft Teams, pois os usuários precisam entrar no Teams para obter acesso ao Kippa. |
