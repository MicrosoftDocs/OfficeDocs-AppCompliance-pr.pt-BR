---
title: Informações do aplicativo para SurveySparrow da SurveySparrow inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para SurveySparrow, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1b923c85-b04c-43d4-b2c2-0fdc0f598658" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela SurveySparrow inc. à Microsoft:
...
| Nome da empresa parceira | SurveySparrow inc. |
| Site da empresa | [https://surveysparrow.com](https://surveysparrow.com) |
| Termos de Uso do Aplicativo | [https://surveysparrow.com/legal/terms-of-service/](https://surveysparrow.com/legal/terms-of-service/) |
| Funcionalidade principal do aplicativo | Realize stand-ups diários, felicidade mensal e meça facilmente o pulso dos funcionários. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://surveysparrow.com/apps/microsoft-teams-survey-integ...](https://surveysparrow.com/apps/microsoft-teams-survey-integration/) |
...
Essas informações foram fornecidas pela SurveySparrow inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
