---
title: Informações do aplicativo para PostBeyond por PostBeyond
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o PostBeyond, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6e588f9e-5271-4583-b373-7991497deaec" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002658" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo PostBeyond para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | PostBeyond |
| ID | WA200002658 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | PostBeyond |
| Site da empresa | [https://www.postbeyond.com](https://www.postbeyond.com) |
| Termos de Uso do Aplicativo | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| Funcionalidade principal do aplicativo | Ative seus defensores de mídia social para aumentar a visibilidade da marca, o envolvimento e os resultados mensuráveis com a consultoria de funcionários da plataforma PostBeyond. Amplificar seu melhor conteúdo em suas redes sociais de funcionários, dando à sua marca a atenção que ela merece. Facilitamos o dimensionamento da defesa dos funcionários para profissionais de marketing e é muito fácil para os funcionários.  |
| Localização da sede da empresa | Canadá |
| Página de informações do aplicativo | [https://www.postbeyond.com/product/](https://www.postbeyond.com/product/) |
...
Essas informações foram fornecidas pelo PostBeyond sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
