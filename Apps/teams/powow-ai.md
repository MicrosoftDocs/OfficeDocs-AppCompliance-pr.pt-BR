...
ms.locfileid: "62200550"
---
# <a name="powow"></a>Powow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 15 de dezembro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002952" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela AI do Powow para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Powow |
| ID | WA200002952 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | IA do Powow |
| Site da empresa | [https://www.powow.ai](https://www.powow.ai) |
...
Essas informações foram fornecidas pela AI do Powow sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil de usuário, email do usuário, eventos de calendário |
...
| URL da Política de Privacidade | https://www.sembly.ai/wp-content/uploads/2021/09/privacy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | aplicação | Usado para o Conector de Pesquisa (recurso para empurrar dados powow para os índices da Microsoft para pesquisa em serviços Microsoft) |
>| ExternalItem.ReadWrite.All | aplicação | Usado para o Conector de Pesquisa (recurso para empurrar dados powow para os índices da Microsoft para pesquisa em serviços Microsoft) |
>| email | delegado | Exibir o endereço de email dos usuários para registro e logon |
>| offline_access | delegado | Para acessar os dados do usuário dentro do aplicativo (controlar atualizações de calendário) |
>| openid | delegado | Conectar os usuários |
>| perfil | delegado | Para acessar as informações básicas de perfil dos usuários para registro |
>| User.Read | delegado | Entrar e ler o perfil do usuário para registro e logon |
