---
title: Informações do aplicativo para Meetgeek by AIVISION PRODUCTS SRL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/28/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Meetgeek, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo AIVISION PRODUCTS SRL para a Microsoft:
...
| Nome da empresa parceira | SRL DE PRODUTOS DO AIVISION |
...
| Funcionalidade principal do aplicativo | Maximize a produtividade de suas reuniões online! Registre, transcreva, compartilhe resumos e acesse automaticamente os insights da reunião. |
...
Essas informações foram fornecidas pelo AIVISION PRODUCTS SRL sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de Perfil do Usuário, Reuniões Online do Calendário |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de Perfil do Usuário, Reuniões Online do Calendário |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegada | Sincronizando dados de calendário para o usuário | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| OnlineMeetings.ReadWrite | Delegada | Sincronizando reuniões online para o usuário | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| User.Read | Delegada | Identificando o usuário conectado | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| email | Delegada | Identificando o usuário conectado | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| offline_access | Delegada | Sincronizando dados de calendário para o usuário | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| openid | Delegada | Identificando o usuário conectado | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| perfil | Delegada | Identificando o usuário conectado | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| Calls.AccessMedia.All | Delegada | Disparar o bot Meetgeek para ingressar no MS Teams chamadas do usuário | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.Initiate.All | Delegada | Disparar o bot Meetgeek para ingressar no MS Teams chamadas do usuário | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.InitiateGroupCall.All | Delegada | Disparar o bot Meetgeek para ingressar no MS Teams chamadas do usuário | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.JoinGroupCall.All | Delegada | Disparar o bot Meetgeek para ingressar no MS Teams chamadas do usuário | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
