...
description: Todas as informações de segurança e conformidade disponíveis para ClipTraining, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6cb4b701-2a4f-4080-8a8a-d99f93905e15" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo ClipTraining para a Microsoft:
...
| Nome da empresa parceira | ClipTraining |
| Site da empresa | [https://www.cliptraining.com](https://www.cliptraining.com) |
| Termos de Uso do Aplicativo | [https://www.cliptraining.com/eula/](https://www.cliptraining.com/eula/) |
| Funcionalidade principal do aplicativo | Um serviço de streaming de conteúdo para aprendizado moderno, incluindo mais de 5.000 lições Microsoft 365. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.cliptraining.com](https://www.cliptraining.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Delegada | Endereço de email, nome, sobrenome para logon e correspondência do usuário.  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| offline_access | Delegada | Endereço de email, nome, sobrenome para logon e correspondência do usuário.  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| openid | Delegada | Endereço de email, nome, sobrenome para logon e correspondência do usuário.  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| perfil | Delegada | Endereço de email, nome, sobrenome para logon e correspondência do usuário.  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
