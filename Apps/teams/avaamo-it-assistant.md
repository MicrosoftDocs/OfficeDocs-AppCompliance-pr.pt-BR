---
title: Informações do aplicativo para o Assistente de IT da Avaamo pela Avaamo
ms.author: elmalova
author: elenamalova
ms.date: 11/01/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para o Assistente de IT da Avaamo, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "60874795"
---
# <a name="avaamo-it-assistant"></a>Assistente de IT da Avaamo
...
* <a href="https://teams.microsoft.com/l/app/ed016582-bd1f-4994-ba97-49daab163b19" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003362" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Avaamo à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Assistente de IT da Avaamo |
| ID | WA200003362 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Avaamo |
| Site da empresa | [https://avaamo.ai](https://avaamo.ai) |
| Termos de uso do aplicativo | [https://avaamo.ai/tos/](https://avaamo.ai/tos/) |
| Funcionalidade principal do aplicativo | Assistente de conversa inteligente que resolve instantaneamente Microsoft Office 365 consultas de suporte. |
...
Essas informações foram fornecidas pela Avaamo sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| O aplicativo está em conformidade com a Health Information Trust Alliance, Common Security Framework (HITRUST CSF)? | Não disponível |
...
| URL da Política de Privacidade | https://www.avaamo.ai/privacy/ |
