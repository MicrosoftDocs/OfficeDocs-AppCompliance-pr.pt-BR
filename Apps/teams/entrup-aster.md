---
title: Informações do aplicativo para o Aster by Entrup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Aster, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2d8e8042-66df-4605-8c3a-9ca8962f3e99" target="_blank">Exibir na loja do Teams</a>
...
Informações fornecidas pelo Entrup para a Microsoft:
...
| Nome da empresa parceira | Entrup |
| Site da empresa | [https://asterapp.co](https://asterapp.co) |
| Termos de Uso do Aplicativo | [https://asterapp.co/conditions-generales/](https://asterapp.co/conditions-generales/) |
| Funcionalidade principal do aplicativo | Minutos de reunião que fazem você economizar tempo! |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? |  |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | Azure, OVH Cloud (França) |
...
Essas informações foram fornecidas pela Entrup sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegada | Lista de diretórios para enviar tarefas do Planner de documentos do Sharepoint | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Group.ReadWrite.All | Delegada | Lista de grupos para enviar tarefas do Planner de documentos do Sharepoint em grupos existentes ou criados | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Notes.ReadWrite.All | Delegada | Conteúdo de anotações para escrita no OneNote | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Tasks.ReadWrite.Shared | Delegada | Tarefas, atribuição, prazos | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| User.Read | Delegada | Email do usuário para identificar o usuário | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| offline_access | Delegada | Nenhum dado coletado, apenas para atualizar o token de forma insu mesmo | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
