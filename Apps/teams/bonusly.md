---
title: Informações do aplicativo para Bonusly por Bonusly
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Bonusly, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65454976"
---
# <a name="bonusly"></a>Bonusly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 16 de maio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/c06753b3-85de-4054-9a99-dcd869dc0836" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Bonusly à Microsoft:
...
| Site da empresa | [https://bonus.ly](https://bonus.ly) |
| Termos de Uso do Aplicativo | [https://bonus.ly/terms_of_service](https://bonus.ly/terms_of_service) |
| Funcionalidade principal do aplicativo | Reconhecimento frequente e o tempo limite do Spark integrando o Bonusly ao Microsoft Teams |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://bonus.ly/integrations/teams](https://bonus.ly/integrations/teams) |
...
Essas informações foram fornecidas pelo Bonusly sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Endereço de email, Nome, Sobrenome, Data de Nascimento (se recurso usado), Data de Contratação (se recurso usado) |
...
| Data de certificação SOC2 mais recente | 2022/4/28 |
...
| URL da Política de Privacidade | https://bonus.ly/privacy_policy |
