...
description: Todas as informações de segurança e conformidade disponíveis para TeamGether, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5a0547cc-ea63-4425-acc8-08b89a8fc1a1" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo EFFENCY para a Microsoft:
...
| Site da empresa | [https://www.effency.fr](https://www.effency.fr) |
| Termos de Uso do Aplicativo | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| Funcionalidade principal do aplicativo | TeamGether é o principal aplicativo de treinamento digital em eficiência coletiva desenvolvido pela EFFENCY |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
...
Essas informações foram fornecidas pela EFFENCY sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
