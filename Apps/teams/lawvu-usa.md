---
title: Informações do aplicativo para LawVu USA por LawVu
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o LawVu USA, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/410462ec-76c7-45ac-9f57-61e6f82a6792" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003911" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | LawVu USA |
| ID | WA200003911 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | LawVu |
...
| Funcionalidade principal do aplicativo | Os usuários empresariais podem gerar solicitações legais diretamente Teams.  A integração captura todos os campos relevantes, incluindo o conteúdo e todos os anexos da mensagem original, e cria o assunto no LawVu para que ele&#8217;parte da equipe jurídica&#8217;sistema de registro. |
...
Essas informações foram fornecidas pelo LawVu sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| Quais dados são armazenados em seus bancos de dados? | O arquivo de anexo nas equipes do MS é extraído para nosso armazenamento de dados. |
...
| Você tem contratos de compartilhamento de dados em vigor com qualquer serviço de terceiros com o qual você compartilha dados de clientes da Microsoft? |  |
