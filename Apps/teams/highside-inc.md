...
description: Todas as informações de segurança e conformidade disponíveis para HighSide, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003916" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela HighSide, Inc para a Microsoft:
...
| Site da empresa | [https://highside.io](https://highside.io) |
| Termos de Uso do Aplicativo | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| Funcionalidade principal do aplicativo | E2E Encrypted Messaging &amp; Files for Microsoft Teams. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://highside.io/secureteams](https://highside.io/secureteams) |
...
| Quais dados são processados pelo seu aplicativo? | Usuário UUID da Microsoft, Nome de Usuário, Endereço de Email do Usuário |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Usuário UUID da Microsoft, Nome de Usuário, Endereço de Email do Usuário |
...
| URL da Política de Privacidade | https://highside.io/privacy-policy |
