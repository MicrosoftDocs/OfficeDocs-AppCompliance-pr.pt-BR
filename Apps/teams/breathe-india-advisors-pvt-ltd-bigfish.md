...
description: Todas as informações de segurança e conformidade disponíveis para o Bigfish, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Funcionalidade principal do aplicativo | Reconheça. Recompensa. Ascensão. Impulsionar a produtividade do local de trabalho por meio do envolvimento moderno dos funcionários. |
