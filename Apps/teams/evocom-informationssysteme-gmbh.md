...
| Site da empresa | [https://evocom.de](https://evocom.de) |
...
| Quais dados são armazenados em seus bancos de dados? | ID do usuário, Email, Nome, Profilbild |
...
| URL da Política de Privacidade | https://evocom.de/datenschutz |
...
| Listar os tipos de políticas com suporte | Autenticação multifafação - Kundenspezifisch |
