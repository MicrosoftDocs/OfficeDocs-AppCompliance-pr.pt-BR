...
description: Todas as informações de segurança e conformidade disponíveis para TINYpulse, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1950b3dc-66fc-4c5f-bbbe-e411ad91a49f" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo TINYpulse à Microsoft:
...
| Site da empresa | [https://www.tinypulse.com](https://www.tinypulse.com) |
| Termos de Uso do Aplicativo | [https://www.tinypulse.com/terms-and-conditions](https://www.tinypulse.com/terms-and-conditions) |
| Funcionalidade principal do aplicativo | Aplicativo com classificação superior para melhorar a cultura, o reconhecimento e evitar pontos cegos. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.tinypulse.com/engage](https://www.tinypulse.com/engage) |
...
Essas informações foram fornecidas pelo TINYpulse sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | conversation_id, conversation_type, tenant_id, service_url, email, userPrincialName, ID de usuário, ID de objeto do usuário (AADObjectId) |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | conversation_id, conversation_type, tenant_id, service_url, email, userPrincialName, ID de usuário, ID de objeto do usuário (AADObjectId) |
...
| URL da Política de Privacidade | https://www.tinypulse.com/privacy-policy |
