---
title: Informações do aplicativo para o agendamento de WorkJam por WorkJam
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Agendamento do WorkJam, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64880108"
---
# <a name="workjam-schedule"></a>Agendar WorkJam

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 13 de julho de 2021</p>

* <a href="https://teams.microsoft.com/l/app/02cc7d46-7636-4f30-bae2-c5dfde32751c" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003058" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo WorkJam para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Agendar WorkJam |
| ID | WA200003058 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | WorkJam |
...
| Funcionalidade principal do aplicativo | O WorkJam é o líder do setor de soluções do Local de Trabalho Digital que opta por orquestrar suas forças de trabalho de linha de frente &#8212; como sua plataforma de produtividade de linha de frente ou dentro de sua solução de funcionários de linha de frente. Disponível em mais de 37 idiomas e implantado em mais de 38 países, o WorkJam fornece total orquestração de força de trabalho por meio de gerenciamento de tarefas líder no mercado, gerenciamento de turnos, pesquisa e microapresa.  |
...
Essas informações foram fornecidas pelo WorkJam sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
| Data de certificação SOC2 mais recente | 2020-08-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | aplicação | Enviar notificações aos usuários finais. | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
>| User.Read | Delegada | Para identificação e autenticação | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
