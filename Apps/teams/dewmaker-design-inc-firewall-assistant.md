---
title: Informações do aplicativo para o Assistente de Firewall da DewMaker Design, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/08/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Assistente de Firewall, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003363" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela DewMaker Design, Inc. para a Microsoft:
...
| Nome da empresa parceira | DewMaker Design, Inc. |
...
| Funcionalidade principal do aplicativo | Gerenciamento de autoatendimento SQL do Azure regras de firewall do servidor usando Microsoft Teams. |
...
Essas informações foram fornecidas pela DewMaker Design, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Endereço de Email e URL de Assinatura do Azure |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Endereço de email (para logons do MS) e dados de ponto de extremidade de assinatura do Azure |
