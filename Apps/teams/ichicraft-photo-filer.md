---
title: Informações do aplicativo para o Photo Filer da Ichicraft
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Photo Filer, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64879718"
---
# <a name="photo-filer"></a>Arquivador de Fotos
...
* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Ichicraft à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Arquivador de Fotos |
| ID | WA200003881 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Ichicraft |
...
| Funcionalidade principal do aplicativo | A maneira mais fácil de compartilhar e arquivar suas fotos Microsoft Teams. |
...
Essas informações foram fornecidas pela Ichicraft sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Delegada | Criar uma mensagem de chat com um pequeno resumo das fotos que foram carregadas pelo usuário. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | Delegada | Lendo a estrutura da pasta e carregando arquivos na biblioteca SharePoint documentos. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | Delegada | Ler o perfil dos usuários. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
