---
title: Informações do aplicativo para o SkyPoint Cloud da SkyPoint Cloud Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/21/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o SkyPoint Cloud, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64880549"
---
# <a name="skypoint-cloud"></a>SkyPoint Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 21 de fevereiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo SkyPoint Cloud Inc. à Microsoft:
...
| Site da empresa | [https://skypointcloud.com](https://skypointcloud.com) |
| Termos de Uso do Aplicativo | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| Funcionalidade principal do aplicativo | O SkyPoint ajuda as marcas a conhecer seus clientes, tomar decisões estratégicas e tomar consistentemente o curso certo de ação para atender melhor seus consumidores e continuar a crescer seus negócios. Somos uma plataforma de dados do cliente que fornece funcionalidades inteligentes em gerenciamento e unificação de dados, conformidade de privacidade, análise e insights e ativação.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
Essas informações foram fornecidas pela SkyPoint Cloud Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
