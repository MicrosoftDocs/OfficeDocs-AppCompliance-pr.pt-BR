...
* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Exibir no Teams store</a>
...
| Funcionalidade principal do aplicativo | O SkyPoint ajuda as marcas a conhecer seus clientes, tomar decisões estratégicas e, de forma consistente, tomar o caminho certo para atender melhor seus consumidores e continuar crescendo seus negócios. Somos uma plataforma de dados do cliente que fornece recursos inteligentes em gerenciamento e unificação de dados, conformidade de privacidade, análise e insights e ativação.  |
...
Essas informações foram fornecidas pelo SkyPoint Cloud Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
