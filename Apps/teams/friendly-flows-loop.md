...
* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas por Fluxos Amigáveis para a Microsoft:
...
| Nome da empresa de parceiro | Fluxos Amigáveis |
...
Essas informações foram fornecidas por Fluxos Amigáveis sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | delegado | Autenticação |
>| perfil | delegado | Autenticação |
>| email | delegado | Registro |
