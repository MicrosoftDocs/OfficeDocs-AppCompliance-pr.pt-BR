---
title: Informações do aplicativo para gerenciamento de treinamento de funcionários por SharePoint| Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: As informações nesta página se baseiam em um relatório de autoavaliação fornecido pelo desenvolvedor do aplicativo sobre as práticas de segurança, conformidade e tratamento de dados seguidas por esse aplicativo.
...
* <a href="https://teams.microsoft.com/l/app/17b6b751-7463-4afd-a3ae-ad26a20c8904" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001512" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo SharePoint| Sapiens para Microsoft:
...
| Nome da empresa parceira | \|SharePoint Sapiens |
...
| Funcionalidade principal do aplicativo | O suplemento Gerenciamento de Treinamento de Funcionários facilita a organização e a administração do contínuo desenvolvimento profissional dos funcionários para todos. Desde a configuração e o agendamento de eventos de treinamento, gerenciamento de aprendizes e suas atribuições e registros, até o acompanhamento de conquistas e comentários, tudo é abordado. O suplemento ajuda você a cumprir seus regulamentos de conformidade e políticas de segurança. Ele permite atribuir treinamento necessário, acompanhar conquistas, gerenciar expirações e muito mais. |
| Localização da sede da empresa | Áustria |
| Página de informações do aplicativo | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/documentation/teams/) |
...
Essas informações foram fornecidas por SharePoint| O Sapiens sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | Delegada | Ler informações básicas do usuário para habilitar Exchange reserva de sala | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
