---
title: Informações do aplicativo para Plumm da Plumm Health LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Plumm, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d66da813-3337-4f88-8e08-f01c0bbb8f34" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Plumm Health LTD |
...
| Funcionalidade principal do aplicativo | A Plumm fornece aos funcionários o suporte necessário para seu bem-estar mental. Cada membro da Plumm tem acesso ao suporte à saúde mental de alta qualidade com uma rede global de mais de 150 terapeutas credenciados, uma biblioteca digital de cursos de bem-estar orientados por terapeuta, terapia de chat e mediações guiadas &#8211; tudo em um só lugar. Os usuários podem se conectar com terapeutas para videoterapia online 1:1 ou conversar com eles em particular sobre suas necessidades. Cursos online e meditações ministrado por terapeuta fornecem suporte de autoatendimento. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | aplicação | Usamos o userID nessa permissão. Isso é usado para enviar notificações necessárias para o usuário com base no uso do nosso serviço. Isso é importante para que o usuário receba notificações apropriadas para sua conta em nosso aplicativo. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | aplicação | Recebemos a ID de instalação usando essa permissão. Isso é importante para que seja possível enviar a notificação apropriada e correta para cada usuário individual. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read | Delegada | Estamos coletando nome, imagem e email para nossos usuários por meio dessa permissão. Isso é necessário para que seja possível identificar usuários individuais e esses pontos de dados devem ser exibidos sempre que necessário, como página de perfil individual e comunicação por email/notificação. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read.All | aplicação | Essa permissão permite que nosso aplicativo leia perfis de usuário sem um usuário conectado. Neste momento, estamos coletando apenas o nome, a imagem do perfil e o email. Isso é necessário para que seja possível identificar usuários individuais e esses pontos de dados devem ser exibidos sempre que necessário, como página de perfil individual e comunicação por email/notificação. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| email | Delegada | A ID de email do usuário é coletada. Exigimos esses dados para conceder acesso ao usuário para nossos serviços e entrar em nosso aplicativo e receber notificações sobre suas contas e nossos serviços nesta ID de email.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| openid | Delegada | Para essa permissão, não estamos coletando dados.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| perfil | Delegada | Estamos coletando nome, imagem e email para nossos usuários por meio dessa permissão. Isso é necessário para que seja possível identificar usuários individuais e esses pontos de dados devem ser exibidos sempre que necessário, como página de perfil individual e comunicação por email/notificação. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
