---
title: Informações do aplicativo para ngDesk by All Blue Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
description: Todas as informações de segurança e conformidade disponíveis para ngDesk, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/64d24486-30aa-4fae-8bdc-2680a85dcbb5" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Soluções All Blue |
| Site da empresa | [https://ngdesk.com](https://ngdesk.com) |
| Termos de Uso do Aplicativo | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| Funcionalidade principal do aplicativo | O ngDesk inclui suporte, vendas, gerenciamento de ativos, marketing e pager em um aplicativo tudo em um que está pronto para uso e fácil de usar. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://ngdesk.com](https://ngdesk.com) |
