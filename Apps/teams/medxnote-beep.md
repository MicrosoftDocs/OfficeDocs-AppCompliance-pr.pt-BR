---
title: Informações do aplicativo para Beep by Medxnote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
<p>Última atualização pelo desenvolvedor em: 11 de maio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Bipe |
| ID | WA200004364 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Medxnote |
| Site da empresa | [https://medxnote.com](https://medxnote.com) |
| Termos de Uso do Aplicativo | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| Funcionalidade principal do aplicativo | Aprimorar a colaboração clínica com a integração de tarefas de EPR da MedxPlanner no Microsoft Teams. |
...
| Quais dados são processados pelo seu aplicativo? | ID do locatário, perfil de usuário, marcas |
...
| URL da Política de Privacidade | https://medxnote.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | Ambas | Estamos obtendo as informações da organização do usuário | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | aplicação | Essa permissão é usada para enviar atividade ao usuário. Portanto, estamos usando isso para criar uma atividade programática no feed do usuário, para torná-lo ciente de que a tarefa é atualizada. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | aplicação | Estamos usando essa permissão para obter e criar as marcas dentro das equipes no Microsoft Teams. Para que possamos mencioná-los programaticamente. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | Delegada | Usando essa permissão, obtemos informações básicas dos usuários, como displayName, email, userPrincipalName, id e foto. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | aplicação | Usando isso, estamos buscando as propriedades totais. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | aplicação | Usando isso, estamos obtendo as equipes unidas dos usuários. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
