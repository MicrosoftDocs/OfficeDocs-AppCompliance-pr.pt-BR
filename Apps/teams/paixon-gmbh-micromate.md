---
title: Informações do aplicativo para Micromate da Paixon GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Micromate, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 27 de julho de 2022</p>

* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Paixon GmbH à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Micromate |
| ID | WA200002981 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Paixon GmbH |
| Site da empresa | [https://paixon.ch](https://paixon.ch) |
| Termos de Uso do Aplicativo | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| Funcionalidade principal do aplicativo | O Micromate empresa conhecimento de maneira eficiente, sustentável e divertida. Com o assistente de aprendizagem inovador, você dá aos seus funcionários o conjunto de habilidades certo a qualquer momento e garante resultados de trabalho perfeitos. |
| Localização da sede da empresa | Suíça |
| Página de informações do aplicativo | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
...
Essas informações foram fornecidas pela Paixon GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | email, nome, sobrenome  |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | email, nome, sobrenome  |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Suíça |
...
| URL da Política de Privacidade | https://micromate.ai/datenschutzbestimmungen/ |
