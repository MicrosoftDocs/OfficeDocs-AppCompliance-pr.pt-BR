---
title: Informações do aplicativo para do!book CB da Digital Office Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o do!book CB, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/92abac76-5f78-472f-8dfa-e7c23564cd92" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Digital Office Inc. |
| Site da empresa | [https://www.do-tools.net](https://www.do-tools.net) |
| Termos de Uso do Aplicativo | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| Funcionalidade principal do aplicativo | Torne as reuniões ainda mais convenientes com o Painel de &quot;Compartilhamento de Material&quot;! |
| Localização da sede da empresa | Japão |
| Página de informações do aplicativo | [https://www.do-tools.net](https://www.do-tools.net) |
