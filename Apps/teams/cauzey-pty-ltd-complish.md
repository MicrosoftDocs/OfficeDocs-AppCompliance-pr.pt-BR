...
description: Todas as informações de segurança e conformidade disponíveis para Complish, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e840a6b7-6a38-4404-baa5-e404eb0c98b3" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Cauzey Pty Ltd para a Microsoft:
...
| Nome da empresa parceira | Cauzey Pty Ltd |
| Site da empresa | [https://www.complish.app](https://www.complish.app) |
| Termos de Uso do Aplicativo | [https://www.complish.app/privacy-and-terms](https://www.complish.app/privacy-and-terms) |
| Funcionalidade principal do aplicativo | O Complish facilita a criação de bons hábitos remotos, tornando o trabalho visível, conectado aos objetivos e promovendo discussões focadas. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://www.complish.app](https://www.complish.app) |
