...
description: Todas as informações de segurança e conformidade disponíveis para a Totara, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5022e09d-d2f9-499f-8925-554c324ad23a" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003222" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Totara Learning à Microsoft:
...
| Nome da empresa parceira | Aprendizagem do Totara |
| Site da empresa | [https://www.totaralearning.com](https://www.totaralearning.com) |
| Termos de Uso do Aplicativo | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| Funcionalidade principal do aplicativo | O aplicativo Totara para Microsoft Teams dá aos assinantes do Totara Cloud a capacidade de acessar o aprendizado e colaborar com outras pessoas dentro Microsoft Teams. Esse aplicativo permite que os usuários acessem o aprendizado atribuído, explorando o conteúdo de aprendizagem e criar, interagir e compartilhar playlists e recursos , tudo dentro Microsoft Teams. |
| Localização da sede da empresa | Nova Zelândia |
| Página de informações do aplicativo | [https://www.totaralearning.com/products/totara-talent-exper...](https://www.totaralearning.com/products/totara-talent-experience-platform) |
...
Essas informações foram fornecidas pela Totara Learning sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Para conectar o usuário do Teams ao usuário do sistema local por meio do endereço de email | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
