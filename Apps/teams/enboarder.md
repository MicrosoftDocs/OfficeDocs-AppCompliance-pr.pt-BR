...
description: Todas as informações de segurança e conformidade disponíveis para o Enboarder, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f6b1f54a-3e72-404f-9085-1d77c4151be0" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Enboarder à Microsoft:
...
| Nome da empresa parceira | Enboarder |
| Site da empresa | [https://enboarder.com](https://enboarder.com) |
| Termos de Uso do Aplicativo | [https://enboarder.com/terms/](https://enboarder.com/terms/) |
| Funcionalidade principal do aplicativo | O Enboarder é a principal plataforma Experience-Driven integração, alterando as experiências de integração. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://enboarder.com/why-enboarder/](https://enboarder.com/why-enboarder/) |
...
Essas informações foram fornecidas pelo Enboarder sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
