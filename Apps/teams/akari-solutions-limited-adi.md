...
| Site da empresa | [https://akari.io](https://akari.io) |
| Termos de uso do aplicativo | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| Funcionalidade principal do aplicativo | A ADI está aqui para ajudá-lo com todas as suas necessidades de acessibilidade e aumentar seus programas de gerenciamento de alterações. Você pode pedir à ADI para dar respostas, conselhos e informações sobre como usar recursos de acessibilidade no Microsoft Teams, você pode aprender sobre deficiências ocultas e situaçãois e quais ferramentas e dicas podem ajudar. A ADI responderá a você com uma mistura de respostas de conversação baseadas em texto, vídeos dimensionados por byte e links conceituais de várias fontes. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://akari.io/adi](https://akari.io/adi) |
