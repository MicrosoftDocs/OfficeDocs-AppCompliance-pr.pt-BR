---
title: Informações do aplicativo para ler o navegador de reuniões da Read AI, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Navegador de Reuniões de Leitura, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65357024"
---
# <a name="read-meeting-navigator"></a>Ler Navegador de Reunião
...
|:----------------|:-------------|
| Nome do aplicativo | Ler Navegador de Reunião |
| ID | WA200003896 |
