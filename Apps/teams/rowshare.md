...
description: Todas as informações de segurança e conformidade disponíveis para RowShare, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/88508c59-07a8-42e3-985d-ff0cc4148c85" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo RowShare à Microsoft:
...
| Nome da empresa parceira | RowShare |
| Site da empresa | [https://www.rowshare.com](https://www.rowshare.com) |
| Termos de Uso do Aplicativo | [https://my.rowshare.com/termsofuse](https://my.rowshare.com/termsofuse) |
| Funcionalidade principal do aplicativo | Simplifique seus processos de administração com planilhas colaborativas, protegidas e visuais. |
| Localização da sede da empresa | França |
| Página de informações do aplicativo | [https://www.rowshare.com/features](https://www.rowshare.com/features) |
...
Essas informações foram fornecidas pelo RowShare sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
