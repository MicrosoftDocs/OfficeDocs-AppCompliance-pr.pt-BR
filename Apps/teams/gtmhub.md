...
description: Todas as informações de segurança e conformidade disponíveis para o Gtmhub, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5fdd80e2-4d58-4c5c-ac85-356c1b2a0bba" target="_blank">Exibir na loja do Teams</a>
...
| Nome da empresa parceira | Gtmhub |
| Site da empresa | [https://www.gtmhub.com](https://www.gtmhub.com) |
| Termos de Uso do Aplicativo | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| Funcionalidade principal do aplicativo | Permite exibir, compartilhar e atualizar seus OKRs sem sair do MS Teams. A exibição de OKRs, o compartilhamento deles em canais e a atualização dos principais resultados nunca foram mais rápidos. A experiência de atualização é tão perfeita quanto no Gtmhub. Na guia Gtmhub, você pode acessar o Hub, que mostra todos os SEUS OKRs e Tarefas.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://help.gtmhub.com/en/articles/3558083-how-to-view-and...](https://help.gtmhub.com/en/articles/3558083-how-to-view-and-update-okrs-from-ms-teams) |
...
| Data de certificação SOC3 mais recente | 2021-07-31 |
...
| URL da Política de Privacidade | https://help.gtmhub.com/en/articles/633973-privacy-policy |
