---
title: Informações do aplicativo para Taskworld por Taskworld
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para Taskworld, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/f8be25a9-34d4-499f-9464-d5d3792de6bf" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003441" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Taskworld à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Taskworld |
| ID | WA200003441 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Taskworld |
| Site da empresa | [https://taskworld.com](https://taskworld.com) |
| Termos de uso do aplicativo | [https://taskworld.com/terms-privacy-security/customer-terms...](https://taskworld.com/terms-privacy-security/customer-terms-of-service/) |
| Funcionalidade principal do aplicativo | Receba suas notificações taskworld no Teams e colabore com mais eficiência! |
...
Essas informações foram fornecidas pela Taskworld sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://taskworld.com/terms-privacy-security/privacy/ |
