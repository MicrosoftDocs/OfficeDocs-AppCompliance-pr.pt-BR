---
title: Informações de aplicativo para Responsum da Responsum Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Responsum, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Responsum Inc. |
...
| Quais dados são processados pelo seu aplicativo? | Eventos de Calendário do Usuário |
