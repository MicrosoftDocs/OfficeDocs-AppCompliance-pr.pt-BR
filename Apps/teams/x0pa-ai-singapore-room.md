...
description: Todas as informações de segurança e conformidade disponíveis para a SALA X0PA, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/d84ed1b7-cd38-42e7-8a07-56f7ae72e93a" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pela X0PA AI Singapore para a Microsoft:
...
| Funcionalidade principal do aplicativo | Recursos de entrevista de vídeo e análise inteligentes sob demanda com sala X0PA |
...
Essas informações foram fornecidas pela X0PA AI Singapore sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
