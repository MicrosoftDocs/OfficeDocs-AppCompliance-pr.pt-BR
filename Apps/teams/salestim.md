---
title: Informações de segurança e conformidade para SalesTim por SalesTim
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/09/2021
...
---
# <a name="salestim-application-information"></a>Informações do aplicativo SalesTim
...
* <a href="https://teams.microsoft.com/l/app/589748de-ec98-4616-9063-e91c629bd1a4" target="_blank">Exibir no Teams armazenamento</a>
...
| Funcionalidade principal do aplicativo | O SalesTim ajuda todas as organizações a melhorar seus processos colaborativos por meio Microsoft Teams criação de modelos sem código e automação de governança em escala. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.ReadWrite.All | Delegada | ID de usuários convidados para um canal por nossa política de associação | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Directory.AccessAsUser.All | Delegada | ID do usuário. Permite que um usuário selecione outros usuários em vários locais no aplicativo, como selecionar aprovadores em um fluxo de trabalho. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Group.ReadWrite.All | Ambos | Podemos&#8217;armazenar apenas grupos/IDs de equipes,&#8217;não estamos armazenando nenhum conteúdo de grupos/equipes. Permite que o aplicativo crie grupos, leia todas as propriedades e associações do grupo em nome do usuário conectado. Além disso, permite aos proprietários do grupo gerenciar seus grupos, e permite aos membros do grupo atualizar o conteúdo do grupo. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| Mail.Send | Delegada | IDs de usuário. Podemos&#8217;armazenar os metadados dessa ação, como a data de notificação, os destinatários e a ID da solicitação. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| User.Read.All | Ambos | ID de usuário e dados de perfil. Permite que um usuário selecione outros usuários em vários locais no aplicativo, como selecionar aprovadores em um fluxo de trabalho. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
>| offline_access | Delegada | Token de atualização. Permite que o aplicativo execute algumas operações e ações em segundo plano como um usuário. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](../azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635.md) |
