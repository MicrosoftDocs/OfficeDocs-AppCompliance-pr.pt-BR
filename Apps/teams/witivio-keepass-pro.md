...
| Quais dados são armazenados em seus bancos de dados? | ID de equipe e canal |
...
>| Files.ReadWrite.All | delegado | Arquivo KDBX de leitura/gravação no SharePoint |
