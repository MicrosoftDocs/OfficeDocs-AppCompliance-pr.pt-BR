...
* <a href="https://teams.microsoft.com/l/app/f6179d94-de34-4c1b-9303-519fdf048c7e" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001721" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Vibração Inc para a Microsoft:
...
Essas informações foram fornecidas pela Vibração Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Nome de exibição do cliente, endereço de email e imagem de perfil |
...
| URL da Política de Privacidade | https://vibe.us/privacy/ |
