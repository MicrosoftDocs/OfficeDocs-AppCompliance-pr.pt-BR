---
title: Informações do aplicativo para qualificado por qualificado
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/04/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Qualificado, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d9850897-f8bf-407c-878b-b0cdcbba93ff" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Qualified para a Microsoft:
...
| Nome da empresa parceira | Qualificado |
| Site da empresa | [https://www.qualified.com](https://www.qualified.com) |
...
| Funcionalidade principal do aplicativo | Qualificado alerta instantaneamente os representantes de vendas quando clientes potenciais quentes chegam ao seu site |
...
Essas informações foram fornecidas pela Qualified sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | aplicação | Permite selecionar o canal para notificar | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
>| Team.ReadBasic.All | aplicação | Nos permite encontrar todos os canais de todas as equipes, para nos permitir selecionar canais para notificar | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
