...
description: Todas as informações de segurança e conformidade disponíveis para o bot RFPIO, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/77c23de0-bcf9-4f27-91c9-135a82ee2543" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | RFPIO |
| Site da empresa | [https://www.rfpio.com](https://www.rfpio.com) |
| Termos de Uso do Aplicativo | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| Funcionalidade principal do aplicativo | RFPIO é a principal solução de gerenciamento de resposta RFP e o primeiro software RFP habilitado para IA do setor, confiável por algumas das empresas mais inteligentes do mundo para gerenciar respostas a RFPs, RFIs, Questionários de Segurança e DDQs.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? |  |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | Azure, AWS, GCP |
...
| Data de certificação SOC2 mais recente | 2021-05-17 |
...
| Listar os tipos de políticas com suporte | Restrição de IP multifator |
