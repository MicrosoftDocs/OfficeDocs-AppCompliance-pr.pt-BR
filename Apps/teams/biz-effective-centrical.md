---
title: Informações do aplicativo para centrados por Biz-Effective
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Centrical, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Biz-Effective |
| Site da empresa | [https://centrical.com](https://centrical.com) |
| Termos de Uso do Aplicativo | [https://centrical.com/terms](https://centrical.com/terms) |
| Funcionalidade principal do aplicativo | A plataforma centrada obtém e mantém os funcionários focados no trabalho que precisa ser feito e, principalmente, como fazer isso. Ele usa dados do trabalho medido para solicitar microlearning que cria proficiência. Ele utiliza a Inteligência Artificial para melhorar o envolvimento, o desempenho e a microlearning dos funcionários. A plataforma centrada está disponível por meio de um aplicativo Web, aplicativos móveis, Microsoft Teams aplicativo, aplicativos Salesforce e SuccessFactors. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
| Data de certificação SOC2 mais recente | 2020-02-03 |
