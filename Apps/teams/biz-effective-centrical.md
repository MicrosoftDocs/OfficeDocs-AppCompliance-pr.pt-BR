...
| Funcionalidade principal do aplicativo | A plataforma centralizado obtém e mantém os funcionários focados no trabalho que precisa ser feito e, o mais importante, como fazer isso. Ele usa dados do trabalho medido para solicitar o microlearning que cria a proficiência. Ele utiliza a Inteligência Artificial para melhorar o envolvimento, o desempenho e o microlearning dos funcionários. A plataforma central está disponível por meio de um aplicativo Web, aplicativos móveis, aplicativos Microsoft Teams, aplicativos Salesforce e SuccessFactors. |
