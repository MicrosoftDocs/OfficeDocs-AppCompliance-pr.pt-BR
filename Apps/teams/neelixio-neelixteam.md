---
title: Informações sobre o aplicativo para Omix.Team por Neelix.IO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Recurso Demix.Team, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | Neelix.IO |
| Site da empresa | [https://www.neelix.team](https://www.neelix.team) |
| Termos de Uso do Aplicativo | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| Funcionalidade principal do aplicativo | A plataforma Dolix gerencia o loop de comentários como um ciclo completo. Os usuários podem canalitar experiências contínuas, comentários retrospectivos e sentimentos no diário da equipe. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://www.neelix.team](https://www.neelix.team) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegada | o aplicativo usa IDs de canal e nomes para fornecer conveniência aos usuários para gerenciar suas preferências padrão ao enviar comentários do MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | Delegada | o aplicativo usa IDs e nomes de equipe para fornecer conveniência aos usuários para gerenciar suas preferências padrão ao enviar comentários do MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| email | Delegada | o email é usado como parte do registro do usuário dentro de Mailix. Após o registro inicial, o email é usado para notificações.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | Delegada | Isso é usado para obter o token de atualização | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| perfil | Delegada | O nome de usuário é usado para criar uma conta de usuário ao se registrar com o Recurso Demix.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | Delegada | O aplicativo de bot usa user.read para poder enviar informações ao usuário para que a plataforma core Domix possa identificar o usuário | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
