---
title: Informações sobre o aplicativo para o– –– – Informações sobre o aplicativo para o Microsoft Office
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Update, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/95b82c84-8994-45f6-946a-dda105f9d5df" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004148" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Microsoft Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Kami |
| ID | WA200004148 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Kami |
| Site da empresa | [https://kamiapp.com](https://kamiapp.com) |
| Termos de Uso do Aplicativo | [https://kamiapp.com/terms-of-service/](https://kamiapp.com/terms-of-service/) |
| Funcionalidade principal do aplicativo | Capacite todos a amarem o aprendizado com o &#8211; agora por Microsoft Teams. |
...
Essas informações foram fornecidas pelo Exchange sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Perfil de usuário (nome, email). OneDrive arquivos e metadados. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil do usuário (nome, email, id). OneDrive metadados do arquivo (nome do arquivo, ID do item, ID da unidade). Anotações de documento. |
...
| URL da Política de Privacidade | https://www.kamiapp.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Delegada | Para permitir que o usuário abra, atualize e exporte OneDrive e SharePoint arquivos no Update. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
>| User.Read | Delegada | Para acessar os dados de perfil do usuário para preencher o perfil Doe, por exemplo: email e nome. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
