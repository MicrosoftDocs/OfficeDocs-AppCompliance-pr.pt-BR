---
title: Informações do aplicativo para PerformYard by PerformYard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a PerformYard, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66546970"
---
# <a name="performyard"></a>PerformYard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 10 de junho de 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae947de1-da03-4e37-a420-3c5316f01e73" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004215" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela PerformYard à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | PerformYard |
| ID | WA200004215 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | PerformYard |
| Site da empresa | [https://performyard.com](https://performyard.com) |
| Termos de Uso do Aplicativo | [https://www.performyard.com/master-subscription-agreement](https://www.performyard.com/master-subscription-agreement) |
| Funcionalidade principal do aplicativo | O PerformYard facilita o gerenciamento de desempenho para todos. Flexível para RH simples &amp; para funcionários. |
...
Essas informações foram fornecidas pela PerformYard sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Informações de identificação de locatário, os nomes de todas as equipes e todos os canais neles; instalar e desinstalar eventos. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Informações de identificação de locatário, os nomes de todas as equipes e todos os canais neles. |
...
| Data de certificação SOC2 mais recente | 2022-06-01 |
...
| URL da Política de Privacidade | https://www.performyard.com/privacy |
