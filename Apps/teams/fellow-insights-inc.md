...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Calendars.ReadWrite | ambos | O colega se conecta aos calendários do usuário para fornecer a eles a capacidade de fazer anotações nos dados. | Os colegas armazenam todos os dados de evento do calendário principal do usuário. Os anexos não são armazenados. Isso é usado em Fellow para fornecer uma experiência de tomada de anotações baseada em calendário. | f6671df0-1909-428c-91f7-1c42df04d3e4 |
