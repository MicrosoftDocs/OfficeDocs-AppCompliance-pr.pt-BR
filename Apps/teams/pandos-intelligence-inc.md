---
title: Informações de aplicativo para Pandos da Pandos Intelligence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Pandos, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0e777926-2ab4-4e40-9fe5-80dc68e5044f" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003534" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Pandos Intelligence Inc para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Pandos |
| ID | WA200003534 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Pandos Intelligence Inc |
| Site da empresa | [https://pandos.io](https://pandos.io) |
| Termos de Uso do Aplicativo | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| Funcionalidade principal do aplicativo | O Pandos é uma plataforma de aprendizado e desenvolvimento de uma parada para gerentes de equipe e pessoas, líderes de projeto, treinadores e instrutores educacionais. Ele dá suporte a recursos fundamentais, como a formação de equipe com base em critérios (incluindo disponibilidade, personalidade, habilidades ou qualquer critério personalizado), gerenciamento de tarefas de equipe e avaliação de pares. A plataforma gera automaticamente um perfil para as habilidades flexíveis dos membros, verificadas por pares.  |
| Localização da sede da empresa | Canadá |
| Página de informações do aplicativo | [https://pandos.io](https://pandos.io) |
...
Essas informações foram fornecidas pela Pandos Intelligence Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
