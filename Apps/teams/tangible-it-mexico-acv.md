---
title: Informações do aplicativo para ACV da TI tangível no México
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Todas as informações de segurança e conformidade disponíveis para ACV, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela TI tangível do México para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | ACV |
| ID | WA200004237 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Tangible IT Mexico |
| Site da empresa | [https://www.tangibleit.com](https://www.tangibleit.com) |
| Termos de Uso do Aplicativo | [https://www.acv.app/terms](https://www.acv.app/terms) |
| Funcionalidade principal do aplicativo | Gerencie o controle de participação, forneça visibilidade executiva por meio de painéis e facilite a experiência de ensino por meio do uso de quadros de comunicações. Tudo em uma solução que espelha sua escola. |
| Localização da sede da empresa | México |
| Página de informações do aplicativo | [https://www.acv.app](https://www.acv.app) |
...
Essas informações foram fornecidas pela TI tangível no México sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário, dados de email do usuário para autenticação. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Nome de usuário, email do usuário, função de usuário, telefone escolar, endereço escolar, nome da escola, assuntos, classes, lições. |
...
| URL da Política de Privacidade | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Ambas | Para postar o link de colaboração do quadro de comunicações (Nosso Recurso) no canal. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | Ambas | Para postar o link de colaboração do quadro de comunicações (Nosso Recurso) no canal. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | Ambas | Os processos de autenticação são executados e os dados são obtidos no perfil dos alunos que pertencem a um grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| email | Ambas | Os processos de autenticação são executados e os dados são obtidos no perfil dos alunos que pertencem a um grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| openid | Ambas | Os processos de autenticação são executados e os dados são obtidos no perfil dos alunos que pertencem a um grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| perfil | Ambas | Os processos de autenticação são executados e os dados são obtidos no perfil dos alunos que pertencem a um grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
