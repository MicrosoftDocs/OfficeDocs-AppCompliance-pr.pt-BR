---
title: Informações do aplicativo para o SimplyDo by SimplyDo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o SimplyDo, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66248786"
---
# <a name="simplydo"></a>SimplyDo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 14 de março de 2022</p>

* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo SimplyDo à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | SimplyDo |
| ID | WA200004248 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | SimplyDo |
| Site da empresa | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| Termos de Uso do Aplicativo | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| Funcionalidade principal do aplicativo | O SimplyDo permite que as organizações capturem as ideias e insights de toda a base de funcionários, habilitando a melhoria e a inovação contínuas. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
Essas informações foram fornecidas pelo SimplyDo sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário (nome, departamento, cargo, email). |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de perfil do usuário (nome, departamento, cargo, email) |
...
| URL da Política de Privacidade | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | Para acessar dados de perfil para logon único | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| email | Delegada | Para dar suporte a recursos/logon do OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | Delegada | Para dar suporte a recursos/logon do OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | Delegada | Para dar suporte a recursos/logon do OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
