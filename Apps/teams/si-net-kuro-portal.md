---
title: Informações do aplicativo para o Portal kuro por Si-Net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Portal KURO, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
---
# <a name="kuro-portal"></a>KURO Portal
...
* <a href="https://teams.microsoft.com/l/app/c4af7af6-4fa4-4777-bab7-713cda6d0f74" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004019" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Si-Net para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | KURO Portal |
| ID | WA200004019 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Si-Net |
| Site da empresa | [https://www.si-net.it](https://www.si-net.it) |
| Termos de Uso do Aplicativo | [https://www.si-net.it/termini-di-utilizzo-kuro/](https://www.si-net.it/termini-di-utilizzo-kuro/) |
| Funcionalidade principal do aplicativo | O aplicativo PORTAL DO KURO para Teams promete ser um CRM leve, onde as pessoas podem ter em um relance todas as informações necessárias do cliente, ser usadas como uma lista telefônica para ligar diretamente de equipes com sua própria operadora de telefonia, enviar emails diretamente para as pessoas nos contatos, conversar diretamente e criar uma reunião com clientes convidados do Portal kuro,  pesquisando informações de clientes de maneira fácil e rápida, acesse diretamente a coleção de documentos&#8217;cliente selecionado e o gerenciamento de documentos compartilhados  |
...
Essas informações foram fornecidas pelo Si-Net sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | locatário e dispositivo do cliente |
...
| URL da Política de Privacidade | https://www.si-net.it/termini-di-utilizzo-kuro/ |
