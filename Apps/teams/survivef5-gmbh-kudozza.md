...
description: Todas as informações disponíveis de segurança e conformidade para kudozza, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Vista na loja Teams</a>
...
Informações fornecidas pela surviveF5 GmbH para a Microsoft:
...
| URL do site de parceiros | [https://www.kudozza.com](https://www.kudozza.com) |
| URL da página de informações do aplicativo Teams | [https://kudozza.com](https://kudozza.com) |
| URL da Política de Privacidade | [https://www.kudozza.com/privacy](https://www.kudozza.com/privacy) |
| URL de Termos de Uso | [https://www.kudozza.com/terms](https://www.kudozza.com/terms) |
...
Essas informações foram fornecidas pela surviveF5 GmbH sobre como este aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:-------------------|:--------------------------|:--------------------------|
>| AWS | userId, teamId, tenantId, nome de usuário | O serviço e o banco de dados estão hospedados na AWS.  |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Os parabéns são enviados para outras pessoas e a mensagem precisa ser ressentida com frequência. Também é fornecido um ranking que torna necessário armazenar os nomes e ids dos usuários usando o aplicativo Kudozza. | userid, nome de usuário | Os parabéns são enviados para outras pessoas e a mensagem precisa ser ressentida com frequência. Também é fornecido um ranking que torna necessário armazenar os nomes e ids dos usuários usando o aplicativo Kudozza. |
...
>inquilinoId, teamId, userId. A política de retenção é de 14 dias.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Controles organizacionais para dados armazenados por parceiro

Descrever como os administradores da organização podem controlar suas informações em sistemas de parceiros? por exemplo, exclusão, retenção, auditoria, arquivamento, política de usuário final, etc.

>Por DPA. Auditoria e ent políticas de usuários.
...
<iframe height='1020' title='Microsoft Cloud App Security informação' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36547' frameborder='no' style='width: 100%;'></iframe>
...
Essas informações foram fornecidas pela surviveF5 GmbH sobre como este aplicativo lida com autenticação, autorização, práticas recomendadas de registro de aplicativos e outros critérios de identidade.
