---
title: Informações do aplicativo do Svava para reuniões do Svava
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
Informações fornecidas pelo Svava à Microsoft:
...
| Nome da empresa de parceiro | Svava |
...
| Página de informações do aplicativo | [https://svava.io](https://svava.io) |
...
Essas informações foram fornecidas pelo Svava sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
