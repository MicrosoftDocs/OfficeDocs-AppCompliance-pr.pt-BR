---
title: Informações do aplicativo para iManage by iManage
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o iManage, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c941fa60-c3a3-4bc6-b846-a63406009c15" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo iManage para a Microsoft:
...
| Nome da empresa parceira | iManage |
| Site da empresa | [https://imanage.com](https://imanage.com) |
| Termos de Uso do Aplicativo | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| Funcionalidade principal do aplicativo | Colabore livremente enquanto o conteúdo é salvo e regido no iManage. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
| Data de certificação SOC2 mais recente | 2021-04-16 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente | 2021-04-16 |
