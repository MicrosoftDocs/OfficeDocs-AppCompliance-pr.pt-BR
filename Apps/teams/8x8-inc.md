...
| Funcionalidade principal do aplicativo | O 8x8 Voice é um serviço de roteamento direto baseado em nuvem para fazer/receber chamadas PSTN. Uma experiência nativa com telefonia de nível empresarial + recursos de central de contatos. Planos de chamada ilimitados em 47 países + serviço de Substituição PSTN em 43 países, Análise, SMS, MMS e Fax. Receba planos de chamada econômicos local ou internacionalmente e estenda a chamada PSTN para países onde a&#8217;Microsoft ainda não oferece planos, para obter o máximo de Microsoft 365. |
