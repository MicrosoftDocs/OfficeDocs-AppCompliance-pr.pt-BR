---
title: Informações de aplicativo para Bonfyre por Bonfyre, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Bonfyre, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Bonfyre, Inc para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Bonfyre |
| ID | WA200004185 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Bonfyre, Inc |
| Site da empresa | [https://bonfyreapp.com](https://bonfyreapp.com) |
| Termos de Uso do Aplicativo | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| Funcionalidade principal do aplicativo | Traga o poder dos recursos de envolvimento do Bonfyre para o canal de trabalho que seus funcionários usam todos os dias. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
Essas informações foram fornecidas pela Bonfyre, Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | O usuário enviou conteúdo e dados de perfil de usuário. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Nomes de usuário, endereços de email e imagens de perfil.  Essas informações podem ser pré-compartilhadas durante a integração do cliente, mas sincronizamos com perfis de usuário para manter as informações atualizadas.. |
...
| URL da Política de Privacidade | https://bonfyreapp.com/privacy-policy-teams |
