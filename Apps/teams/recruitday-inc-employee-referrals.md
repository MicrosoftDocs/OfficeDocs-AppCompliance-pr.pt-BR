---
title: Informações do aplicativo para indicações de funcionários da Recruitday Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: Todas as informações de segurança e conformidade disponíveis para indicações de funcionários, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c179cdf6-f93d-4aa3-9e2d-e934e5a81846" target="_blank">Exibir no Teams armazenamento</a>
...
| Site da empresa | [https://www.recruitday.com](https://www.recruitday.com) |
| Termos de Uso do Aplicativo | [https://www.recruitday.com/terms-of-use](https://www.recruitday.com/terms-of-use) |
| Funcionalidade principal do aplicativo | Consulte seus amigos para abrir trabalhos em sua empresa e acompanhar suas recompensas usando Microsoft Teams. |
| Localização da sede da empresa | Filipinas (o) |
| Página de informações do aplicativo | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
...
Essas informações foram fornecidas pela Recruitday Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Ambos | O nome e o sobrenome (do usuário do aplicativo, ou seja, funcionário) serão usados principalmente pelo usuário de RH para identificar facilmente o funcionário que encaminhou um candidato para acompanhamento de aplicativo de referência e pagamento de recompensas. Ele também será usado para lidar corretamente com o funcionário quando as notificações de email geradas pelo sistema forem enviadas. | [7414b436-87d1-4904-9d52-ff47885b89f1](../azure/7414b436-87d1-4904-9d52-ff47885b89f1.md) |
