...
description: Todas as informações de segurança e conformidade disponíveis para FloQast, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | FloQast |
| Site da empresa | [https://floqast.com](https://floqast.com) |
| Termos de Uso do Aplicativo | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| Funcionalidade principal do aplicativo | O FloQast fornece uma solução de gerenciamento próxima, bem como automação de fluxo de trabalho projetada para ajudar os contadores a realizar o fechamento do mês. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://floqast.com](https://floqast.com) |
...
| Data de certificação SOC2 mais recente | 2/28/2021 |
