---
title: Informações do aplicativo para DailyBot por DailyBot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o DailyBot, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66915646"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 27 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo DailyBot à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | DailyBot |
| ID | WA200001492 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | DailyBot |
| Site da empresa | [https://www.dailybot.com](https://www.dailybot.com) |
| Termos de Uso do Aplicativo | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| Funcionalidade principal do aplicativo | O DailyBot reduz a necessidade de reuniões automatizando standups, relatórios de status diários, retrospectivas e check-ins periódicos. Ele acompanha a motivação da equipe e promove comentários positivos com reconhecimento e reconhecimento. O DailyBot inclui recursos extras para criar atalhos/comandos e automatizar seus fluxos de trabalho de chat. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
Essas informações foram fornecidas pelo DailyBot sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Nome Email usuário, ID do locatário, ID e nome do recurso da equipe do MS, IDs do Canal de Equipe |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Usuário Email, ID de locatário, IDs e nomes de recursos da equipe do MS, IDs de canal de equipe, conteúdo das respostas do usuário coletadas pelos recursos e fluxos de trabalho do DailyBot, como: Check-Ins, Pesquisas, Formulários ou Kudos. |
...
| URL da Política de Privacidade | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegada | O DailyBot requer a leitura de informações básicas dos usuários das equipes. Isso é usado para fornecer uma boa experiência do usuário nos processos de integração e facilitar o processo de convite do membro. | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
