---
title: Informações do aplicativo para Wurqi por Wurqi
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Wurqi, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65938670"
---
# <a name="wurqi"></a>Wurqi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 11 de fevereiro de 2022</p>

* <a href="https://teams.microsoft.com/l/app/5173558d-bfb0-40dd-b75c-3cfac117ce72" target="_blank">Exibir na loja do Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004161" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Wurqi à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Wurqi |
| ID | WA200004161 |
| Clientes do Office 365 com suporte | Microsoft Teams |
| Nome da empresa parceira | Wurqi |
| Site da empresa | [https://wurqi.com](https://wurqi.com) |
| Termos de Uso do Aplicativo | [https://wurqi.com/terms/](https://wurqi.com/terms/) |
| Funcionalidade principal do aplicativo | O Wurqi é uma plataforma de gerenciamento de trabalho que integra todo o seu trabalho, projetos e comunicação. O aplicativo Teams fornece aos usuários uma página somente de exibição que exibirá todas as informações sobre o projeto no qual eles estão trabalhando, permitindo que todos os usuários da Equipe vejam como as coisas estão progredindo.  |
...
Essas informações foram fornecidas pelo Wurqi sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Autenticação Multifator (MFA) habilitada para: | DNSManagement, CodeRepositories |
...
| URL da Política de Privacidade | https://wurqi.com/privacy-policy/ |
