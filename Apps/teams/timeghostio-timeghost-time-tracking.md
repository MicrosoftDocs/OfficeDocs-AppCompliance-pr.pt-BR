---
title: Informações do aplicativo para timeghost – Controle de tempo por timeghost.io
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para timeghost - Controle de tempo, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66540820"
---
# <a name="timeghost---time-tracking"></a>timeghost - Controle de tempo
...
* <a href="https://teams.microsoft.com/l/app/e3956558-7399-4ec1-848a-c61a2aa95bc1" target="_blank">Exibir na loja do Teams</a>
...
Informações fornecidas pelo timeghost.io para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | timeghost - Controle de tempo |
| ID | WA200001532 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | timeghost.io |
| Site da empresa | [https://timeghost.io](https://timeghost.io) |
| Termos de Uso do Aplicativo | [https://timeghost.io/terms-and-conditions/](https://timeghost.io/terms-and-conditions/) |
| Funcionalidade principal do aplicativo | Timeghost é a ferramenta de controle de tempo que foi projetada especificamente para Office 365. |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://timeghost.io](https://timeghost.io) |
...
Essas informações foram fornecidas pelo timeghost.io sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário, dados de email do usuário, dados de calendário do usuário |
...
| URL da Política de Privacidade | https://timeghost.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegada | Para integrar aplicativos do Microsoft 365 ao timeghost e mostrar eventos Calendário do Outlook específicos no feed timeghost. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| People.Read | Delegada | Para integrar aplicativos do Microsoft 365 ao timeghost e mostrar, por exemplo, mostrar o avatar do usuário que está vinculado ao perfil do Microsoft 365. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.Read | Delegada | Para integrar aplicativos do Microsoft 365 ao timeghost e mostrar aos usuários, por exemplo, mostrar aos usuários que outros usuários de sua empresa também usam timeghost. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.ReadBasic.All | Delegada | Para integrar aplicativos do Microsoft 365 ao timeghost e mostrar, por exemplo, mostrar o avatar do usuário que está vinculado ao perfil do Microsoft 365. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| openid | Delegada | ID de usuário interno  | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| perfil | Delegada | Para integrar aplicativos do Microsoft 365 ao timeghost e mostrar, por exemplo, mostrar o avatar do usuário que está vinculado ao perfil do Microsoft 365. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
