---
title: Informações de aplicativo para Infor Coleman pela INFOR (EUA), INC.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/06/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Infor Coleman, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b9a120c7-9103-4e04-90b8-91c9db422a6e" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003314" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo INFOR (EUA), INC. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Infor Coleman |
| ID | WA200003314 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | INFOR (EUA), INC. |
| Site da empresa | [https://www.infor.com](https://www.infor.com) |
| Termos de Uso do Aplicativo | [https://www.infor.com/about/legal](https://www.infor.com/about/legal) |
| Funcionalidade principal do aplicativo | O Assistente Digital do Infor Coleman fornece uma interface de conversação para maximizar o potencial do trabalho humano, permitindo a extensibilidade e a acessibilidade de linguagem natural ao Infor Cloudsuites. |
...
Essas informações foram fornecidas pelo INFOR (EUA), INC. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
