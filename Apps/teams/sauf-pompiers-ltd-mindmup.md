---
title: Informações de aplicativo para MindMup por Sauf Pompiers Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Todas as informações de segurança e conformidade disponíveis para MindMup, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas por Sauf Pompiers Ltd para a Microsoft:
...
| Nome da empresa parceira | Sauf Pompiers Ltd |
| Site da empresa | [https://www.mindmup.com](https://www.mindmup.com) |
...
| Funcionalidade principal do aplicativo | O MindMup permite que os usuários visualizem facilmente ideias usando mapas  mind, diagramas de aranha, mapas de conceito, visualizações de argumento e gráficos hierárquicos. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams.ReadBasic.All | Delegada | identificadores de equipe e nomes de equipe para usuários | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | Delegada | Identificador de usuário, endereço de email a ser exibido após a autenticação | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
