...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| Sistemas de armazenamento AWS usados para manter informações básicas de perfil de usuário, para dar suporte ao compartilhamento de documentos e acesso seguro aos documentos do usuário no MindMup |  | N/D |
