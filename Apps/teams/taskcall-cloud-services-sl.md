---
title: Informações do aplicativo para TaskCall by TaskCall Cloud Services, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para TaskCall, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Exibir no Teams store</a>
...
Informações fornecidas pelo TaskCall Cloud Services, S.L. para a Microsoft:
...
| Nome da empresa de parceiro | TaskCall Cloud Services, S.L. |
...
| Funcionalidade principal do aplicativo | A integração Microsoft Teams bi-direcional do TaskCall simplifica a comunicação e IT-Ops colaboração permitindo que incidentes sejam tratados de dentro Microsoft Teams. |
...
Essas informações foram fornecidas pelo TaskCall Cloud Services, S.L. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
