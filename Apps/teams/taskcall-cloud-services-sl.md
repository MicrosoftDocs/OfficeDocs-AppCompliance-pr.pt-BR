---
title: Informações do aplicativo para TaskCall by TaskCall Serviços de Nuvem, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para TaskCall, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por TaskCall Serviços de Nuvem, S.L. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | TaskCall |
| ID | WA200003914 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | TaskCall Cloud Services, S.L. |
| Site da empresa | [https://taskcallapp.com](https://taskcallapp.com) |
| Termos de Uso do Aplicativo | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| Funcionalidade principal do aplicativo | A integração Microsoft Teams bidirecional da TaskCall simplifica a comunicação e IT-Ops colaboração, permitindo que incidentes sejam tratados de dentro Microsoft Teams. |
| Localização da sede da empresa | Espanha |
| Página de informações do aplicativo | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
Essas informações foram fornecidas pelo TaskCall Serviços de Nuvem, S.L. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
