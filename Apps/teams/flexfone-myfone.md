---
title: Informações do aplicativo para Myfone da Flexfone
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Myfone, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro STAR do CSA.
...
* <a href="https://teams.microsoft.com/l/app/5f447fa4-da1f-4651-a0da-d2488a404c19" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pelo Flexfone para a Microsoft:
...
| Nome da empresa parceira | Flexfone |
| Site da empresa | [https://flexfone.dk](https://flexfone.dk) |
| Termos de Uso do Aplicativo | [https://flexfone.dk/Content/pdf/Slutkundebetingelser.pdf](https://flexfone.dk/Content/pdf/Slutkundebetingelser.pdf) |
...
| Página de informações do aplicativo | [https://faq.flexfone.dk/da](https://faq.flexfone.dk/da) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? |  |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | SelfHosted, Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegada | Os calendários são usados para que os usuários possam mostrar seus calandares a colegas de trabalho e usar reuniões para configurar sua telefonia | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| Contacts.Read | Delegada | Os contatos dos usuários podem ser armazenados se quiserem exibi-los no aplicativo para facilitar a discagem de contatos | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | Delegada | O usuário lido neste aplicativo é usado para fins de identificação. | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | Delegada | Não armazenamos os dados. O aplicativo é simplesmente usado para fins de autenticação | [f0199b83-0ca3-4b41-a23b-d9b234484438](../azure/f0199b83-0ca3-4b41-a23b-d9b234484438.md) |
