---
title: Informações do aplicativo para o Bot de Tempo Zero do Replicon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Bot de Tempo Zero, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65269916"
---
# <a name="zero-time-bot"></a>Bot de Tempo Zero

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 8 de dezembro de 2021</p>

* <a href="https://teams.microsoft.com/l/app/4db812e1-4d29-44e4-b72e-9654c0c91ce4" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003717" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Replicon à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Bot de Tempo Zero |
| ID | WA200003717 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Replicon |
| Site da empresa | [https://www.replicon.com](https://www.replicon.com) |
| Termos de Uso do Aplicativo | [https://www.replicon.com/terms-and-conditions/](https://www.replicon.com/terms-and-conditions/) |
| Funcionalidade principal do aplicativo | O Bot de Tempo Zero permite que os usuários preencham diretamente seus quadros de horários do Replicon conversando com o Bot. |
...
Essas informações foram fornecidas pelo Replicon sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de perfil do usuário, dados de hora |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | aplicação | obter o email do usuário e mapeá-lo para o usuário no sistema do Replicon para enviar mensagens de chat por push para o aplicativo do Replicon | [4db812e1-4d29-44e4-b72e-9654c0c91ce4](../azure/4db812e1-4d29-44e4-b72e-9654c0c91ce4.md) |
