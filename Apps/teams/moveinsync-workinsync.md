---
title: Informações do aplicativo para WorkInSync por MoveInSync
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o WorkInSync, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4e00663a-be72-4de1-a163-269a477a7a6e" target="_blank">Exibir no Teams armazenamento</a>
...
| Nome da empresa parceira | MoveInSync |
...
| Funcionalidade principal do aplicativo | O WorkInSync permite que as organizações planejem &amp; facilmente executar um modelo de reserva de mesa flexível para seu escritório.  Como funcionário, você pode: - Criar e gerenciar reservas de mesa - &amp; Entrada no relógio ao trabalhar de casa no fim do dia Como gerente - Você é notificado sobre os planos de clockin/clockouts &amp; dos membros da sua equipe Na guia Atividade da Equipe que você pode instalar em um contexto de canal, você pode - &amp; Ver onde toda a equipe está trabalhando de sua presença - Pesquisar um colega específico em toda a organização |
...
| Listar os tipos de políticas com suporte | Autenticação multifator |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegada | 1. Para obter detalhes transitivos dos membros do grupo. Eles são usados na 'guia Atividade da Equipe' quando instalados no contexto do canal. 2. Para fazer logon na lista de detalhes do perfil do &amp;  usuário de usuários na organização. Eles são usados quando a guia Atividade da Equipe é instalada no contexto pessoal, como um fallback para mostrar a visualização de colegas de equipe caso a API de pessoas falhe (usuários que não são do Outlook) | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| People.Read | Delegada | Para fazer com que as pessoas mais relacionadas ao usuário conectado mostrem na guia Atividade da Equipe são instaladas no contexto pessoal. | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read | Delegada | Para obter informações de presença de uma lista de usuários na guia Atividade da Equipe no contexto pessoal e do canal | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read.All | Delegada | Para obter informações de presença de uma lista de usuários na guia Atividade da Equipe no contexto pessoal e do canal | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.Read.All | aplicação | Usado para obter informações do gerenciador de relatórios de qualquer usuário para enviar notificações de reserva e check-in/check-out para o gerente | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.ReadBasic.All | Delegada | Usado para ler a foto do perfil do funcionário | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| email | Delegada | Necessário para obter o token de SSO usando Teams cliente | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| offline_access | Delegada | Necessário para obter o token de SSO usando Teams cliente | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| openid | Delegada | Necessário para obter o token de SSO usando Teams cliente | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| perfil | Delegada | Necessário para obter o token de SSO usando Teams cliente | [foodbfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
