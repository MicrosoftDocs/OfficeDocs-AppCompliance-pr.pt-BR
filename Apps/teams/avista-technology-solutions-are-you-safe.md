---
title: Informações sobre aplicativos para Você Cofre? por soluções de tecnologia do Avista
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Exibir no Teams store</a>
...
| Funcionalidade principal do aplicativo | &quot;AreYouSafe?&quot; bot é seu assistente de gerenciamento de crise personalizado. Ideal para administradores de segurança e funcionários de RH configurar e usar durante emergências.  Você não precisa de outro software ou serviço para usar este aplicativo. Nosso bot é fácil de usar e evita ter que trocar entre Teams e aplicativos externos durante toda a crise.  Use nosso bot para saber o status de seus funcionários afetados por um incidente importante. &quot;AreYouSafe?&quot; o bot ajuda você a oferecer assistência aos que precisam, fornecendo atualizações em tempo real. |
