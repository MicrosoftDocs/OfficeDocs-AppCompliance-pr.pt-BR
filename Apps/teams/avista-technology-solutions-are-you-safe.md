---
title: Informações de aplicativo para o Are You Cofre? por soluções de tecnologia do Avista
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Are You Cofre?, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
ms.openlocfilehash: b2ce9336e7b38e5c2866145194d56408ca6121c1
ms.sourcegitcommit: 5e2cd59a54fc018a6df761b00c18e3ba592d9dba
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 04/15/2022
ms.locfileid: "64867020"
---
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelas Soluções de Tecnologia do Avista para a Microsoft:
...
| Nome da empresa parceira | Soluções Tecnológicas Avista |
| Site da empresa | [https://safetybot.in](https://safetybot.in) |
| Termos de Uso do Aplicativo | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| Funcionalidade principal do aplicativo | &quot;Você éSafe?&quot; bot é seu assistente de gerenciamento de crise personalizado. Ideal para que os administradores de segurança e a equipe de RH configurem e usem durante emergências.  Você não precisa de nenhum outro software ou serviço para usar este aplicativo. Nosso bot é fácil de usar e evita a necessidade de alternar entre Teams e aplicativos externos durante toda a crise.  Use nosso bot para saber o status de seus funcionários afetados por um incidente importante. &quot;Você éSafe?&quot; O bot ajuda você a oferecer assistência aos que precisam, fornecendo atualizações em tempo real. |
| Localização da sede da empresa | Índia |
| Página de informações do aplicativo | [https://safetybot.in](https://safetybot.in) |
...
Essas informações foram fornecidas pelas Soluções de Tecnologia do Avista sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
