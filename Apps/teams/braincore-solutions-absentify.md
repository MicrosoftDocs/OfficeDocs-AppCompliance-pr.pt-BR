---
title: Informações do aplicativo para absentify por Soluções BrainCore
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para absentify, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Exibir no Teams armazenamento</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003833" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelas Soluções BrainCore para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | absentify |
| ID | WA200003833 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa parceira | Soluções BrainCore |
| Site da empresa | [https://braincore.solutions](https://braincore.solutions) |
| Termos de Uso do Aplicativo | [https://absentify.com/terms-and-conditions](https://absentify.com/terms-and-conditions) |
| Funcionalidade principal do aplicativo | A maneira mais fácil de lidar com o tempo de folga dos funcionários , em Microsoft Teams |
| Localização da sede da empresa | Suíça |
| Página de informações do aplicativo | [https://absentify.com](https://absentify.com) |
...
Essas informações foram fornecidas pelas Soluções BrainCore sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | ID de Usuário da Microsoft, Email, DisplayName |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | ID de Usuário da Microsoft, Email, DisplayName |
...
| URL da Política de Privacidade | https://absentify.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | aplicação | Opcional. Para enviar notificações para Microsoft Teams. | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](/microsoft-365-app-certification/azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2) |
>| Calendars.ReadWrite | Delegada | Opcional: para criar automaticamente uma entrada Outlook calendário para ausências. | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](/microsoft-365-app-certification/azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c) |
>| User.Read | Delegada | Para logon | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
>| User.ReadBasic.All | Delegada | Opcional: para exibir as imagens de perfil da Microsoft dos usuários. | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
