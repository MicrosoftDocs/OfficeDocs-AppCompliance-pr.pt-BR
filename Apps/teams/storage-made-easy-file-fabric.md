---
title: Informações do aplicativo para o File Fabric Armazenamento Facilitada
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o File Fabric, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Exibir no Teams armazenamento</a>
...
Informações fornecidas pela Armazenamento Facilitada para a Microsoft:
...
| Nome da empresa parceira | Armazenamento Facilitado |
| Site da empresa | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| Termos de Uso do Aplicativo | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| Funcionalidade principal do aplicativo | Pesquise, procure, edite e compartilhe arquivos armazenados Arquivos do Azure, Armazenamento de Blobs do Azure e outros armazenamentos. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? |  |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | SelfHosted, Azure, AWS, GCP, IBMCloud, Os usuários podem se conectar com os serviços Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3-Compatible, FTP e WebDAV |
...
Essas informações foram fornecidas pelo Armazenamento Made Easy sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | aplicação | Dados de arquivo lidos ou gravados quando o usuário baixa, carrega ou edita arquivos especificados por meio do aplicativo. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | aplicação | Metadados coletados para todos os&#8217;e pastas do usuário que fornecem exibição federada em todos os serviços de arquivo. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
