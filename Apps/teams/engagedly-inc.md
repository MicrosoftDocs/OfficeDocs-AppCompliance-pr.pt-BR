---
title: Informações do aplicativo para envolvidos pela Engagedly Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/10/2021
...
description: Todas as informações de segurança e conformidade disponíveis para As políticas de tratamento de dados, as suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63552640"
---
# <a name="engagedly"></a>Engagedly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 21 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/d794bf4c-ef30-4d92-9e2e-6944e9f1512e" target="_blank">Exibir no Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003446" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Engagedly Inc à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Engagedly |
| ID | WA200003446 |
| Office 365 clientes com suporte | Microsoft Teams |
| Nome da empresa de parceiro | Engagedly Inc |
| Site da empresa | [https://engagedly.com](https://engagedly.com) |
| Termos de uso do aplicativo | [https://engagedly.com/terms/](https://engagedly.com/terms/) |
| Funcionalidade principal do aplicativo | É uma solução de gerenciamento de talentos que oferece gerenciamento contínuo de desempenho com análises de desempenho envolvendo, impulsiona o envolvimento dos funcionários com um sistema de gamificação e fornece uma série de ferramentas de planejamento de equipe e análise. |
...
Essas informações foram fornecidas pela Engagedly Inc sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://engagedly.com/privacy/ |
