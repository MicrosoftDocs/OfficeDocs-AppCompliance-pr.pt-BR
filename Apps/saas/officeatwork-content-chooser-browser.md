---
title: Visão geral do navegador officeatwork Content Chooser
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Navegador do Selador de Conteúdo, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65227235"
---
# <a name="officeatwork-content-chooser-browser-overview"></a>Visão geral do navegador officeatwork Content Chooser
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.content-chooser-browser" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Navegador do Selador de Conteúdo |
