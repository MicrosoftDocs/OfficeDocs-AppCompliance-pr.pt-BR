---
title: Informações do aplicativo para gravação de conformidade do Luware para Microsoft Teams luware AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Luware Compliance Recording para Microsoft Teams, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64881428"
---
# <a name="luware-compliance-recording-for-microsoft-teams"></a>Gravação de conformidade do Luware para Microsoft Teams
...
|:----------------|:-------------|
| Nome do aplicativo | Gravação de conformidade do Luware para Microsoft Teams |
...
| Funcionalidade principal do aplicativo | Solução de nuvem para ajudá-lo a capturar, arquivar, analisar e recuperar todos os modos de comunicação. |
...
| Quais dados são processados pelo seu aplicativo? | Informações do chamador/receptor (números de telefone, upn, duração, endereço de email &amp; , etc.), Detalhes da chamada, metadados,  |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | IDs de Objeto do Azure, UPNs, endereço de email &amp; , nome de exibição, nome, sobrenome, local (opcional), departamento(opcional) |
...
>| User.Read | Delegada | Logon Único | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
