---
title: Informações de aplicativo para MURAL por MURAL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o MURAL, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">Exibir no AppSource</a>
...
| Nome da empresa parceira | MURAL |
| Site da empresa | [https://www.mural.co](https://www.mural.co) |
| Termos de Uso do Aplicativo | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| Funcionalidade principal do aplicativo | Pensar e colaborar visualmente |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://support.mural.co](https://support.mural.co) |
...
Essas informações foram fornecidas pelo MURAL sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | O MURAL requer apenas Nome, Sobrenome e Endereço de Email para fins de logon. O tipo de dados a ser processado/armazenado dependeria do cliente. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | O MURAL armazena apenas o nome, sobrenome e email do usuário para fins de logon. Qualquer outra informação armazenada depende das informações que os clientes armazenam em seus mural. |
...
| Data de certificação SOC2 mais recente | 2021-04-01 |
| O aplicativo está em conformidade com os Controles da Organização do Serviço (SOC 3)? | Sim |
| Data de certificação SOC3 mais recente | 2021-04-01 |
...
| URL da Política de Privacidade | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Delegada | Files.read necessário para carregar documentos no MURAL. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | Delegada | User.read porque o mural precisa de nome, sobrenome e email para a criação da conta. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
