---
title: Informações do aplicativo para MIPA – Meu Assistente Pessoal Inteligente do iGlobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/16/2021
...
description: Todas as informações de segurança e conformidade disponíveis para MIPA – Meu Assistente Pessoal Inteligente, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 3 de julho de 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/17859280.mipa" target="_blank">Exibir no AppSource</a>
