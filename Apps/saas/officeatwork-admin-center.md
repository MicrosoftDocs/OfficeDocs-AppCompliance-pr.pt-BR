---
title: Informações do aplicativo para o Centro de Administração por officeatwork
ms.author: elmalova
author: elenamalova
ms.date: 01/25/2022
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para o Centro de Administração, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "62255829"
---
# <a name="admin-center"></a>Centro de Administração
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork.admin-center" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Centro de Administração |
...
| Funcionalidade principal do aplicativo | Gerencie e configure todos os aplicativos do officeatwork e Add-Ins em um local central. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | delegado | Habilitando a exibição do status de consentimento | [8cf0fbc9-28f7-4bfb-94db-237b049fcbf7](https://docs.microsoft.com/microsoft-365-app-certification/azure/8cf0fbc9-28f7-4bfb-94db-237b049fcbf7) |
>| Group.Read.All | delegado | Habilitando a restrição da audiência de bibliotecas | [8cf0fbc9-28f7-4bfb-94db-237b049fcbf7](https://docs.microsoft.com/microsoft-365-app-certification/azure/8cf0fbc9-28f7-4bfb-94db-237b049fcbf7) |
>| Sites.Read.All | delegado | Habilita a verificação da criação da biblioteca | [8cf0fbc9-28f7-4bfb-94db-237b049fcbf7](https://docs.microsoft.com/microsoft-365-app-certification/azure/8cf0fbc9-28f7-4bfb-94db-237b049fcbf7) |
...
>| User.ReadBasic.All | delegado | Habilitando a exibição de propriedades do usuário | [8cf0fbc9-28f7-4bfb-94db-237b049fcbf7](https://docs.microsoft.com/microsoft-365-app-certification/azure/8cf0fbc9-28f7-4bfb-94db-237b049fcbf7) |
