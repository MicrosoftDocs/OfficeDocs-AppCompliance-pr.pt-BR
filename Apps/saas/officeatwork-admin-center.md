...
>| Sites.Read.All | delegado | Habilita a verificação da criação da biblioteca |
>| Directory.Read.All | delegado | Habilitando a exibição do status de consentimento |
>| Group.Read.All | delegado | Habilitando a restrição da audiência de bibliotecas |
>| User.ReadBasic.All | delegado | Habilitando a exibição de propriedades do usuário |
