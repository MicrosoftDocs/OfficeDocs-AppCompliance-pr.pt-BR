...
* <a href="https://appsource.microsoft.com/product/web-apps/wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por Ideias Amplas/Idea2Innovation para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Ideias amplas - Software de Inovação |
...
Essas informações foram fornecidas por Ideias Amplas/Idea2Innovation sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Nome de usuário e endereço de email |
| Se a estrutura subjacente processa ou armazena dados de clientes da Microsoft, onde esses dados são armazenados geograficamente? | Suécia |
...
| URL da Política de Privacidade | https://getwideideas.com/privacy-policy/ |
