---
title: Informações do aplicativo para a gravação e a análise de conformidade do CallCabinet Atmos da CallCabinet Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o CallCabinet Atmos Compliance Recording and Analytics, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66704000"
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>Análise e gravação de conformidade de Atmos do CallCabinet
...
* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela CallCabinet Corporation à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Análise e gravação de conformidade de Atmos do CallCabinet |
| ID | callcabinetcorporation1584393576335.atmos |
| Nome da empresa parceira | CallCabinet Corporation |
| Site da empresa | [https://www.callcabinet.com](https://www.callcabinet.com) |
...
| Funcionalidade principal do aplicativo | Atmos by CallCabinet é uma solução de SaaS de conformidade, análise de IA e saaS de conformidade nativa do Azure para o Microsoft Teams e outros sistemas de colaboração ou contact center. |
...
Essas informações foram fornecidas pela CallCabinet Corporation sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Conversas gravadas do Teams, vídeo e compartilhamento de tela |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Conversas gravadas do Teams, vídeo e compartilhamento de tela |
