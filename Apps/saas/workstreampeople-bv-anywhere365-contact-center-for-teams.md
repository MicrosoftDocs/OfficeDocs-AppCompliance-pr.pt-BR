---
title: Informações do aplicativo para o Centro de Contatos do Anywhere365 para Teams por WORKSTREAMPEOPLE BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Centro de Contatos do Anywhere365 para Teams, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66703599"
---
# <a name="anywhere365-contact-center-for-teams"></a>Central de Contatos do Anywhere365 para Teams

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Última atualização pelo desenvolvedor em: 7 de abril de 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.anywhere365contactcenterforteams" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo WORKSTREAMPEOPLE BV para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Central de Contatos do Anywhere365 para Teams |
| ID | workstreampeople.anywhere365contactcenterforteams |
| Nome da empresa parceira | WORKSTREAMPEOPLE BV |
| Site da empresa | [https://anywhere365.io](https://anywhere365.io) |
| Termos de Uso do Aplicativo | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| Funcionalidade principal do aplicativo | Anywhere365&#174; Dialogue Cloud platform for Omnichannel Communications, o primeiro centro de contatos certificado pela Microsoft para o Teams, totalmente integrado ao Microsoft eocystem: do Azure, do Sharepoint e do Teams para o Dynamics 365, PowerApps e PowerBI. Com a atribuição de nossa plataforma de automação de comunicação de baixo código Dialog Studio, podemos nos integrar a qualquer estrutura de bot baseada em API, camadas de comunicação e sistemas de inteligência. |
| Localização da sede da empresa | Países Baixos (o) |
| Página de informações do aplicativo | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
...
Essas informações foram fornecidas pelo WORKSTREAMPEOPLE BV sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de &amp; presença de comunicações |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados de &amp; presença de comunicações |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Países Baixos (o), Estados Unidos da América, Singapura |
...
| URL da Política de Privacidade | https://anywhere365.io/wp-content/uploads/2021/07/Anywhere365-Privacy-Policy-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegada | Coletar domínios do cliente | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| Presence.Read.All | Delegada | Coletar detalhes de presença do cliente. | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| User.ReadBasic.All | Delegada | Coletar nomes de exibição do cliente | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
