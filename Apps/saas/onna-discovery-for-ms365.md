...
<p>Última atualização pelo desenvolvedor em: 2 de novembro de 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/onna1600902517721.onna-discovery-1" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Onna à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Descoberta onna para MS365 |
| ID | onna1600902517721.onna-discovery-1 |
| Nome da empresa de parceiro | Onna |
| Site da empresa | [https://onna.com](https://onna.com) |
...
Essas informações foram fornecidas pelo Onna sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Emails, endereços de email, IDs de usuário, chats, arquivos. As políticas de retenção e remoção são configuráveis pelo usuário final.  |
...
| Data de certificação SOC2 mais recente |  2019-06-01 |
...
| URL da Política de Privacidade | https://onna.com/privacy-policy/ |
