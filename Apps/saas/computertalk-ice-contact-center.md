...
| Quais dados são processados pelo seu aplicativo? | AzureADGuid (vinculação de conta).  Email endereço e número de telefone podem ser importados do AAD. |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | AzureADGuid (vinculação de conta).  Email endereço e número de telefone podem ser importados do AAD. |
