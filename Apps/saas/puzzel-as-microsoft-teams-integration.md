---
title: Informações do aplicativo para integração do Puzzel Microsoft Teams pelo Puzzel AS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Puzzel Microsoft Teams Integration, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66704180"
---
# <a name="puzzel-microsoft-teams-integration"></a>Integração do Puzzel Microsoft Teams
...
* <a href="https://appsource.microsoft.com/product/web-apps/puzzel-5257631.puzzel_teams_integration" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Puzzel AS para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Integração do Puzzel Microsoft Teams |
| ID | puzzel-5257631.puzzel_teams_integration |
| Nome da empresa parceira | Puzzel AS |
| Site da empresa | [https://www.puzzel.com](https://www.puzzel.com) |
| Termos de Uso do Aplicativo | [https://www.puzzel.com/neighbourhood/trust-centre/privacy-p...](https://www.puzzel.com/neighbourhood/trust-centre/privacy-policy) |
| Funcionalidade principal do aplicativo | A integração do Puzzel com o Microsoft Teams aproxima seus agentes e facilita a colaboração. Os agentes podem fazer chamadas do Teams, enviar mensagens, pesquisar e transferir contatos sem precisar sair do Aplicativo do Agente puzzel. Os usuários podem ver se outros agentes estão online, ocupados, ausentes ou em chamadas, bem como os status de presença de todos os outros colegas em sua organização. Os agentes podem exibir contatos&#8217; calendários e agendas no Teams para alinhar melhor os planos, reuniões e chamadas. |
| Localização da sede da empresa | Noruega |
| Página de informações do aplicativo | [https://www.puzzel.com/microsoft-teams](https://www.puzzel.com/microsoft-teams) |
...
Essas informações foram fornecidas pelo Puzzel AS sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de presença, dados do usuário, dados de calendário |
| O aplicativo dá suporte ao TLS 1.1 ou superior? | Sim |
| O aplicativo ou a infraestrutura subjacente armazena dados do cliente da Microsoft? | Sim |
| Quais dados são armazenados em seus bancos de dados? | Dados do Usuário, Dados de Calendário |
| Se a infastructure subjacente processa ou armazena dados do cliente da Microsoft, onde esses dados são armazenados geograficamente? | Noruega, Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
...
| URL da Política de Privacidade | https://www.puzzel.com/neighbourhood/trust-centre |
