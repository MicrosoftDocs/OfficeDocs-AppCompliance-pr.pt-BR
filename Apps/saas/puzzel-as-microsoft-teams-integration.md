---
title: Informações do aplicativo para o Puzzel Microsoft Teams integração por Puzzel AS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/09/2022
...
ms.locfileid: "65982588"
---
# <a name="puzzel-microsoft-teams-integration"></a>Integração de Microsoft Teams Puzzel
...
|:----------------|:-------------|
| Nome do aplicativo | Integração de Microsoft Teams Puzzel |
...
| Funcionalidade principal do aplicativo | A integração do Puzzel com o Microsoft Teams aproxima seus agentes e facilita a colaboração. Os agentes podem fazer Teams, enviar mensagens, pesquisar e transferir contatos sem precisar sair do Aplicativo do Agente Puzzel. Os usuários podem ver se outros agentes estão online, ocupados, ausentes ou em chamadas, bem como os status de presença de todos os outros colegas em sua organização. Os agentes podem exibir contatos&#8217; calendários e agendas no Teams para alinhar melhor os planos, reuniões e chamadas. |
