---
title: Informações do aplicativo para a integração do Teams do Storm Cloud Contact Center pelo Content Guru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Integração do Teams do Storm Cloud Contact Center, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66702689"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>Integração do Teams do Storm Cloud Contact Center
...
* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Content Guru à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Integração do Teams do Storm Cloud Contact Center |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Nome da empresa parceira | Guru do Conteúdo |
| Site da empresa | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| Termos de Uso do Aplicativo | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| Funcionalidade principal do aplicativo | Integre o Storm Cloud Contact Center ao Microsoft Teams para uma solução CCaaS unificada. |
...
Essas informações foram fornecidas pelo Content Guru sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | REFERÊNCIA DE Usuário dos EUA (EUII), Referência da Organização do MS (OII), Detalhes da chamada e Dados de Perfil do Usuário (EUII) |
...
| Data de certificação SOC2 mais recente | 2020-12-31 |
...
| URL da Política de Privacidade | https://www.contentguru.com/about-us/privacy-cookies-policy/ |
