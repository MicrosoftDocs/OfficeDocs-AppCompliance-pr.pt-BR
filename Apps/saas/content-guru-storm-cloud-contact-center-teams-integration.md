---
title: Informações do aplicativo para o Cloud Contact Center Teams Integração por Guru de Conteúdo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
Informações fornecidas pelo Guru do Conteúdo para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Storm Cloud Contact Center Teams Integration |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Nome da empresa de parceiro | Guru do Conteúdo |
...
| Funcionalidade principal do aplicativo | Integrar o Cloud Contact Center com Microsoft Teams para uma solução CCaaS unificada. |
...
Essas informações foram fornecidas pelo Guru do Conteúdo sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
