---
title: Informações do aplicativo para a conformidade de gravação do &amp; lago Theta Teams vídeo pelo Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Theta Lake Recording &amp; Compliance for Teams Video, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no Registro STAR do CSA.
...
| Nome da empresa de parceiro | Theta Lake |
...
| Funcionalidade principal do aplicativo | Gravação, arquivamento, conformidade e mitigação de riscos para reuniões Microsoft Teams áudio e vídeo |
...
| Quais dados são armazenados em seus bancos de dados? | Microsoft Video, Microsoft Teams Chat |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | delegado | Graph API precisa ser acesso para receber registro de chamada | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
