---
title: OneNote informações do aplicativo para o officeatwork | Se escolha de imagem para Office por officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: OneNote foi revisado pela Microsoft em relação aos padrões e controles do setor para práticas de segurança, conformidade e tratamento de dados. Todas as informações de segurança e conformidade disponíveis para o officeatwork | O Selador de Imagem para Office, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64784330"
---
# <a name="onenote--officeatwork--image-chooser-for-office"></a>OneNote | trabalho de escritório | Se escolha de imagem para Office
