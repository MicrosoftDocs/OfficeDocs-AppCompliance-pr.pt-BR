...
description: Todas as informações de segurança e conformidade disponíveis para Assinaturas de Impressão, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
| Nome da empresa parceira | Assinaturas de Impressão |
...
| Funcionalidade principal do aplicativo | As Assinaturas de Impressão fornecem assinaturas compatíveis com eSignatures ECT Act e entrega segura de documentos. Gerenciar o fluxo de trabalho de assinatura e retornar uma cadeia de custódia segura acrescentada ao documento assinado.  |
...
Essas informações foram fornecidas pelas Assinaturas de Impressão sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | Ambos | Dados de autenticação e dados de diretório. | [be181d9c-9060-40a0-a692-b29f2e314d16](../azure/be181d9c-9060-40a0-a692-b29f2e314d16.md) |
