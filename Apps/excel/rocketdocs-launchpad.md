---
title: Informações do aplicativo para o LaunchPad do RocketDocs pelo RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o LaunchPad do RocketDocs, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo RocketDocs para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | RocketDocs LaunchPad |
| ID | WA200003648 |
| Office 365 clientes com suporte | Excel 2016 ou posterior no Mac, Excel 2016 ou posterior no Windows, Excel na Web, Word 2016 ou posterior no Mac, Word na Web, Word 2016 ou posterior no Windows |
| Nome da empresa de parceiro | RocketDocs |
| Site da empresa | [https://rocketdocs.com](https://rocketdocs.com) |
| Termos de uso do aplicativo | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| Funcionalidade principal do aplicativo | Permite que os usuários localizem o conteúdo na plataforma RocketDocs e o insiram em um documento. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
Essas informações foram fornecidas pelo RocketDocs sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
