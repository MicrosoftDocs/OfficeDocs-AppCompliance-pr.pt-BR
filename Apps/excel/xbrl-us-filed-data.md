---
title: Informações do aplicativo para dados arquivados XBRL por XBRL US
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Todas as informações de segurança e conformidade disponíveis para dados arquivados XBRL, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
Informações fornecidas pelo XBRL US para a Microsoft:
...
| Nome da empresa parceira | XBRL US |
| Site da empresa | [https://xbrl.us](https://xbrl.us) |
| Termos de Uso do Aplicativo | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| Funcionalidade principal do aplicativo | A XBRL US é o consórcio sem fins lucrativos que está criando e dando suporte a padrões de relatório de negócios gratuitos, abertos e não apropriados nos EUA XBRL dos EUA tem conduzido o desenvolvimento e a implementação de padrões de dados para agências governamentais - a Sec (Comissão de Títulos e Exchange), a Comissão Federal de Regulação de Energia (FERC) e o Departamento de Energia. A XBRL US monitora dados e ajuda a criar padrões de qualidade de dados usados pela SEC para ajudar as empresas públicas a criar demonstrações financeiras XBRL de boa qualidade.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? |  |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | GitHub |
