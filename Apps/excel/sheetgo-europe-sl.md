...
| Quais dados são armazenados em seus bancos de dados? | Metadados de planilha, como tamanho de arquivo, proprietário de planilha, usuários de planilha, data da última modificação, nome do arquivo, etc. NÃO ARMAZENAMOS DADOS DE PLANILHA |
