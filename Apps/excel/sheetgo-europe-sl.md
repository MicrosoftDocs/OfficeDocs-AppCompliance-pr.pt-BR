---
title: Informações do aplicativo SHEETGO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
<p>Última atualização pelo desenvolvedor em: 1º de novembro de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002128" target="_blank">Exibir no AppSource</a>
...
| Site da empresa | [https://www.sheetgo.com](https://www.sheetgo.com) |
| Termos de Uso do Aplicativo | [https://www.sheetgo.com/legal/terms/](https://www.sheetgo.com/legal/terms/) |
| Funcionalidade principal do aplicativo | O Sheetgo é uma plataforma de automação de fluxo de trabalho que permite que os usuários conectem planilhas online e criem sistemas automatizados de gerenciamento de dados. O aplicativo Web Sheetgo fornece uma plataforma para criar e gerenciar fluxos de trabalho, juntamente com uma variedade de modelos. O suplemento Sheetgo para Excel e complemento para Google Sheets permite que os usuários se conectem e automatizem diretamente dentro de uma planilha, e o aplicativo Teams permite que os criadores de fluxo de trabalho compartilhem seus arquivos conectados com colegas em canais e chats em grupo. |
...
| Quais dados são armazenados em seus bancos de dados? | Metadados de planilha, como tamanho do arquivo, proprietário da planilha, usuários da planilha, data da última modificação, nome do arquivo etc. NÃO ARMAZENAMOS DADOS DE PLANILHA |
...
| URL da Política de Privacidade | https://www.sheetgo.com/legal/privacy |
