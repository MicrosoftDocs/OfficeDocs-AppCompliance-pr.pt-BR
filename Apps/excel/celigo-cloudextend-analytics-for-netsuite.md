...
description: Todas as informações de segurança e conformidade disponíveis para o CloudExtend Analytics para NetSuite, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 7 de junho de 2022</p>
...
| Site da empresa | [https://www.cloudextend.io](https://www.cloudextend.io) |
| Termos de Uso do Aplicativo | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| Funcionalidade principal do aplicativo | Para usuários do NetSuite, o CLOUDExtend Analytics for NetSuite (CEAN) visualizará seus dados para fornecer todos os insights necessários para tomar a decisão de negócios certa no momento certo. O CEAN é uma ferramenta que fornece todas as ferramentas necessárias, fornecendo flexibilidade para personalizar e controlar seus dados para obter insights sobre seus dados netSuite. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.cloudextend.io/netsuite/excel-integration/p/ana...](https://www.cloudextend.io/netsuite/excel-integration/p/analytics-for-netsuite/) |
...
Essas informações foram fornecidas pelo Celigo CloudExtend sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Os dados comerciais do usuário que eles optaram por processar por meio de nosso aplicativo. |
...
| Data de certificação SOC1 mais recente | 2022-03-24 |
...
| URL da Política de Privacidade | https://www.cloudextend.io/privacy/ |
...
| Se seu aplicativo não usar uma das bibliotecas acima, qual biblioteca ou biblioteca de autenticação ele usa? | Fluxo de código de autorização do OAuth 2.0 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | aplicação | para atualizar periodicamente as pastas de trabalho do Excel com os dados mais recentes | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Sites.ReadWrite.All | aplicação | para obter as informações sobre os trabalhos do Excel nos quais o usuário está trabalhando se estiver no local do SharePoint | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| offline_access | Delegada | para poder gravar no Excel quando o cliente não estiver conectado. Isso é necessário, pois temos tarefas agendadas que gravam dados em tabelas do Excel | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
