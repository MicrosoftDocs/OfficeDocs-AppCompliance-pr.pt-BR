---
title: Excel informações do aplicativo para o officeatwork | Se escolha de imagem para Office por officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Excel foi revisado pela Microsoft em relação aos padrões e controles do setor para práticas de segurança, conformidade e tratamento de dados. Esta página exibe as informações de segurança e conformidade disponíveis para o officeatwork | O Selador de Imagem para Office, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
---
# <a name="excel-information-for-officeatwork--image-chooser-for-office"></a>Excel informações sobre o officeatwork | Se escolha de imagem para Office
...
| Funcionalidade principal do aplicativo | Banco de Imagens para M365 \| Acesse suas imagens compartilhadas centralmente no Word, Excel, PowerPoint e outros aplicativos |
