---
title: Informações do aplicativo para o suplemento AuditBoard da Auditboard, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
Informações fornecidas pela Auditboard, Inc. para a Microsoft:
...
| Funcionalidade principal do aplicativo | Permite que os assinantes do AuditBoard insiram dados de links &amp; para o site AB durante a edição de Narrativas AB.  |
...
Essas informações foram fornecidas pela Auditboard, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
