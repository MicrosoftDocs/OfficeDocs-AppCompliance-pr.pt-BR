...
description: Todas as informações de segurança e conformidade disponíveis para o Jira Cloud para Excel, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64881108"
---
# <a name="jira-cloud-for-excel"></a>Jira Cloud para Excel
...
|:----------------|:-------------|
| Nome do aplicativo | Jira Cloud para Excel |
| ID | WA200000556 |
