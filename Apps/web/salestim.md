...
>| Directory.AccessAsUser.All | delegado | Podemos&#8217;armazenar apenas algumas IDs de usuários, não dados de perfil. | Permite que um usuário selecione outros usuários em vários locais no aplicativo, como selecionar aprovadores em um fluxo de trabalho. | 2a651f59-97ce-42bb-97d7-cf7a2af4b635 |
>| Group.ReadWrite.All | delegado | &#8217;estamos apenas armazenar IDs de grupos/equipes,&#8217;não estamos armazenar conteúdo de grupos/equipes. | Permite que o aplicativo crie grupos, leia todas as propriedades e associações de grupo em nome do usuário associado. Além disso, permite aos proprietários do grupo gerenciar seus grupos, e permite aos membros do grupo atualizar o conteúdo do grupo. | 2a651f59-97ce-42bb-97d7-cf7a2af4b635 |
...
>Todos os dados coletados são descritos aqui: https://developers.salestim.com/platform/datamanagement.html#application-data conforme descrito, os logs são temporariamente armazenados por 15 dias e excluídos automaticamente.
...
As implantações em ambientes de produção são automatizadas por meio de uma filial protegida dedicada em nosso ambiente GitHub, onde apenas duas pessoas podem aprovar alterações.
