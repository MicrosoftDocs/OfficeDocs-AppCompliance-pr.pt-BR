---
title: Informações do aplicativo para Verificador
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para o Verificador, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "65225282"
---
# <a name="application-information-for-verifier-by-officeatwork"></a>Informações do aplicativo para o Verificador por officeatwork
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.Read | Delegada | Nenhum dado é armazenado. | OneDrive: para poder ler os arquivos do usuário conectado | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Files.Read.All | Delegada | Nenhum dado é armazenado. | Teams: para ler todos os arquivos aos qual o usuário conectado tem acesso. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Sites.Read.All | Delegada | Nenhum dado é armazenado. | SharePoint Online: para habilitar a leitura de dados do SharePoint Online, o usuário conectado tem acesso. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| User.Read | Delegada | Nenhum dado é armazenado. | Entrar: para permitir que o aplicativo officeatwork leia as propriedades básicas do usuário. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| offline_access | Delegada | Nenhum dado é armazenado. | Entrada: para habilitar a entrada automática por meio de tokens de atualização, como sem, os usuários precisariam entrar manualmente sempre que iniciam o aplicativo officeatwork. Esse escopo só é necessário para aplicativos host não habilitados para SSO. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| openid | Delegada | Nenhum dado é armazenado. | Sing-In: para permitir que os usuários se conectem ao aplicativo officeatwork com sua conta organizacional e/ou Microsoft. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| perfil | Delegada | Nenhum dado é armazenado. | Sing-In: para mostrar o usuário conectado no aplicativo officeatwork. Isso ajuda a garantir/confirmar ao usuário qual conta foi usada para entrar no aplicativo officeatwork. | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
...
<iframe height='1020' title='Microsoft Cloud App Security informações' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755' frameborder='no'></iframe>
