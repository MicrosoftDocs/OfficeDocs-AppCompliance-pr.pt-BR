---
title: Informações do aplicativo para Konnect eMail Parser da Konnect eMail
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Konnect eMail Parser, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
<p>Última atualização pelo desenvolvedor em: 1º de fevereiro de 2022</p>
...
Informações fornecidas pela Konnect eMail para a Microsoft:
...
| Site da empresa | [https://www.konnectemail.com](https://www.konnectemail.com) |
| Termos de Uso do Aplicativo | [https://www.konnectemail.com/eula](https://www.konnectemail.com/eula) |
| Funcionalidade principal do aplicativo | Capturar automaticamente atributos de email como metadados. |
| Localização da sede da empresa | Austrália |
| Página de informações do aplicativo | [https://www.konnectemail.com/sharepoint-email-management](https://www.konnectemail.com/sharepoint-email-management) |
...
Essas informações foram fornecidas pela Konnect eMail sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.

| **Information** | **Resposta** |
|:----------------|:-------------|
| O aplicativo ou a infraestrutura subjacente processa dados relacionados a um cliente da Microsoft ou seu dispositivo? | Sim |
| Quais dados são processados pelo seu aplicativo? | Dados de Email do Usuário |
