---
title: Informações do aplicativo para o Painel de Tarefas Agile SharePoint Online pela Agile-IS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Painel de Tarefas Agile para SharePoint Online, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64753871"
---
# <a name="agile-task-board-for-sharepoint-online"></a>Painel de Tarefas Agile para SharePoint Online
...
|:----------------|:-------------|
| Nome do aplicativo | Painel de Tarefas Agile para SharePoint Online |
| ID | WA200002087 |
