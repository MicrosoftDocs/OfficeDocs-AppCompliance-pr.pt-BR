---
title: Informações do aplicativo para SharePoint|sapiens Gerenciamento de Treinamento de Funcionários pelo SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Gerenciamento de Treinamento de Funcionários SharePoint|sapiens, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "63778396"
---
# <a name="sharepointsapiens-employee-training-management"></a>SharePoint| gerenciamento de treinamento de funcionários SharePoint|sapiens

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 22 de março de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380833" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo SharePointSapiens à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | SharePoint-sapiens Gerenciamento de Treinamento de Funcionários |
| ID | WA104380833 |
| Office 365 clientes com suporte | SharePoint 2016 ou posterior |
| Nome da empresa de parceiro | SharePointSapiens |
| Site da empresa | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
...
| Funcionalidade principal do aplicativo | O complemento Gerenciamento de Treinamento de Funcionários facilita a organização e a administração do desenvolvimento profissional contínuo dos funcionários para todos. Desde a configuração e o agendamento de eventos de treinamento, o gerenciamento de alunos e suas atribuições e inscrições, até o acompanhamento de conquistas e comentários, tudo é abordado. O complemento ajuda você a cumprir seus regulamentos de conformidade e políticas de segurança. Ele permite atribuir treinamento necessário, acompanhar conquistas, gerenciar expirações e muito mais. |
| Localização da sede da empresa | Áustria |
| Página de informações do aplicativo | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/) |
...
Essas informações foram fornecidas pelo SharePointSapiens sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://addins.sharepointsapiens.com/licensing/data-processing-agreement.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | delegado | Ler informações básicas do usuário para habilitar Exchange reserva de sala | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
