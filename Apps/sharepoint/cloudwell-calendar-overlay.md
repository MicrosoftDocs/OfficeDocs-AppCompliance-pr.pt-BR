...
description: Todas as informações de segurança e conformidade disponíveis para a Sobreposição de Calendário, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
| Quais dados são processados pelo seu aplicativo? | Endereço de email do usuário, ID do locatário do usuário |
