---
title: Informações do aplicativo para sobreposição de calendário pela Cloudwell
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/06/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Sobreposição de Calendário, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
Informações fornecidas pelo Cloudwell à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Sobreposição de Calendário |
| ID | WA200003806 |
| Clientes do Office 365 com suporte | SharePoint 2016 ou posterior |
| Nome da empresa parceira | Cloudwell |
| Site da empresa | [https://cloudwell.io](https://cloudwell.io) |
...
| Funcionalidade principal do aplicativo | A Web Part sobreposição de Calendário permite que você exiba todos os seus eventos do Microsoft SharePoint, Planner e Exchange em um só lugar! |
...
Essas informações foram fornecidas pelo Cloudwell sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
