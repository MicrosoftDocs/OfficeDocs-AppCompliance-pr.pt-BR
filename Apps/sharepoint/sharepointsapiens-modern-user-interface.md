---
title: Informações do aplicativo SharePoint| interface de usuário moderna do SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para a Interface do Usuário Moderna SharePoint|sapiens, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no Registro STAR do CSA.
...
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint| interface de usuário moderna do SharePoint|sapiens
...
* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | SharePoint-sapiens interface de usuário moderna |
| ID | WA200003529 |
...
| Funcionalidade principal do aplicativo | Esse aplicativo precisa ser usado em conjunto com nosso SharePoint|aplicativo de Gerenciamento de Eventos (WA104380834) ou SharePoint|aplicativo de Gerenciamento de Treinamento de Funcionários (WA104380833).  Este aplicativo fornece uma interface de usuário intuitiva que permite que você crie e gerencie eventos, tópicos, cursos e currículos no SharePoint, inscreva os usuários ou permita que eles se inscrevam e acompanhem todos os participantes, atribuições e conquistas. |
