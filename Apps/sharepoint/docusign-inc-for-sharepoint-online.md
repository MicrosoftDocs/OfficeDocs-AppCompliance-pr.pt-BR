---
title: Informações de aplicativo para DocuSign para SharePoint Online da DocuSign, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/24/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o DocuSign para SharePoint Online, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104218069" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | DocuSign para SharePoint Online |
| ID | WA104218069 |
...
| Funcionalidade principal do aplicativo | Assinar ou solicitar assinaturas para documentos SharePoint. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.docusign.com/solutions/microsoft/sharepoint-onl...](https://www.docusign.com/solutions/microsoft/sharepoint-online) |
