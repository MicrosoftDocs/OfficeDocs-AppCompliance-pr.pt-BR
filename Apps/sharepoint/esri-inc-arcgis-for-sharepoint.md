---
title: Informações de aplicativo para ArcGIS para SharePoint da Esri, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/04/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o ArcGIS para SharePoint, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
| Nome da empresa parceira | Esri, Inc. |
