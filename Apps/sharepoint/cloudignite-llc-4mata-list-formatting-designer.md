---
title: Informações do aplicativo para 4Mata – Designer de Formatação de Lista da CLOUDIGNITE LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o 4Mata – Designer de Formatação de Lista, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro STAR do CSA.
...
ms.locfileid: "66112983"
---
# <a name="4mata---list-formatting-designer"></a>4Mata – Designer de Formatação de Lista
...
* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo CLOUDIGNITE LLC para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | 4Mata – Designer de Formatação de Lista |
| ID | WA200002892 |
| Office 365 clientes com suporte | SharePoint 2016 ou posterior |
| Nome da empresa parceira | CLOUDIGNITE LLC |
| Site da empresa | [https://4mata.com](https://4mata.com) |
| Termos de Uso do Aplicativo | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| Funcionalidade principal do aplicativo | O 4Mata da CloudIgnite é um conjunto de ferramentas que capacitam as empresas a visualizar dados criando e formatando SharePoint listas e formulários.  Com esse aplicativo, os usuários podem configurar intuitivamente formulários e listas de SharePoint altamente personalizados para relatórios, faturas, publicação de detalhes do produto e coleta de informações de contato para integrar-se convenientemente aos seus requisitos de processo empresarial.  |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://4mata.com](https://4mata.com) |
...
Essas informações foram fornecidas pelo CLOUDIGNITE LLC sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
