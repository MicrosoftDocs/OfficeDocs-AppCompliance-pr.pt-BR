---
title: Informações do aplicativo para os achievers Conexões do Viva by Achievers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Achievers for Conexões do Viva |
| ID | WA200004313 |
...
| Funcionalidade principal do aplicativo | Cartões de ação rápidos para membros que usam a plataforma Achievers para assinar um cartão de comemoração, exibir autocons reconhecimentos e reconhecimentos populares |
