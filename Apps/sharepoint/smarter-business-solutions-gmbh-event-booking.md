---
title: Informações do aplicativo para a reserva de eventos mais inteligente da Smarter Business Solutions GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Todas as informações de segurança e conformidade disponíveis para a Reserva de Eventos Mais Inteligente, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64876528"
---
# <a name="smarter-event-booking"></a>Reserva de eventos mais inteligente
...
Informações fornecidas pela Smarter Business Solutions GmbH para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Reserva de eventos mais inteligente |
| ID | WA200003125 |
| Office 365 clientes com suporte | SharePoint 2016 ou posterior |
| Nome da empresa parceira | Smarter Business Solutions GmbH |
...
| Funcionalidade principal do aplicativo | O Smarter Event Booking permite que os usuários do Microsoft365 se inscrevam em eventos criados anteriormente. |
...
Essas informações foram fornecidas pela Smarter Business Solutions GmbH sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
