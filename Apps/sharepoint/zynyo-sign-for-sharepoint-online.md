...
* <a href="https://appsource.microsoft.com/product/office/WA200003673" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por Zynyo à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Zynyo Sign for SharePoint Online |
| ID | WA200003673 |
| Office 365 clientes com suporte | SharePoint 2016 ou posterior |
| Nome da empresa de parceiro | Zynyo |
| Site da empresa | [https://zynyo.com](https://zynyo.com) |
...
Essas informações foram fornecidas por Zynyo sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | Quando o usuário envia uma solicitação de assinatura, o documento selecionado e os dados inseridos são armazenados, isso pode incluir dados do cliente, como nome, email e número de telefone. Esses dados são excluídos quando a solicitação de sinal expira, por padrão, 30 dias. |
...
| URL da Política de Privacidade | https://zynyo.com/Zynyo-Privacyverklaring.pdf |
