---
title: Informações do aplicativo Egnyte para Outlook da Egnyte, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Egnyte para Outlook, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66655930"
---
# <a name="egnyte-for-outlook"></a>Egnyte para Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 8 de março de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004177" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Egnyte, Inc. à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Egnyte para Outlook |
| ID | WA200004177 |
| Office 365 clientes com suporte | Outlook 2013 ou posterior no Windows, Outlook 2016 ou posterior no Mac, Outlook na Web |
| Nome da empresa parceira | Egnyte, Inc. |
| Site da empresa | [https://www.egnyte.com](https://www.egnyte.com) |
| Termos de Uso do Aplicativo | [https://www.egnyte.com/terms-and-conditions/01-2020](https://www.egnyte.com/terms-and-conditions/01-2020) |
| Funcionalidade principal do aplicativo | Compartilhe facilmente arquivos do Egnyte para seus emails no Outlook ou salve emails e anexos do Outlook diretamente em uma pasta do Egnyte sem sair da sua caixa de entrada |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125](https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125) |
...
Essas informações foram fornecidas pela Egnyte, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | endereço de email, ID do locatário, tokens, IDs de mensagem e anexo e seu conteúdo |
...
| Data de certificação SOC2 mais recente | 2021-07-31 |
...
| URL da Política de Privacidade | https://www.egnyte.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Read.Shared | Delegada | Necessário para ler os detalhes do email ao qual o usuário tem acesso | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| User.Read | Delegada | Necessário para validar o usuário para fins de autorização | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| email | Delegada | Necessário para o token de acesso de validação | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| offline_access | Delegada | Necessário para solicitar explicitamente um token de atualização ao usar o OAuth 2.0 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| openid | Delegada | Necessário para ler informações básicas dos usuários | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| perfil | Delegada | Necessário para ler informações básicas do usuário | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
