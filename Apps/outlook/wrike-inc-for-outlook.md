---
title: Informações de aplicação para Wrike for Outlook pela Wrike Inc.
ms.author: elmalova
author: elenamalova
ms.date: 03/23/2020
ms.topic: article
...
description: Todas as informações disponíveis de segurança e conformidade para a Wrike for Outlook, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
| ID | WA104381120 |
| Office 365 clientes suportados | Outlook 2013 ou mais tarde em Windows, Outlook 2016 ou posterior no Mac, Outlook no iOS, Outlook na web, Outlook no Android |
