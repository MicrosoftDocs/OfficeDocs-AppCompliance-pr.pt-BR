---
title: Informações do aplicativo pexip One for Outlook by PexipAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Pexip One para Outlook, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64881458"
---
# <a name="pexip-one-for-outlook"></a>Pexip One para Outlook
...
|:----------------|:-------------|
| Nome do aplicativo | Pexip One para Outlook |
| ID | WA200003137 |
| Office 365 clientes com suporte | Outlook 2013 ou posterior no Windows, Outlook 2016 ou posterior no Mac, Outlook na Web |
| Nome da empresa parceira | PexipAS |
| Site da empresa | [https://www.pexip.com](https://www.pexip.com) |
| Termos de Uso do Aplicativo | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| Funcionalidade principal do aplicativo | O Pexip One permite que os usuários criem reuniões seguras facilmente enquanto usam seus fluxos de trabalho de organização de reunião existentes. O Pexip one oferece recursos de compartilhamento de tela, voz e chat em vídeo. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegada | Os dados de evento para usuários são usados para agendar reuniões na plataforma e controlar alterações nos metadados da reunião | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
