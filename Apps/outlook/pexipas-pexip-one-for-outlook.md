...
| Funcionalidade principal do aplicativo | O Pexip One permite que os usuários criem reuniões seguras facilmente enquanto usam seus fluxos de trabalho de organização de reunião existentes. O Pexip um oferece recursos de compartilhamento de tela, voz e chat de vídeo. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | delegado | Os dados de eventos para usuários são usados para agendar reuniões na plataforma e acompanhar alterações nos metadados de reunião | [69609b5a-e416-4d72-b10b-8903e84780c3](https://docs.microsoft.com/microsoft-365-app-certification/azure/69609b5a-e416-4d72-b10b-8903e84780c3) |
