---
title: Informações do aplicativo para Reator de Email da Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Reator de Email, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no Registro STAR da CSA.
...
---
# <a name="email-reactor"></a>Reator de Email
...
* <a href="https://appsource.microsoft.com/product/office/WA104379506" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Reator de Email |
| ID | WA104379506 |
...
| Termos de Uso do Aplicativo | [https://www.flosim.com/reactor/EULA.html](https://www.flosim.com/reactor/EULA.html) |
| Funcionalidade principal do aplicativo | Ferramenta de rascunho de resposta de email com economia de tempo |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://www.flosim.com/reactor/Email_Reactor.html](https://www.flosim.com/reactor/Email_Reactor.html) |
