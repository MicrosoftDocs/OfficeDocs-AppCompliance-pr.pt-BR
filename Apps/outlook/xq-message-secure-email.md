...
description: Todas as informações de segurança e conformidade disponíveis para o Email Seguro do XQ, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
|:----------------|:-------------|
| Nome do aplicativo | XQ Secure Email |
| ID | WA200000090 |
...
| Nome da empresa parceira | Mensagem XQ |
| Site da empresa | [https://xqmsg.co](https://xqmsg.co) |
| Termos de Uso do Aplicativo | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| Funcionalidade principal do aplicativo | Proteja todas as suas comunicações &#8212; emails para arquivos. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://xqmsg.co/about](https://xqmsg.co/about) |
