---
title: Informações do aplicativo para assinaturas de impressão para Outlook por assinaturas de impressão
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: Todas as informações de segurança e conformidade disponíveis para Assinaturas de Impressão para Outlook, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003199" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | Assinaturas de impressão para Outlook |
| ID | WA200003199 |
