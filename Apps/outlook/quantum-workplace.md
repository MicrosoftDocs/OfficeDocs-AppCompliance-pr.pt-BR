---
title: Informações do aplicativo para o Quantum Workplace by Quantum Workplace
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Quantum Workplace, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
Informações fornecidas pelo Quantum Workplace para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Quantum Workplace |
| ID | WA104381747 |
| Office 365 clientes com suporte | Outlook 2013 ou posterior no Windows, Outlook 2016 ou posterior no Mac, Outlook na Web |
| Nome da empresa parceira | Quantum Workplace |
| Site da empresa | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
| Termos de Uso do Aplicativo | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| Funcionalidade principal do aplicativo | Ajude os funcionários a obter sucesso com alertas e notificações do Quantum Workplace. |
...
Essas informações foram fornecidas pelo Quantum Workplace sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente | 2021-06-30 |
...
>| User.Read.All | aplicação | User.Id (Armazenado) – usado para correlacionar os usuários enviados ao nosso Ponto de Extremidade do Bot; User.UserPrincipalName (Não armazenado) - Atualmente não utilizado; User.Mail (Não Armazenado) – usado para fazer a correspondência dos usuários em nosso sistema com a ID do AzureAD que armazenamos. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
