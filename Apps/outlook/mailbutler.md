...
ms.locfileid: "62147312"
---
# <a name="mailbutler"></a>Mailbutler

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 4 de novembro de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001031" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Mailbutler à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Mailbutler |
| ID | WA200001031 |
| Office 365 clientes com suporte | Outlook 2016 ou posterior no Windows, Outlook 2016 ou posterior no Mac, Outlook na Web |
| Nome da empresa de parceiro | Mailbutler |
| Site da empresa | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
Essas informações foram fornecidas pelo Mailbutler sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Quais dados são armazenados em seus bancos de dados? | IDs de email, Metadados de Email (Assunto, Remetente/Destinatários, se o cliente autorizar), Dados de Contato (se importados por usuários) |
...
| URL da Política de Privacidade | https://www.mailbutler.io/privacy-policy-mailbutler/ |
