...
| Funcionalidade principal do aplicativo | Adicione assinaturas visíveis no Outlook e no OWA gerados no lado do servidor por CI-Sign, bem como uma visualização se as assinaturas são adicionadas no lado do servidor por CI-Disclaimer para atender aos requisitos de identidade corporativa e aos requisitos legalmente exigidos.  |
