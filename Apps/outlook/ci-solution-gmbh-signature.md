---
title: Informações do aplicativo para CI-Signature por ci solution GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Todas as informações de segurança e conformidade disponíveis para CI-Signature, suas políticas de manipulação de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002458" target="_blank">Exibir no AppSource</a>
...
| Funcionalidade principal do aplicativo | Adicione assinaturas visíveis no Outlook e no OWA gerados no lado do servidor pelo CI-Sign, bem como uma visualização se as assinaturas forem adicionadas no lado do servidor pelo CI-Disclaimer para atender aos requisitos de identidade corporativa e aos requisitos legalmente necessários.  |
| Localização da sede da empresa | Alemanha |
| Página de informações do aplicativo | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
