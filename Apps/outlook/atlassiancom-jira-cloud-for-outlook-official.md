...
description: Todas as informações de segurança e conformidade disponíveis para o Jira Cloud for Outlook (Oficial), suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64881498"
---
# <a name="jira-cloud-for-outlook-official"></a>Jira Cloud for Outlook (Oficial)
...
|:----------------|:-------------|
| Nome do aplicativo | Jira Cloud for Outlook (Oficial) |
| ID | WA200000056 |
...
| Funcionalidade principal do aplicativo | Planejar, acompanhar, lançar software. Gerencie suporte, atendimento ao cliente e projetos. |
...
| Quais dados são processados pelo seu aplicativo? | Os Dados de Email do Usuário são processados como parte da função de aplicativos de exibição de links Jira. |
