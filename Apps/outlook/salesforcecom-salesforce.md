...
| Funcionalidade principal do aplicativo | Permite que você experimente o Salesforce no Outlook. A integração é 100% na nuvem com base sem software para pressionar, instalar ou manter. Exibir todos os contatos, contatos, contas, oportunidades e casos associados a emails e compromissos sem alternar entre Salesforce e Outlook; seus dados do Salesforce aparecem diretamente no Outlook. Crie novos registros do Salesforce, incluindo registros de Objetos Personalizados, diretamente Outlook. Adicionar emails e compromissos aos registros do Salesforce em um clique, mesmo ao compor |
