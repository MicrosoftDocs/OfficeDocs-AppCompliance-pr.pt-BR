...
description: Todas as informações de segurança e conformidade disponíveis para o Salesforce, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
| Site da empresa | [https://www.salesforce.com](https://www.salesforce.com) |
| Termos de Uso do Aplicativo | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| Funcionalidade principal do aplicativo | Permite que você experimente o Salesforce no Outlook. A integração é 100% baseada em nuvem sem software para push, instalação ou manutenção. Exiba todos os contatos, clientes potenciais, contas, oportunidades e casos associados a emails e compromissos sem alternar entre o Salesforce e o Outlook; seus dados do Salesforce aparecem diretamente no Outlook. Crie novos registros do Salesforce, incluindo registros de Objeto Personalizado, diretamente Outlook. Adicionar emails e compromissos aos registros do Salesforce com um clique, mesmo ao redigir |
