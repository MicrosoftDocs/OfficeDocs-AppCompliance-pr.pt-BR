...
description: Todas as informações de segurança e conformidade disponíveis para neopoleta, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
| Página de informações do aplicativo | [https://neopol.is](https://neopol.is) |
