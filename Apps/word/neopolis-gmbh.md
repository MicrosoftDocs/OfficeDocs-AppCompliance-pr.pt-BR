---
title: Informações do aplicativo para neopolápole pela GmbH de neopolásia
ms.author: elmalova
author: elenamalova
ms.date: 10/28/2021
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para neopoleta, suas políticas de tratamento de dados, suas informações de catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no Registro STAR do CSA.
...
ms.locfileid: "60874801"
---
# <a name="neopolis"></a>neopoliápole
...
* <a href="https://appsource.microsoft.com/product/office/WA200002920" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo GmbH da neopolásia para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | neopoliápole |
| ID | WA200002920 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2013 ou posterior no Windows |
| Nome da empresa de parceiro | neopolásia GmbH |
| Site da empresa | [https://neopol.is](https://neopol.is) |
| Termos de uso do aplicativo | [https://app.termly.io/document/terms-of-use-for-saas/655330...](https://app.termly.io/document/terms-of-use-for-saas/655330e8-5787-47b4-8957-90006db46c80) |
| Funcionalidade principal do aplicativo | Professionelle Textdokumente parallel schreiben, &#252;berarbeiten und versionieren. Wir wenden das in der Softwareentwicklung etablierte Git-Prinzip auf die kollaborative Bearbeitung professioneller Textdokumente an. Unser Word Plug-in m&#246;glicht parallele und kontrollierte Zusammenarbeit, ohne dass bestehende Prozesse oder Software umgestellt werden m&#252;ssen. |
...
Essas informações foram fornecidas pelo GmbH neopolis sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| **Information** | **Response** |
|:----------------|:-------------|
| O aplicativo está em conformidade com a Lei de Portabilidade e Contabilidade do Seguro de Saúde (HIPAA)? | Não disponível |
...
| O aplicativo está em conformidade com Sarbanes-Oxley Lei (SOX)? | Não disponível |
| O aplicativo está em conformidade com o NIST 800-171? | Não disponível |
...
| URL da Política de Privacidade | https://neopol.is/gdpr/ |
