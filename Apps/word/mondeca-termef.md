---
title: Informações do aplicativo para TerMef da Mondeca
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/09/2021
...
description: Todas as informações de segurança e conformidade disponíveis para TerMef, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
| Nome da empresa parceira | Mondeca |
...
| Funcionalidade principal do aplicativo | Rechercher les termes r&#233;f&#233;rents le portail TerMef, via son API REST, et afficher leur infobo&#238;te. La recherche peut s'effectuer par la s&#233;lection d'une portion de texte du document, pour la saisie de termes &#224; rechercher. |
