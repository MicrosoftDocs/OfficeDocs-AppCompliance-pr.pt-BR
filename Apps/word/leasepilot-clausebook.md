---
title: Informações do aplicativo para Clausebook por LeasePilot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Todas as informações de segurança e conformidade disponíveis para Clausebook, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo LeasePilot para a Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Clausebook |
| ID | WA200004044 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2016 ou posterior no Windows |
| Nome da empresa parceira | LeasePilot |
| Site da empresa | [https://clausebook.com](https://clausebook.com) |
| Termos de Uso do Aplicativo | [https://clausebook.com/terms](https://clausebook.com/terms) |
| Funcionalidade principal do aplicativo | Clausebook é seu companheiro de esboçamento de documento! Ele ajuda as equipes a capturar, organizar, redigir e compartilhar formulários e bibliotecas de cláusulas para rascunho rápido e institucionalização das práticas da organização. |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | |
| Qual é o ambiente de hospedagem ou o modelo de serviço usado para executar seu aplicativo? | Paas |
| Quais provedores de nuvem de hospedagem o aplicativo usa? | Other, Vercel |
...
Essas informações foram fornecidas pelo LeasePilot sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
