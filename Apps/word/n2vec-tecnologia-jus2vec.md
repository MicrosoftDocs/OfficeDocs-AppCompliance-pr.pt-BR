---
title: Informações do aplicativo para Jus2vec da N2VEC TECNOLOGIA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Jus2vec, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64906399"
---
# <a name="jus2vec"></a>Jus2vec

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última atualização pelo desenvolvedor em: 18 de abril de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002506" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela N2VEC TECNOLOGIA para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Jus2vec |
| ID | WA200002506 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2013 ou posterior no Windows |
| Nome da empresa parceira | N2VEC TECNOLOGIA |
| Site da empresa | [https://info.jus2vec.com](https://info.jus2vec.com) |
| Termos de Uso do Aplicativo | [https://info.jus2vec.com/termos-de-uso.html](https://info.jus2vec.com/termos-de-uso.html) |
| Funcionalidade principal do aplicativo | Busca por Jurisprud&#234;ncias usando Intelig&#234;ncia Artificial |
| Localização da sede da empresa | Brasil |
...
Essas informações foram fornecidas pela N2VEC TECNOLOGIA sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
