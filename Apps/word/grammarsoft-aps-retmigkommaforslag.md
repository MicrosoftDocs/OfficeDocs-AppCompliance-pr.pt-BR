...
| Site da empresa | [https://retmig.dk](https://retmig.dk) |
| Termos de uso do aplicativo | [https://retmig.dk/terms](https://retmig.dk/terms) |
| Funcionalidade principal do aplicativo | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejl. |
| Localização da sede da empresa | Dinamarca |
| Página de informações do aplicativo | [https://retmig.dk](https://retmig.dk) |
