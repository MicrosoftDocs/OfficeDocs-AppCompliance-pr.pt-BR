...
|:----------------|:-------------|
| Nome do aplicativo | officeatwork - Uploader for Office |
| ID | WA104381430 |
| Office 365 clientes suportados | Palavra sobre iPad, Word 2016 ou mais tarde em Mac, Word 2016 ou mais tarde em Windows, Word na Web |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | Delegada | Nenhum dado é armazenado. | OneDrive: ser capaz de ler e escrever dados para a OneDrive do usuário. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| Group.ReadWrite.All | Delegada | Nenhum dado é armazenado. | Teams: ler e escrever dados para um Grupo. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| GroupMember.Read.All | Delegada | Nenhum dado é armazenado. | SharePoint Online - Suporte a grupos de segurança: permitir que o aplicativo liste grupos, leia propriedades básicas do grupo e leia as adesões de todos os grupos aos que o usuário conectado tem acesso. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| Sites.Read.All | Delegada | Nenhum dado é armazenado. | SharePoint Online: para habilitar a leitura de dados em SharePoint Online, o usuário conectado tem acesso. Para ativar o upload de dados em SharePoint Online | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| User.Read | Delegada | Nenhum dado é armazenado. | Sing-In: para habilitar o aplicativo officeatwork para ler as propriedades básicas do usuário. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| User.Read.All | Delegada | Nenhum dado é armazenado. | Teams: descobrir a quais grupos um usuário pertence. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| offline_access | Delegada | Nenhum dado é armazenado. | Sing-In: para ativar o login automático via'tokens de atualização, como sem, os usuários teriam que fazer login manualmente toda vez que lançarem o aplicativo officeatwork. Este escopo só é necessário para aplicativos de host não habilitados para SSO. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| openid | Delegada | Nenhum dado é armazenado. | Sing-In: para permitir que os usuários entrem no aplicativo officeatwork com sua conta organizacional e/ou Microsoft. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| perfil | Delegada | Nenhum dado é armazenado. | Sing-In: para mostrar o usuário assinado no aplicativo officeatwork. Isso ajuda a garantir/confirmar ao usuário qual conta foi usada para fazer login no aplicativo officeatwork. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
...
<iframe height='1020' title='Microsoft Cloud App Security informação' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35750' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35750" target="_blank">Exibir em uma nova guia</a>
