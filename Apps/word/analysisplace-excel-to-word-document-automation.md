---
title: Informações do aplicativo Excel automação de documentos do Excel para o Word
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/28/2022
...
---
# <a name="excel-to-word-document-automation"></a>Excel automação de documentos do Excel para o Word
...
| Quais dados são processados pelo seu aplicativo? | Nome de usuário, endereço de email do usuário, ID do locatário da organização |
