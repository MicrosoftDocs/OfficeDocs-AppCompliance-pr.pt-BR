...
---
# <a name="officeatwork--wizard-for-office"></a>| officeatwork Mago para Office
...
* <a href="https://appsource.microsoft.com/product/office/WA104380519" target="_blank">Exibir no AppSource</a>
...
|:----------------|:-------------|
| Nome do aplicativo | officeatwork - Assistente para Office |
| ID | WA104380519 |
| Office 365 clientes suportados | Word 2016 ou mais tarde em Mac, Word 2016 ou mais tarde em Windows, Word on iPad, Word na Web |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.Read | Delegada | Nenhum dado é armazenado. | Contatos: para permitir a leitura de todos os contatos do usuário de assinatura. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
>| Files.Read.All | Delegada | Nenhum dado é armazenado. | Teams - Arquivos (Conteúdo): para habilitar a leitura de todos os arquivos do usuário de assinatura. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Group.Read.All | Delegada | Nenhum dado é armazenado. | Office 365 Usuários - Limite para grupo: para permitir a leitura de todos os grupos do usuário de assinatura. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Sites.Read.All | Delegada | Nenhum dado é armazenado. | SharePoint Online: para ativar a leitura de dados do SharePoint Online. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
>| User.Read.All | Delegada | Nenhum dado é armazenado. | Office 365 Usuários - Todas as propriedades: para permitir a leitura de todas as propriedades de todos os usuários. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.ReadBasic.All | Delegada | Nenhum dado é armazenado. | Office 365 Usuários - Propriedades básicas: para permitir a leitura das propriedades básicas de todos os usuários | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| offline_access | Delegada | Nenhum dado é armazenado. | Sing-In: para ativar o login automático via'tokens de atualização, como sem, os usuários teriam que fazer login manualmente toda vez que lançarem o aplicativo officeatwork. Este escopo só é necessário para aplicativos de host não habilitados para SSO. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| openid | Delegada | Nenhum dado é armazenado. | Sing-In: para permitir que os usuários entrem no aplicativo officeatwork com sua conta organizacional e/ou Microsoft | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| perfil | Delegada | Nenhum dado é armazenado. | Sing-In: para mostrar o usuário assinado no aplicativo officeatwork. Isso ajuda a garantir/confirmar ao usuário qual conta foi usada para fazer login no aplicativo officeatwork. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
<iframe height='1020' title='Microsoft Cloud App Security informação' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='no' style='width: 100%;'></iframe>
