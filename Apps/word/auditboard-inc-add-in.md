---
title: Informações do aplicativo para o complemento AuditBoard pela Auditboard, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o Complemento do AuditBoard, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003350" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo Auditboard, Inc. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | AuditBoard Add-in |
| ID | WA200003350 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2013 ou posterior no Windows |
| Nome da empresa de parceiro | Auditboard, Inc. |
...
| Funcionalidade principal do aplicativo | Permite que os assinantes do AuditBoard embutam dados de links &amp; para o site AB durante a edição de Ab Narrações.  |
...
Essas informações foram fornecidas pelo Auditboard, Inc. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| Data de certificação SOC2 mais recente |  2020-12-01 |
