---
title: Informações de aplicativo para SmartCite para artigos de ciência digital
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o SmartCite for Papers, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
| Nome da empresa parceira | Ciência Digital |
| Site da empresa | [https://papersapp.com](https://papersapp.com) |
| Termos de Uso do Aplicativo | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| Funcionalidade principal do aplicativo | Cite referências e gere bibliografias automaticamente da biblioteca readCube Papers! |
| Localização da sede da empresa | Estados Unidos da América |
| Página de informações do aplicativo | [https://www.papersapp.com/smartcite-for-word/](https://www.papersapp.com/smartcite-for-word/) |
...
Essas informações foram fornecidas pela Ciência Digital sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados que o aplicativo coleta.
