...
description: Todas as informações de segurança e conformidade disponíveis para CrossCheck, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64881190"
---
# <a name="crosscheck"></a>Cruzar
...
Informações fornecidas por kRevealLLC para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Cruzar |
| ID | WA200003198 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2013 ou posterior no Windows |
| Nome da empresa parceira | kRevealLLC |
| Site da empresa | [https://kreveal.com](https://kreveal.com) |
...
| Funcionalidade principal do aplicativo | O CrossCheck simplifica a revisão de documentos e identifica erros comuns de rascunho. |
...
Essas informações foram fornecidas pela kRevealLLC sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
