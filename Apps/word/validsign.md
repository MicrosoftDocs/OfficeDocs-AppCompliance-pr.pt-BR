---
title: Informações do aplicativo para ValidSign por ValidSign
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Todas as informações de segurança e conformidade disponíveis para ValidSign, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pelo ValidSign à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | ValidSign |
| ID | WA200001890 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2013 ou posterior no Windows |
| Nome da empresa parceira | ValidSign |
| Site da empresa | [https://www.validsign.eu](https://www.validsign.eu) |
| Termos de Uso do Aplicativo | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| Funcionalidade principal do aplicativo | Trabalhe de forma mais inteligente e eficiente com o suplemento ValidSign Word |
| Localização da sede da empresa | Países Baixos (o) |
| Página de informações do aplicativo | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
Essas informações foram fornecidas pelo ValidSign sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://www.validsign.eu/validsign-privacy-statement/ |
