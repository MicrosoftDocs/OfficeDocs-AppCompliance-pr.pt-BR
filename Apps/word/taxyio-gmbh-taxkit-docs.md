---
title: Informações do aplicativo para documentos do TaxKit da Taxy.io GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Todas as informações de segurança e conformidade disponíveis para o TaxKit Docs, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "64880848"
---
# <a name="taxkit-docs"></a>Documentos do TaxKit
...
|:----------------|:-------------|
| Nome do aplicativo | Documentos do TaxKit |
| ID | WA200002849 |
| Office 365 clientes com suporte | Word 2016 ou posterior no Mac, Word na Web, Word 2013 ou posterior no Windows |
| Nome da empresa parceira | Taxy.io GmbH |
| Site da empresa | [https://www.taxy.io](https://www.taxy.io) |
| Termos de Uso do Aplicativo | [https://go.microsoft.com](https://go.microsoft.com) |
| Funcionalidade principal do aplicativo | O TaxKit Docs ajuda os consultores fiscais a encontrar literatura jurídica relevante para o documento e o caso em que estão trabalhando. Isso os ajuda a orientar seus clientes com mais eficiência. |
