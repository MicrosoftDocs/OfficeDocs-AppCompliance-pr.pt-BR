---
title: Informações de aplicativo para RocketDocs LaunchPad by RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o RocketDocs LaunchPad, suas políticas de manipulação de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
Informações fornecidas pelo RocketDocs à Microsoft:
...
| Nome da empresa parceira | RocketDocs |
