---
title: Informações do aplicativo para Menndeley Cite by ELSEVIER LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Mendeley Cite, suas políticas de tratamento de dados, suas informações do catálogo de aplicativos do Microsoft Cloud App Security e informações de segurança/conformidade no registro CSA STAR.
...
ms.locfileid: "66249946"
---
# <a name="mendeley-cite"></a>Citação de Mendeley
...
* <a href="https://appsource.microsoft.com/product/office/WA104382081" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela ELSEVIER LIMITED à Microsoft:

| **Information** | **Response** |
|:----------------|:-------------|
| Nome do aplicativo | Citação de Mendeley |
| ID | WA104382081 |
| Office 365 clientes com suporte | Word no iPad, Word 2016 ou posterior no Windows, Word 2016 ou posterior no Mac, Word na Web |
| Nome da empresa parceira | ELSEVIER LIMITED |
| Site da empresa | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| Termos de Uso do Aplicativo | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| Funcionalidade principal do aplicativo | Cite como você escreve. Gere citações e bibliografias e altere seu estilo de citação. |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://www.mendeley.com/guides/mendeley-cite/](https://www.mendeley.com/guides/mendeley-cite/) |
...
Essas informações foram fornecidas pela ELSEVIER LIMITED sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
| URL da Política de Privacidade | https://privacy.elsevier.com |
