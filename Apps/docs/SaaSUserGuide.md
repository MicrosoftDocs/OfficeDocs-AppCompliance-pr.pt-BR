...
ms.author: legerrar
manager: tonybal
description: Guia do usuário do ISV para Microsoft 365 SaaS do Programa de Conformidade de Aplicativos
keywords: Guia do usuário do ISV para Microsoft 365 SaaS do Programa de Conformidade de Aplicativos
ms.topic: conceptual
...
ms.locfileid: "64752860"
---
# <a name="partners-user-guide-for-microsoft-365-app-compliance-program---saas"></a>Guia do usuário do parceiro para o Microsoft 365 de Conformidade de Aplicativos – SaaS
...
## <a name="3-publisher-attestation-workflow"></a>3. Fluxo Publisher de Atestado
...
![Selecionando um aplicativo no Marketplace Comercial](../media/NewPCOffersOffice.png)
...
![Obter um Atestado do Publisher](../media/UserGuidePhotos/5.5.png)
...
![Clonar Recurso](../media/UserGuidePhotos/05.png)
...
**Etapa 5**: depois de concluída, clique em 'Enviar', a avaliação agora será 'Em Revisão'.
 ...
 ![Enviar Publisher confirmação de envio](../media/UserGuidePhotos/07.png) ![](../media/UserGuidePhotos/08.png)
...
- Após a aprovação, o parceiro pode:
 ...
 ![Iniciando a certificação Microsoft 365 dados](../media/UserGuidePhotos/11.png)
...
## <a name="4---microsoft-365-certification-workflow"></a>4. Fluxo de Microsoft 365 de Certificação
...
![Envio inicial de documentoEnviar](../media/UserGuidePhotos/14.png) 
![ envio inicial de documento](../media/UserGuidePhotos/15.png)
...
![Upload de controle](../media/UserGuidePhotos/19.png)
...
![Necessidades de evidência atualizadas](../media/UserGuidePhotos/22.png)
...
## <a name="5---microsoft-365-renewal-workflow"></a>5. Fluxo Microsoft 365 renovação:
...
![Renovação de Atestado](../media/UserGuidePhotos/32.png) 
