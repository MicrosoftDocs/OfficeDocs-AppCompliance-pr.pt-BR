---
title: Informações do aplicativo para Showmaster por cerejeira
ms.author: elmalova
author: elenamalova
ms.date: 01/19/2022
ms.topic: article
...
description: Todas as informações de segurança e conformidade disponíveis para o Showmaster, suas políticas de tratamento de dados, suas Microsoft Cloud App Security de catálogo de aplicativos e informações de segurança/conformidade no Registro STAR do CSA.
