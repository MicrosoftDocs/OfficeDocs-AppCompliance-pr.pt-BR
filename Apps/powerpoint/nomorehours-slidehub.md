...
description: Todas as informações de segurança e conformidade disponíveis para o SlideHub, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001625" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas por nomorehours à Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | SlideHub |
| ID | WA200001625 |
| Office 365 clientes com suporte | PowerPoint 2016 ou posterior no Mac, PowerPoint na Web, PowerPoint 2013 ou posterior no Windows |
| Nome da empresa parceira | nomorehours |
| Site da empresa | [https://nomorehours.com](https://nomorehours.com) |
| Termos de Uso do Aplicativo | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| Funcionalidade principal do aplicativo | NoMore fornece aos usuários PowerPoint serviços de design e um suplemento PowerPoint para torná-los mais eficientes PowerPoint. Como parte do serviço de design, NoMore converte rascunhos aproximados em slides prontos para cliente em apenas 8 horas. O Suplemento ajuda a acessar o serviço mais rapidamente, mas também permite que os usuários acessem designs de slide predefinido e uma biblioteca de slides específica da empresa, bem como um kit de ferramentas de consultoria &#8220;&#8221; que contém diferentes ferramentas de produtividade. |
| Localização da sede da empresa | Dinamarca |
| Página de informações do aplicativo | [https://nomorehours.com](https://nomorehours.com) |
...
Essas informações foram fornecidas por nomorehours sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicação | email e nome. O email é usado como o nome de usuário no aplicativo. Coletar o email pode ajudar a se registrar e fazer logon no aplicativo mais rapidamente. O nome é usado no caso de um evento de registro. | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
