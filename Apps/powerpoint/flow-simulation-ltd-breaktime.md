---
title: Informações do aplicativo para o tempo de interrupção por Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Todas as informações de segurança e conformidade disponíveis para o Breaktime, suas políticas de tratamento de dados, suas Microsoft Cloud App Security do catálogo de aplicativos e informações de segurança/conformidade no registro CSA STAR.
...
---
# <a name="breaktime"></a>Tempo de interrupção
...
* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">Exibir no AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informações gerais

Informações fornecidas pela Flow Simulation Ltd. para a Microsoft:

| **Information** | **Resposta** |
|:----------------|:-------------|
| Nome do aplicativo | Tempo de interrupção |
| ID | WA200001661 |
...
| Nome da empresa parceira | Flow Simulation Ltd. |
| Site da empresa | [https://www.flosim.com](https://www.flosim.com) |
| Termos de Uso do Aplicativo | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| Funcionalidade principal do aplicativo | Uma maneira rápida de dizer a todos quando você estará de volta, porque é o Tempo de Interrupção! |
| Localização da sede da empresa | Reino Unido da Grã-Bretanha e Irlanda do Norte (o) |
| Página de informações do aplicativo | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
Essas informações foram fornecidas pela Flow Simulation Ltd. sobre como esse aplicativo coleta e armazena dados organizacionais e o controle que sua organização terá sobre os dados coletados pelo aplicativo.
